 ...
 */const D_=function(t){const e=[];let n=0;for(let r=0;r<t.length;r++){let s=t.charCodeAt(r);s<128?e[n++]=s:s<2048?(e[n++]=s>>6|192,e[n++]=s&63|128):(s&64512)===55296&&r+1<t.length&&(t.charCodeAt(r+1)&64512)===56320?(s=65536+((s&1023)<<10)+(t.charCodeAt(++r)&1023),e[n++]=s>>18|240,e[n++]=s>>12&63|128,e[n++]=s>>6&63|128,e[n++]=s&63|128):(e[n++]=s>>12|224,e[n++]=s>>6&63|128,e[n++]=s&63|128)}return e},jb=function(t){const e=[];let n=0,r=0;for(;n<t.length;){const s=t[n++];if(s<128)e[r++]=String.fromCharCode(s);else if(s>191&&s<224){const i=t[n++];e[r++]=String.fromCharCode((s&31)<<6|i&63)}else if(s>239&&s<365){const i=t[n++],o=t[n++],l=t[n++],c=((s&7)<<18|(i&63)<<12|(o&63)<<6|l&63)-65536;e[r++]=String.fromCharCode(55296+(c>>10)),e[r++]=String.fromCharCode(56320+(c&1023))}else{const i=t[n++],o=t[n++];e[r++]=String.fromCharCode((s&15)<<12|(i&63)<<6|o&63)}}return e.join("")},x_={byteToCharMap_:null,charToByteMap_:null,byteToCharMapWebSafe_:null,charToByteMapWebSafe_:null,ENCODED_VALS_BASE:"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789",get ENCODED_VALS(){return this.ENCODED_VALS_BASE+"+/="},get ENCODED_VALS_WEBSAFE(){return this.ENCODED_VALS_BASE+"-_."},HAS_NATIVE_SUPPORT:typeof atob=="function",encodeByteArray(t,e){if(!Array.isArray(t))throw Error("encodeByteArray takes an array as a parameter");this.init_();const n=e?this.byteToCharMapWebSafe_:this.byteToCharMap_,r=[];for(let s=0;s<t.length;s+=3){const i=t[s],o=s+1<t.length,l=o?t[s+1]:0,c=s+2<t.length,u=c?t[s+2]:0,f=i>>2,p=(i&3)<<4|l>>4;let m=(l&15)<<2|u>>6,_=u&63;c||(_=64,o||(m=64)),r.push(n[f],n[p],n[m],n[_])}return r.join("")},encodeString(t,e){return this.HAS_NATIVE_SUPPORT&&!e?btoa(t):this.encodeByteArray(D_(t),e)},decodeString(t,e){return this.HAS_NATIVE_SUPPORT&&!e?atob(t):jb(this.decodeStringToByteArray(t,e))},decodeStringToByteArray(t,e){this.init_();const n=e?this.charToByteMapWebSafe_:this.charToByteMap_,r=[];for(let s=0;s<t.length;){const i=n[t.charAt(s++)],l=s<t.length?n[t.charAt(s)]:0;++s;const u=s<t.length?n[t.charAt(s)]:64;++s;const p=s<t.length?n[t.charAt(s)]:64;if(++s,i==null||l==null||u==null||p==null)throw new Bb;const m=i<<2|l>>4;if(r.push(m),u!==64){const _=l<<4&240|u>>2;if(r.push(_),p!==64){const A=u<<6&192|p;r.push(A)}}}return r},init_(){if(!this.byteToCharMap_){this.byteToCharMap_={},this.charToByteMap_={},this.byteToCharMapWebSafe_={},this.charToByteMapWebSafe_={};for(let t=0;t<this.ENCODED_VALS.length;t++)this.byteToCharMap_[t]=this.ENCODED_VALS.charAt(t),this.charToByteMap_[this.byteToCharMap_[t]]=t,this.byteToCharMapWebSafe_[t]=this.ENCODED_VALS_WEBSAFE.charAt(t),this.charToByteMapWebSafe_[this.byteToCharMapWebSafe_[t]]=t,t>=this.ENCODED_VALS_BASE.length&&(this.charToByteMap_[this.ENCODED_VALS_WEBSAFE.charAt(t)]=t,this.charToByteMapWebSafe_[this.ENCODED_VALS.charAt(t)]=t)}}};class Bb extends Error{constructor(){super(...arguments),this.name="DecodeBase64StringError"}}const qb=function(t){const e=D_(t);return x_.encodeByteArray(e,!0)},Na=function(t){return qb(t).replace(/\./g,"")},V_=function(t){try{return x_.decodeString(t,!0)}catch(e){console.error("base64Decode failed: ",e)}return null};/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class DA{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(n=>{if(xA(n)){const r=n.getImmediate();return`${r.library}/${r.version}`}else return null}).filter(n=>n).join(" ")}}function xA(t){const e=t.getComponent();return(e==null?void 0:e.type)==="VERSION"}const eu="@firebase/app",Kd="0.12.1";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Js=o0;function j_(t,e={}){let n=t;typeof e!="object"&&(e={name:e});const r=Object.assign({name:tu,automaticDataCollectionEnabled:!1},e),s=r.name;if(typeof s!="string"||!s)throw _r.create("bad-app-name",{appName:String(s)});if(n||(n=M_()),!n)throw _r.create("no-options");const i=Ma.get(s);if(i){if(Zr(n,i.options)&&Zr(r,i.config))return i;throw _r.create("duplicate-app",{appName:s})}const o=new gA(s);for(const c of nu.values())o.addComponent(c);const l=new u0(n,r,o);return Ma.set(s,l),l}function B_(t=tu){const e=Ma.get(t);if(!e&&t===tu&&M_())return j_();if(!e)throw _r.create("no-app",{appName:t});return e}function yr(t,e,n){var r;let s=(r=a0[t])!==null&&r!==void 0?r:t;n&&(s+=`-${n}`);const i=s.match(/\s|\//),o=e.match(/\s|\//);if(i||o){const l=[`Unable to register library "${s}" with version "${e}":`];i&&l.push(`library name "${s}" contains illegal characters (whitespace or "/")`),i&&o&&l.push("and"),o&&l.push(`version name "${e}" contains illegal characters (whitespace or "/")`),Bn.warn(l.join(" "));return}Us(new es(`${s}-version`,()=>({library:s,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const h0="firebase-heartbeat-database",f0=1,ro="firebase-heartbeat-store";let Ac=null;function q_(){return Ac||(Ac=PA(h0,f0,{upgrade:(t,e)=>{switch(e){case 0:try{t.createObjectStore(ro)}catch(n){console.warn(n)}}}}).catch(t=>{throw _r.create("idb-open",{originalErrorMessage:t.message})})),Ac}async function d0(t){try{const n=(await q_()).transaction(ro),r=await n.objectStore(ro).get(H_(t));return await n.done,r}catch(e){if(e instanceof Gn)Bn.warn(e.message);else{const n=_r.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});Bn.warn(n.message)}}}async function Qd(t,e){try{const r=(await q_()).transaction(ro,"readwrite");await r.objectStore(ro).put(e,H_(t)),await r.done}catch(n){if(n instanceof Gn)Bn.warn(n.message);else{const r=_r.create("idb-set",{originalErrorMessage:n==null?void 0:n.message});Bn.warn(r.message)}}}function H_(t){return`${t.name}!${t.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function E0(t){Us(new es("platform-logger",e=>new DA(e),"PRIVATE")),Us(new es("heartbeat",e=>new g0(e),"PRIVATE")),yr(eu,Kd,t),yr(eu,Kd,"esm2017"),yr("fire-js","")}E0("");var T0="firebase",w0="11.7.1";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */yr(T0,w0,"app");var Xd=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
...
*/var W_,Ci,K_,ha,ru,G_,Q_,Y_;(function(){var t,e=typeof Object.defineProperties=="function"?Object.defineProperty:function(a,h,d){return a==Array.prototype||a==Object.prototype||(a[h]=d.value),a};function n(a){a=[typeof globalThis=="object"&&globalThis,a,typeof window=="object"&&window,typeof self=="object"&&self,typeof ea=="object"&&ea];for(var h=0;h<a.length;++h){var d=a[h];if(d&&d.Math==Math)return d}throw Error("Cannot find global object")}var r=n(this);function s(a,h){if(h)e:{var d=r;a=a.split(".");for(var g=0;g<a.length-1;g++){var k=a[g];if(!(k in d))break e;d=d[k]}a=a[a.length-1],g=d[a],h=h(g),h!=g&&h!=null&&e(d,a,{configurable:!0,writable:!0,value:h})}}function i(a,h){a instanceof String&&(a+="");var d=0,g=!1,k={next:function(){if(!g&&d<a.length){var V=d++;return{value:h(V,a[V]),done:!1}}return g=!0,{done:!0,value:void 0}}};return k[Symbol.iterator]=function(){return k},k}s("Array.prototype.values",function(a){return a||function(){return i(this,function(h,d){return d})}});/** @license
 ...
 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/var o=o||{},l=this||self;function c(a){var h=typeof a;return h=h!="object"?h:a?Array.isArray(a)?"array":h:"null",h=="array"||h=="object"&&typeof a.length=="number"}function u(a){var h=typeof a;return h=="object"&&a!=null||h=="function"}function f(a,h,d){return a.call.apply(a.bind,arguments)}function p(a,h,d){if(!a)throw Error();if(2<arguments.length){var g=Array.prototype.slice.call(arguments,2);return function(){var k=Array.prototype.slice.call(arguments);return Array.prototype.unshift.apply(k,g),a.apply(h,k)}}return function(){return a.apply(h,arguments)}}function m(a,h,d){return m=Function.prototype.bind&&Function.prototype.bind.toString().indexOf("native code")!=-1?f:p,m.apply(null,arguments)}function _(a,h){var d=Array.prototype.slice.call(arguments,1);return function(){var g=d.slice();return g.push.apply(g,arguments),a.apply(this,g)}}function A(a,h){function d(){}d.prototype=h.prototype,a.aa=h.prototype,a.prototype=new d,a.prototype.constructor=a,a.Qb=function(g,k,V){for(var G=Array(arguments.length-2),Ve=2;Ve<arguments.length;Ve++)G[Ve-2]=arguments[Ve];return h.prototype[k].apply(g,G)}}function O(a){const h=a.length;if(0<h){const d=Array(h);for(let g=0;g<h;g++)d[g]=a[g];return d}return[]}function x(a,h){for(let d=1;d<arguments.length;d++){const g=arguments[d];if(c(g)){const k=a.length||0,V=g.length||0;a.length=k+V;for(let G=0;G<V;G++)a[k+G]=g[G]}else a.push(g)}}class H{constructor(h,d){this.i=h,this.j=d,this.h=0,this.g=null}get(){let h;return 0<this.h?(this.h--,h=this.g,this.g=h.next,h.next=null):h=this.i(),h}}function j(a){return/^[\s\xa0]*$/.test(a)}function N(){var a=l.navigator;return a&&(a=a.userAgent)?a:""}function D(a){return D[" "](a),a}D[" "]=function(){};var q=N().indexOf("Gecko")!=-1&&!(N().toLowerCase().indexOf("webkit")!=-1&&N().indexOf("Edge")==-1)&&!(N().indexOf("Trident")!=-1||N().indexOf("MSIE")!=-1)&&N().indexOf("Edge")==-1;function te(a,h,d){for(const g in a)h.call(d,a[g],g,a)}function R(a,h){for(const d in a)h.call(void 0,a[d],d,a)}function v(a){const h={};for(const d in a)h[d]=a[d];return h}const y="constructor hasOwnProperty isPrototypeOf propertyIsEnumerable toLocaleString toString valueOf".split(" ");function w(a,h){let d,g;for(let k=1;k<arguments.length;k++){g=arguments[k];for(d in g)a[d]=g[d];for(let V=0;V<y.length;V++)d=y[V],Object.prototype.hasOwnProperty.call(g,d)&&(a[d]=g[d])}}function S(a){var h=1;a=a.split(":");const d=[];for(;0<h&&a.length;)d.push(a.shift()),h--;return a.length&&d.push(a.join(":")),d}function b(a){l.setTimeout(()=>{throw a},0)}function E(){var a=Lt;let h=null;return a.g&&(h=a.g,a.g=a.g.next,a.g||(a.h=null),h.next=null),h}class Ce{constructor(){this.h=this.g=null}add(h,d){const g=Je.get();g.set(h,d),this.h?this.h.next=g:this.g=g,this.h=g}}var Je=new H(()=>new De,a=>a.reset());class De{constructor(){this.next=this.g=this.h=null}set(h,d){this.h=h,this.g=d,this.next=null}reset(){this.next=this.g=this.h=null}}let he,Ee=!1,Lt=new Ce,nn=()=>{const a=l.Promise.resolve(void 0);he=()=>{a.then(Wt)}};var Wt=()=>{for(var a;a=E();){try{a.h.call(a.g)}catch(d){b(d)}var h=Je;h.j(a),100>h.h&&(h.h++,a.next=h.g,h.g=a)}Ee=!1};function He(){this.s=this.s,this.C=this.C}He.prototype.s=!1,He.prototype.ma=function(){this.s||(this.s=!0,this.N())},He.prototype.N=function(){if(this.C)for(;this.C.length;)this.C.shift()()};function ze(a,h){this.type=a,this.g=this.target=h,this.defaultPrevented=!1}ze.prototype.h=function(){this.defaultPrevented=!0};var Yn=function(){if(!l.addEventListener||!Object.defineProperty)return!1;var a=!1,h=Object.defineProperty({},"passive",{get:function(){a=!0}});try{const d=()=>{};l.addEventListener("test",d,h),l.removeEventListener("test",d,h)}catch{}return a}();function fn(a,h){if(ze.call(this,a?a.type:""),this.relatedTarget=this.g=this.target=null,this.button=this.screenY=this.screenX=this.clientY=this.clientX=0,this.key="",this.metaKey=this.shiftKey=this.altKey=this.ctrlKey=!1,this.state=null,this.pointerId=0,this.pointerType="",this.i=null,a){var d=this.type=a.type,g=a.changedTouches&&a.changedTouches.length?a.changedTouches[0]:null;if(this.target=a.target||a.srcElement,this.g=h,h=a.relatedTarget){if(q){e:{try{D(h.nodeName);var k=!0;break e}catch{}k=!1}k||(h=null)}}else d=="mouseover"?h=a.fromElement:d=="mouseout"&&(h=a.toElement);this.relatedTarget=h,g?(this.clientX=g.clientX!==void 0?g.clientX:g.pageX,this.clientY=g.clientY!==void 0?g.clientY:g.pageY,this.screenX=g.screenX||0,this.screenY=g.screenY||0):(this.clientX=a.clientX!==void 0?a.clientX:a.pageX,this.clientY=a.clientY!==void 0?a.clientY:a.pageY,this.screenX=a.screenX||0,this.screenY=a.screenY||0),this.button=a.button,this.key=a.key||"",this.ctrlKey=a.ctrlKey,this.altKey=a.altKey,this.shiftKey=a.shiftKey,this.metaKey=a.metaKey,this.pointerId=a.pointerId||0,this.pointerType=typeof a.pointerType=="string"?a.pointerType:Dt[a.pointerType]||"",this.state=a.state,this.i=a,a.defaultPrevented&&fn.aa.h.call(this)}}A(fn,ze);var Dt={2:"touch",3:"pen",4:"mouse"};fn.prototype.h=function(){fn.aa.h.call(this);var a=this.i;a.preventDefault?a.preventDefault():a.returnValue=!1};var M="closure_listenable_"+(1e6*Math.random()|0),X=0;function Y(a,h,d,g,k){this.listener=a,this.proxy=null,this.src=h,this.type=d,this.capture=!!g,this.ha=k,this.key=++X,this.da=this.fa=!1}function ne(a){a.da=!0,a.listener=null,a.proxy=null,a.src=null,a.ha=null}function Re(a){this.src=a,this.g={},this.h=0}Re.prototype.add=function(a,h,d,g,k){var V=a.toString();a=this.g[V],a||(a=this.g[V]=[],this.h++);var G=I(a,h,g,k);return-1<G?(h=a[G],d||(h.fa=!1)):(h=new Y(h,this.src,V,!!g,k),h.fa=d,a.push(h)),h};function T(a,h){var d=h.type;if(d in a.g){var g=a.g[d],k=Array.prototype.indexOf.call(g,h,void 0),V;(V=0<=k)&&Array.prototype.splice.call(g,k,1),V&&(ne(h),a.g[d].length==0&&(delete a.g[d],a.h--))}}function I(a,h,d,g){for(var k=0;k<a.length;++k){var V=a[k];if(!V.da&&V.listener==h&&V.capture==!!d&&V.ha==g)return k}return-1}var P="closure_lm_"+(1e6*Math.random()|0),L={};function B(a,h,d,g,k){if(Array.isArray(h)){for(var V=0;V<h.length;V++)B(a,h[V],d,g,k);return null}return d=ue(d),a&&a[M]?a.K(h,d,u(g)?!!g.capture:!1,k):U(a,h,d,!1,g,k)}function U(a,h,d,g,k,V){if(!h)throw Error("Invalid event type");var G=u(k)?!!k.capture:!!k,Ve=J(a);if(Ve||(a[P]=Ve=new Re(a)),d=Ve.add(h,d,g,G,V),d.proxy)return d;if(g=Q(),d.proxy=g,g.src=a,g.listener=d,a.addEventListener)Yn||(k=G),k===void 0&&(k=!1),a.addEventListener(h.toString(),g,k);else if(a.attachEvent)a.attachEvent(z(h.toString()),g);else if(a.addListener&&a.removeListener)a.addListener(g);else throw Error("addEventListener and attachEvent are unavailable.");return d}function Q(){function a(d){return h.call(a.src,a.listener,d)}const h=oe;return a}function K(a,h,d,g,k){if(Array.isArray(h))for(var V=0;V<h.length;V++)K(a,h[V],d,g,k);else g=u(g)?!!g.capture:!!g,d=ue(d),a&&a[M]?(a=a.i,h=String(h).toString(),h in a.g&&(V=a.g[h],d=I(V,d,g,k),-1<d&&(ne(V[d]),Array.prototype.splice.call(V,d,1),V.length==0&&(delete a.g[h],a.h--)))):a&&(a=J(a))&&(h=a.g[h.toString()],a=-1,h&&(a=I(h,d,g,k)),(d=-1<a?h[a]:null)&&W(d))}function W(a){if(typeof a!="number"&&a&&!a.da){var h=a.src;if(h&&h[M])T(h.i,a);else{var d=a.type,g=a.proxy;h.removeEventListener?h.removeEventListener(d,g,a.capture):h.detachEvent?h.detachEvent(z(d),g):h.addListener&&h.removeListener&&h.removeListener(g),(d=J(h))?(T(d,a),d.h==0&&(d.src=null,h[P]=null)):ne(a)}}}function z(a){return a in L?L[a]:L[a]="on"+a}function oe(a,h){if(a.da)a=!0;else{h=new fn(h,this);var d=a.listener,g=a.ha||a.src;a.fa&&W(a),a=d.call(g,h)}return a}function J(a){return a=a[P],a instanceof Re?a:null}var re="__closure_events_fn_"+(1e9*Math.random()>>>0);function ue(a){return typeof a=="function"?a:(a[re]||(a[re]=function(h){return a.handleEvent(h)}),a[re])}function ae(){He.call(this),this.i=new Re(this),this.M=this,this.F=null}A(ae,He),ae.prototype[M]=!0,ae.prototype.removeEventListener=function(a,h,d,g){K(this,a,h,d,g)};function ge(a,h){var d,g=a.F;if(g)for(d=[];g;g=g.F)d.push(g);if(a=a.M,g=h.type||h,typeof h=="string")h=new ze(h,a);else if(h instanceof ze)h.target=h.target||a;else{var k=h;h=new ze(g,a),w(h,k)}if(k=!0,d)for(var V=d.length-1;0<=V;V--){var G=h.g=d[V];k=be(G,g,!0,h)&&k}if(G=h.g=a,k=be(G,g,!0,h)&&k,k=be(G,g,!1,h)&&k,d)for(V=0;V<d.length;V++)G=h.g=d[V],k=be(G,g,!1,h)&&k}ae.prototype.N=function(){if(ae.aa.N.call(this),this.i){var a=this.i,h;for(h in a.g){for(var d=a.g[h],g=0;g<d.length;g++)ne(d[g]);delete a.g[h],a.h--}}this.F=null},ae.prototype.K=function(a,h,d,g){return this.i.add(String(a),h,!1,d,g)},ae.prototype.L=function(a,h,d,g){return this.i.add(String(a),h,!0,d,g)};function be(a,h,d,g){if(h=a.i.g[String(h)],!h)return!0;h=h.concat();for(var k=!0,V=0;V<h.length;++V){var G=h[V];if(G&&!G.da&&G.capture==d){var Ve=G.listener,ut=G.ha||G.src;G.fa&&T(a.i,G),k=Ve.call(ut,g)!==!1&&k}}return k&&!g.defaultPrevented}function mt(a,h,d){if(typeof a=="function")d&&(a=m(a,d));else if(a&&typeof a.handleEvent=="function")a=m(a.handleEvent,a);else throw Error("Invalid listener argument");return 2147483647<Number(h)?-1:l.setTimeout(a,h||0)}function lt(a){a.g=mt(()=>{a.g=null,a.i&&(a.i=!1,lt(a))},a.l);const h=a.h;a.h=null,a.m.apply(null,h)}class Kt extends He{constructor(h,d){super(),this.m=h,this.l=d,this.h=null,this.i=!1,this.g=null}j(h){this.h=arguments,this.g?this.i=!0:lt(this)}N(){super.N(),this.g&&(l.clearTimeout(this.g),this.g=null,this.i=!1,this.h=null)}}function gt(a){He.call(this),this.h=a,this.g={}}A(gt,He);var Jn=[];function ai(a){te(a.g,function(h,d){this.g.hasOwnProperty(d)&&W(h)},a),a.g={}}gt.prototype.N=function(){gt.aa.N.call(this),ai(this)},gt.prototype.handleEvent=function(){throw Error("EventHandler.handleEvent not implemented")};var ct=l.JSON.stringify,Gt=l.JSON.parse,Vo=class{stringify(a){return l.JSON.stringify(a,void 0)}parse(a){return l.JSON.parse(a,void 0)}};function zl(){}zl.prototype.h=null;function Gh(a){return a.h||(a.h=a.i())}function Qh(){}var li={OPEN:"a",kb:"b",Ja:"c",wb:"d"};function Wl(){ze.call(this,"d")}A(Wl,ze);function Kl(){ze.call(this,"c")}A(Kl,ze);var Nr={},Yh=null;function No(){return Yh=Yh||new ae}Nr.La="serverreachability";function Jh(a){ze.call(this,Nr.La,a)}A(Jh,ze);function ci(a){const h=No();ge(h,new Jh(h))}Nr.STAT_EVENT="statevent";function Xh(a,h){ze.call(this,Nr.STAT_EVENT,a),this.stat=h}A(Xh,ze);function Rt(a){const h=No();ge(h,new Xh(h,a))}Nr.Ma="timingevent";function Zh(a,h){ze.call(this,Nr.Ma,a),this.size=h}A(Zh,ze);function ui(a,h){if(typeof a!="function")throw Error("Fn must not be null and must be a function");return l.setTimeout(function(){a()},h)}function hi(){this.g=!0}hi.prototype.xa=function(){this.g=!1};function RE(a,h,d,g,k,V){a.info(function(){if(a.g)if(V)for(var G="",Ve=V.split("&"),ut=0;ut<Ve.length;ut++){var Se=Ve[ut].split("=");if(1<Se.length){var _t=Se[0];Se=Se[1];var yt=_t.split("_");G=2<=yt.length&&yt[1]=="type"?G+(_t+"="+Se+"&"):G+(_t+"=redacted&")}}else G=null;else G=V;return"XMLHTTP REQ ("+g+") [attempt "+k+"]: "+h+`
`+d+`
`+G})}function SE(a,h,d,g,k,V,G){a.info(function(){return"XMLHTTP RESP ("+g+") [ attempt "+k+"]: "+h+`
`+d+`
`+V+" "+G})}function ps(a,h,d,g){a.info(function(){return"XMLHTTP TEXT ("+h+"): "+PE(a,d)+(g?" "+g:"")})}function CE(a,h){a.info(function(){return"TIMEOUT: "+h})}hi.prototype.info=function(){};function PE(a,h){if(!a.g)return h;if(!h)return null;try{var d=JSON.parse(h);if(d){for(a=0;a<d.length;a++)if(Array.isArray(d[a])){var g=d[a];if(!(2>g.length)){var k=g[1];if(Array.isArray(k)&&!(1>k.length)){var V=k[0];if(V!="noop"&&V!="stop"&&V!="close")for(var G=1;G<k.length;G++)k[G]=""}}}}return ct(d)}catch{return h}}var Mo={NO_ERROR:0,gb:1,tb:2,sb:3,nb:4,rb:5,ub:6,Ia:7,TIMEOUT:8,xb:9},ef={lb:"complete",Hb:"success",Ja:"error",Ia:"abort",zb:"ready",Ab:"readystatechange",TIMEOUT:"timeout",vb:"incrementaldata",yb:"progress",ob:"downloadprogress",Pb:"uploadprogress"},Gl;function Lo(){}A(Lo,zl),Lo.prototype.g=function(){return new XMLHttpRequest},Lo.prototype.i=function(){return{}},Gl=new Lo;function Xn(a,h,d,g){this.j=a,this.i=h,this.l=d,this.R=g||1,this.U=new gt(this),this.I=45e3,this.H=null,this.o=!1,this.m=this.A=this.v=this.L=this.F=this.S=this.B=null,this.D=[],this.g=null,this.C=0,this.s=this.u=null,this.X=-1,this.J=!1,this.O=0,this.M=null,this.W=this.K=this.T=this.P=!1,this.h=new tf}function tf(){this.i=null,this.g="",this.h=!1}var nf={},Ql={};function Yl(a,h,d){a.L=1,a.v=jo(Rn(h)),a.m=d,a.P=!0,rf(a,null)}function rf(a,h){a.F=Date.now(),Fo(a),a.A=Rn(a.v);var d=a.A,g=a.R;Array.isArray(g)||(g=[String(g)]),yf(d.i,"t",g),a.C=0,d=a.j.J,a.h=new tf,a.g=Mf(a.j,d?h:null,!a.m),0<a.O&&(a.M=new Kt(m(a.Y,a,a.g),a.O)),h=a.U,d=a.g,g=a.ca;var k="readystatechange";Array.isArray(k)||(k&&(Jn[0]=k.toString()),k=Jn);for(var V=0;V<k.length;V++){var G=B(d,k[V],g||h.handleEvent,!1,h.h||h);if(!G)break;h.g[G.key]=G}h=a.H?v(a.H):{},a.m?(a.u||(a.u="POST"),h["Content-Type"]="application/x-www-form-urlencoded",a.g.ea(a.A,a.u,a.m,h)):(a.u="GET",a.g.ea(a.A,a.u,null,h)),ci(),RE(a.i,a.u,a.A,a.l,a.R,a.m)}Xn.prototype.ca=function(a){a=a.target;const h=this.M;h&&Sn(a)==3?h.j():this.Y(a)},Xn.prototype.Y=function(a){try{if(a==this.g)e:{const yt=Sn(this.g);var h=this.g.Ba();const _s=this.g.Z();if(!(3>yt)&&(yt!=3||this.g&&(this.h.h||this.g.oa()||Af(this.g)))){this.J||yt!=4||h==7||(h==8||0>=_s?ci(3):ci(2)),Jl(this);var d=this.g.Z();this.X=d;t:if(sf(this)){var g=Af(this.g);a="";var k=g.length,V=Sn(this.g)==4;if(!this.h.i){if(typeof TextDecoder>"u"){Mr(this),fi(this);var G="";break t}this.h.i=new l.TextDecoder}for(h=0;h<k;h++)this.h.h=!0,a+=this.h.i.decode(g[h],{stream:!(V&&h==k-1)});g.length=0,this.h.g+=a,this.C=0,G=this.h.g}else G=this.g.oa();if(this.o=d==200,SE(this.i,this.u,this.A,this.l,this.R,yt,d),this.o){if(this.T&&!this.K){t:{if(this.g){var Ve,ut=this.g;if((Ve=ut.g?ut.g.getResponseHeader("X-HTTP-Initial-Response"):null)&&!j(Ve)){var Se=Ve;break t}}Se=null}if(d=Se)ps(this.i,this.l,d,"Initial handshake response via X-HTTP-Initial-Response"),this.K=!0,Xl(this,d);else{this.o=!1,this.s=3,Rt(12),Mr(this),fi(this);break e}}if(this.P){d=!0;let rn;for(;!this.J&&this.C<G.length;)if(rn=kE(this,G),rn==Ql){yt==4&&(this.s=4,Rt(14),d=!1),ps(this.i,this.l,null,"[Incomplete Response]");break}else if(rn==nf){this.s=4,Rt(15),ps(this.i,this.l,G,"[Invalid Chunk]"),d=!1;break}else ps(this.i,this.l,rn,null),Xl(this,rn);if(sf(this)&&this.C!=0&&(this.h.g=this.h.g.slice(this.C),this.C=0),yt!=4||G.length!=0||this.h.h||(this.s=1,Rt(16),d=!1),this.o=this.o&&d,!d)ps(this.i,this.l,G,"[Invalid Chunked Response]"),Mr(this),fi(this);else if(0<G.length&&!this.W){this.W=!0;var _t=this.j;_t.g==this&&_t.ba&&!_t.M&&(_t.j.info("Great, no buffering proxy detected. Bytes received: "+G.length),sc(_t),_t.M=!0,Rt(11))}}else ps(this.i,this.l,G,null),Xl(this,G);yt==4&&Mr(this),this.o&&!this.J&&(yt==4?Df(this.j,this):(this.o=!1,Fo(this)))}else KE(this.g),d==400&&0<G.indexOf("Unknown SID")?(this.s=3,Rt(12)):(this.s=0,Rt(13)),Mr(this),fi(this)}}}catch{}finally{}};function sf(a){return a.g?a.u=="GET"&&a.L!=2&&a.j.Ca:!1}function kE(a,h){var d=a.C,g=h.indexOf(`
`,d);return g==-1?Ql:(d=Number(h.substring(d,g)),isNaN(d)?nf:(g+=1,g+d>h.length?Ql:(h=h.slice(g,g+d),a.C=g+d,h)))}Xn.prototype.cancel=function(){this.J=!0,Mr(this)};function Fo(a){a.S=Date.now()+a.I,of(a,a.I)}function of(a,h){if(a.B!=null)throw Error("WatchDog timer not null");a.B=ui(m(a.ba,a),h)}function Jl(a){a.B&&(l.clearTimeout(a.B),a.B=null)}Xn.prototype.ba=function(){this.B=null;const a=Date.now();0<=a-this.S?(CE(this.i,this.A),this.L!=2&&(ci(),Rt(17)),Mr(this),this.s=2,fi(this)):of(this,this.S-a)};function fi(a){a.j.G==0||a.J||Df(a.j,a)}function Mr(a){Jl(a);var h=a.M;h&&typeof h.ma=="function"&&h.ma(),a.M=null,ai(a.U),a.g&&(h=a.g,a.g=null,h.abort(),h.ma())}function Xl(a,h){try{var d=a.j;if(d.G!=0&&(d.g==a||Zl(d.h,a))){if(!a.K&&Zl(d.h,a)&&d.G==3){try{var g=d.Da.g.parse(h)}catch{g=null}if(Array.isArray(g)&&g.length==3){var k=g;if(k[0]==0){e:if(!d.u){if(d.g)if(d.g.F+3e3<a.F)Ko(d),zo(d);else break e;rc(d),Rt(18)}}else d.za=k[1],0<d.za-d.T&&37500>k[2]&&d.F&&d.v==0&&!d.C&&(d.C=ui(m(d.Za,d),6e3));if(1>=cf(d.h)&&d.ca){try{d.ca()}catch{}d.ca=void 0}}else Fr(d,11)}else if((a.K||d.g==a)&&Ko(d),!j(h))for(k=d.Da.g.parse(h),h=0;h<k.length;h++){let Se=k[h];if(d.T=Se[0],Se=Se[1],d.G==2)if(Se[0]=="c"){d.K=Se[1],d.ia=Se[2];const _t=Se[3];_t!=null&&(d.la=_t,d.j.info("VER="+d.la));const yt=Se[4];yt!=null&&(d.Aa=yt,d.j.info("SVER="+d.Aa));const _s=Se[5];_s!=null&&typeof _s=="number"&&0<_s&&(g=1.5*_s,d.L=g,d.j.info("backChannelRequestTimeoutMs_="+g)),g=d;const rn=a.g;if(rn){const Qo=rn.g?rn.g.getResponseHeader("X-Client-Wire-Protocol"):null;if(Qo){var V=g.h;V.g||Qo.indexOf("spdy")==-1&&Qo.indexOf("quic")==-1&&Qo.indexOf("h2")==-1||(V.j=V.l,V.g=new Set,V.h&&(ec(V,V.h),V.h=null))}if(g.D){const ic=rn.g?rn.g.getResponseHeader("X-HTTP-Session-Id"):null;ic&&(g.ya=ic,Ue(g.I,g.D,ic))}}d.G=3,d.l&&d.l.ua(),d.ba&&(d.R=Date.now()-a.F,d.j.info("Handshake RTT: "+d.R+"ms")),g=d;var G=a;if(g.qa=Nf(g,g.J?g.ia:null,g.W),G.K){uf(g.h,G);var Ve=G,ut=g.L;ut&&(Ve.I=ut),Ve.B&&(Jl(Ve),Fo(Ve)),g.g=G}else kf(g);0<d.i.length&&Wo(d)}else Se[0]!="stop"&&Se[0]!="close"||Fr(d,7);else d.G==3&&(Se[0]=="stop"||Se[0]=="close"?Se[0]=="stop"?Fr(d,7):nc(d):Se[0]!="noop"&&d.l&&d.l.ta(Se),d.v=0)}}ci(4)}catch{}}var OE=class{constructor(a,h){this.g=a,this.map=h}};function af(a){this.l=a||10,l.PerformanceNavigationTiming?(a=l.performance.getEntriesByType("navigation"),a=0<a.length&&(a[0].nextHopProtocol=="hq"||a[0].nextHopProtocol=="h2")):a=!!(l.chrome&&l.chrome.loadTimes&&l.chrome.loadTimes()&&l.chrome.loadTimes().wasFetchedViaSpdy),this.j=a?this.l:1,this.g=null,1<this.j&&(this.g=new Set),this.h=null,this.i=[]}function lf(a){return a.h?!0:a.g?a.g.size>=a.j:!1}function cf(a){return a.h?1:a.g?a.g.size:0}function Zl(a,h){return a.h?a.h==h:a.g?a.g.has(h):!1}function ec(a,h){a.g?a.g.add(h):a.h=h}function uf(a,h){a.h&&a.h==h?a.h=null:a.g&&a.g.has(h)&&a.g.delete(h)}af.prototype.cancel=function(){if(this.i=hf(this),this.h)this.h.cancel(),this.h=null;else if(this.g&&this.g.size!==0){for(const a of this.g.values())a.cancel();this.g.clear()}};function hf(a){if(a.h!=null)return a.i.concat(a.h.D);if(a.g!=null&&a.g.size!==0){let h=a.i;for(const d of a.g.values())h=h.concat(d.D);return h}return O(a.i)}function DE(a){if(a.V&&typeof a.V=="function")return a.V();if(typeof Map<"u"&&a instanceof Map||typeof Set<"u"&&a instanceof Set)return Array.from(a.values());if(typeof a=="string")return a.split("");if(c(a)){for(var h=[],d=a.length,g=0;g<d;g++)h.push(a[g]);return h}h=[],d=0;for(g in a)h[d++]=a[g];return h}function xE(a){if(a.na&&typeof a.na=="function")return a.na();if(!a.V||typeof a.V!="function"){if(typeof Map<"u"&&a instanceof Map)return Array.from(a.keys());if(!(typeof Set<"u"&&a instanceof Set)){if(c(a)||typeof a=="string"){var h=[];a=a.length;for(var d=0;d<a;d++)h.push(d);return h}h=[],d=0;for(const g in a)h[d++]=g;return h}}}function ff(a,h){if(a.forEach&&typeof a.forEach=="function")a.forEach(h,void 0);else if(c(a)||typeof a=="string")Array.prototype.forEach.call(a,h,void 0);else for(var d=xE(a),g=DE(a),k=g.length,V=0;V<k;V++)h.call(void 0,g[V],d&&d[V],a)}var df=RegExp("^(?:([^:/?#.]+):)?(?://(?:([^\\\\/?#]*)@)?([^\\\\/?#]*?)(?::([0-9]+))?(?=[\\\\/?#]|$))?([^?#]+)?(?:\\?([^#]*))?(?:#([\\s\\S]*))?$");function VE(a,h){if(a){a=a.split("&");for(var d=0;d<a.length;d++){var g=a[d].indexOf("="),k=null;if(0<=g){var V=a[d].substring(0,g);k=a[d].substring(g+1)}else V=a[d];h(V,k?decodeURIComponent(k.replace(/\+/g," ")):"")}}}function Lr(a){if(this.g=this.o=this.j="",this.s=null,this.m=this.l="",this.h=!1,a instanceof Lr){this.h=a.h,Uo(this,a.j),this.o=a.o,this.g=a.g,$o(this,a.s),this.l=a.l;var h=a.i,d=new mi;d.i=h.i,h.g&&(d.g=new Map(h.g),d.h=h.h),pf(this,d),this.m=a.m}else a&&(h=String(a).match(df))?(this.h=!1,Uo(this,h[1]||"",!0),this.o=di(h[2]||""),this.g=di(h[3]||"",!0),$o(this,h[4]),this.l=di(h[5]||"",!0),pf(this,h[6]||"",!0),this.m=di(h[7]||"")):(this.h=!1,this.i=new mi(null,this.h))}Lr.prototype.toString=function(){var a=[],h=this.j;h&&a.push(pi(h,mf,!0),":");var d=this.g;return(d||h=="file")&&(a.push("//"),(h=this.o)&&a.push(pi(h,mf,!0),"@"),a.push(encodeURIComponent(String(d)).replace(/%25([0-9a-fA-F]{2})/g,"%$1")),d=this.s,d!=null&&a.push(":",String(d))),(d=this.l)&&(this.g&&d.charAt(0)!="/"&&a.push("/"),a.push(pi(d,d.charAt(0)=="/"?LE:ME,!0))),(d=this.i.toString())&&a.push("?",d),(d=this.m)&&a.push("#",pi(d,UE)),a.join("")};function Rn(a){return new Lr(a)}function Uo(a,h,d){a.j=d?di(h,!0):h,a.j&&(a.j=a.j.replace(/:$/,""))}function $o(a,h){if(h){if(h=Number(h),isNaN(h)||0>h)throw Error("Bad port number "+h);a.s=h}else a.s=null}function pf(a,h,d){h instanceof mi?(a.i=h,$E(a.i,a.h)):(d||(h=pi(h,FE)),a.i=new mi(h,a.h))}function Ue(a,h,d){a.i.set(h,d)}function jo(a){return Ue(a,"zx",Math.floor(2147483648*Math.random()).toString(36)+Math.abs(Math.floor(2147483648*Math.random())^Date.now()).toString(36)),a}function di(a,h){return a?h?decodeURI(a.replace(/%25/g,"%2525")):decodeURIComponent(a):""}function pi(a,h,d){return typeof a=="string"?(a=encodeURI(a).replace(h,NE),d&&(a=a.replace(/%25([0-9a-fA-F]{2})/g,"%$1")),a):null}function NE(a){return a=a.charCodeAt(0),"%"+(a>>4&15).toString(16)+(a&15).toString(16)}var mf=/[#\/\?@]/g,ME=/[#\?:]/g,LE=/[#\?]/g,FE=/[#\?@]/g,UE=/#/g;function mi(a,h){this.h=this.g=null,this.i=a||null,this.j=!!h}function Zn(a){a.g||(a.g=new Map,a.h=0,a.i&&VE(a.i,function(h,d){a.add(decodeURIComponent(h.replace(/\+/g," ")),d)}))}t=mi.prototype,t.add=function(a,h){Zn(this),this.i=null,a=ms(this,a);var d=this.g.get(a);return d||this.g.set(a,d=[]),d.push(h),this.h+=1,this};function gf(a,h){Zn(a),h=ms(a,h),a.g.has(h)&&(a.i=null,a.h-=a.g.get(h).length,a.g.delete(h))}function _f(a,h){return Zn(a),h=ms(a,h),a.g.has(h)}t.forEach=function(a,h){Zn(this),this.g.forEach(function(d,g){d.forEach(function(k){a.call(h,k,g,this)},this)},this)},t.na=function(){Zn(this);const a=Array.from(this.g.values()),h=Array.from(this.g.keys()),d=[];for(let g=0;g<h.length;g++){const k=a[g];for(let V=0;V<k.length;V++)d.push(h[g])}return d},t.V=function(a){Zn(this);let h=[];if(typeof a=="string")_f(this,a)&&(h=h.concat(this.g.get(ms(this,a))));else{a=Array.from(this.g.values());for(let d=0;d<a.length;d++)h=h.concat(a[d])}return h},t.set=function(a,h){return Zn(this),this.i=null,a=ms(this,a),_f(this,a)&&(this.h-=this.g.get(a).length),this.g.set(a,[h]),this.h+=1,this},t.get=function(a,h){return a?(a=this.V(a),0<a.length?String(a[0]):h):h};function yf(a,h,d){gf(a,h),0<d.length&&(a.i=null,a.g.set(ms(a,h),O(d)),a.h+=d.length)}t.toString=function(){if(this.i)return this.i;if(!this.g)return"";const a=[],h=Array.from(this.g.keys());for(var d=0;d<h.length;d++){var g=h[d];const V=encodeURIComponent(String(g)),G=this.V(g);for(g=0;g<G.length;g++){var k=V;G[g]!==""&&(k+="="+encodeURIComponent(String(G[g]))),a.push(k)}}return this.i=a.join("&")};function ms(a,h){return h=String(h),a.j&&(h=h.toLowerCase()),h}function $E(a,h){h&&!a.j&&(Zn(a),a.i=null,a.g.forEach(function(d,g){var k=g.toLowerCase();g!=k&&(gf(this,g),yf(this,k,d))},a)),a.j=h}function jE(a,h){const d=new hi;if(l.Image){const g=new Image;g.onload=_(er,d,"TestLoadImage: loaded",!0,h,g),g.onerror=_(er,d,"TestLoadImage: error",!1,h,g),g.onabort=_(er,d,"TestLoadImage: abort",!1,h,g),g.ontimeout=_(er,d,"TestLoadImage: timeout",!1,h,g),l.setTimeout(function(){g.ontimeout&&g.ontimeout()},1e4),g.src=a}else h(!1)}function BE(a,h){const d=new hi,g=new AbortController,k=setTimeout(()=>{g.abort(),er(d,"TestPingServer: timeout",!1,h)},1e4);fetch(a,{signal:g.signal}).then(V=>{clearTimeout(k),V.ok?er(d,"TestPingServer: ok",!0,h):er(d,"TestPingServer: server error",!1,h)}).catch(()=>{clearTimeout(k),er(d,"TestPingServer: error",!1,h)})}function er(a,h,d,g,k){try{k&&(k.onload=null,k.onerror=null,k.onabort=null,k.ontimeout=null),g(d)}catch{}}function qE(){this.g=new Vo}function HE(a,h,d){const g=d||"";try{ff(a,function(k,V){let G=k;u(k)&&(G=ct(k)),h.push(g+V+"="+encodeURIComponent(G))})}catch(k){throw h.push(g+"type="+encodeURIComponent("_badmap")),k}}function Bo(a){this.l=a.Ub||null,this.j=a.eb||!1}A(Bo,zl),Bo.prototype.g=function(){return new qo(this.l,this.j)},Bo.prototype.i=function(a){return function(){return a}}({});function qo(a,h){ae.call(this),this.D=a,this.o=h,this.m=void 0,this.status=this.readyState=0,this.responseType=this.responseText=this.response=this.statusText="",this.onreadystatechange=null,this.u=new Headers,this.h=null,this.B="GET",this.A="",this.g=!1,this.v=this.j=this.l=null}A(qo,ae),t=qo.prototype,t.open=function(a,h){if(this.readyState!=0)throw this.abort(),Error("Error reopening a connection");this.B=a,this.A=h,this.readyState=1,_i(this)},t.send=function(a){if(this.readyState!=1)throw this.abort(),Error("need to call open() first. ");this.g=!0;const h={headers:this.u,method:this.B,credentials:this.m,cache:void 0};a&&(h.body=a),(this.D||l).fetch(new Request(this.A,h)).then(this.Sa.bind(this),this.ga.bind(this))},t.abort=function(){this.response=this.responseText="",this.u=new Headers,this.status=0,this.j&&this.j.cancel("Request was aborted.").catch(()=>{}),1<=this.readyState&&this.g&&this.readyState!=4&&(this.g=!1,gi(this)),this.readyState=0},t.Sa=function(a){if(this.g&&(this.l=a,this.h||(this.status=this.l.status,this.statusText=this.l.statusText,this.h=a.headers,this.readyState=2,_i(this)),this.g&&(this.readyState=3,_i(this),this.g)))if(this.responseType==="arraybuffer")a.arrayBuffer().then(this.Qa.bind(this),this.ga.bind(this));else if(typeof l.ReadableStream<"u"&&"body"in a){if(this.j=a.body.getReader(),this.o){if(this.responseType)throw Error('responseType must be empty for "streamBinaryChunks" mode responses.');this.response=[]}else this.response=this.responseText="",this.v=new TextDecoder;vf(this)}else a.text().then(this.Ra.bind(this),this.ga.bind(this))};function vf(a){a.j.read().then(a.Pa.bind(a)).catch(a.ga.bind(a))}t.Pa=function(a){if(this.g){if(this.o&&a.value)this.response.push(a.value);else if(!this.o){var h=a.value?a.value:new Uint8Array(0);(h=this.v.decode(h,{stream:!a.done}))&&(this.response=this.responseText+=h)}a.done?gi(this):_i(this),this.readyState==3&&vf(this)}},t.Ra=function(a){this.g&&(this.response=this.responseText=a,gi(this))},t.Qa=function(a){this.g&&(this.response=a,gi(this))},t.ga=function(){this.g&&gi(this)};function gi(a){a.readyState=4,a.l=null,a.j=null,a.v=null,_i(a)}t.setRequestHeader=function(a,h){this.u.append(a,h)},t.getResponseHeader=function(a){return this.h&&this.h.get(a.toLowerCase())||""},t.getAllResponseHeaders=function(){if(!this.h)return"";const a=[],h=this.h.entries();for(var d=h.next();!d.done;)d=d.value,a.push(d[0]+": "+d[1]),d=h.next();return a.join(`\r
`)};function _i(a){a.onreadystatechange&&a.onreadystatechange.call(a)}Object.defineProperty(qo.prototype,"withCredentials",{get:function(){return this.m==="include"},set:function(a){this.m=a?"include":"same-origin"}});function Ef(a){let h="";return te(a,function(d,g){h+=g,h+=":",h+=d,h+=`\r
`}),h}function tc(a,h,d){e:{for(g in d){var g=!1;break e}g=!0}g||(d=Ef(d),typeof a=="string"?d!=null&&encodeURIComponent(String(d)):Ue(a,h,d))}function Qe(a){ae.call(this),this.headers=new Map,this.o=a||null,this.h=!1,this.v=this.g=null,this.D="",this.m=0,this.l="",this.j=this.B=this.u=this.A=!1,this.I=null,this.H="",this.J=!1}A(Qe,ae);var zE=/^https?$/i,WE=["POST","PUT"];t=Qe.prototype,t.Ha=function(a){this.J=a},t.ea=function(a,h,d,g){if(this.g)throw Error("[goog.net.XhrIo] Object is active with another request="+this.D+"; newUri="+a);h=h?h.toUpperCase():"GET",this.D=a,this.l="",this.m=0,this.A=!1,this.h=!0,this.g=this.o?this.o.g():Gl.g(),this.v=this.o?Gh(this.o):Gh(Gl),this.g.onreadystatechange=m(this.Ea,this);try{this.B=!0,this.g.open(h,String(a),!0),this.B=!1}catch(V){Tf(this,V);return}if(a=d||"",d=new Map(this.headers),g)if(Object.getPrototypeOf(g)===Object.prototype)for(var k in g)d.set(k,g[k]);else if(typeof g.keys=="function"&&typeof g.get=="function")for(const V of g.keys())d.set(V,g.get(V));else throw Error("Unknown input type for opt_headers: "+String(g));g=Array.from(d.keys()).find(V=>V.toLowerCase()=="content-type"),k=l.FormData&&a instanceof l.FormData,!(0<=Array.prototype.indexOf.call(WE,h,void 0))||g||k||d.set("Content-Type","application/x-www-form-urlencoded;charset=utf-8");for(const[V,G]of d)this.g.setRequestHeader(V,G);this.H&&(this.g.responseType=this.H),"withCredentials"in this.g&&this.g.withCredentials!==this.J&&(this.g.withCredentials=this.J);try{bf(this),this.u=!0,this.g.send(a),this.u=!1}catch(V){Tf(this,V)}};function Tf(a,h){a.h=!1,a.g&&(a.j=!0,a.g.abort(),a.j=!1),a.l=h,a.m=5,wf(a),Ho(a)}function wf(a){a.A||(a.A=!0,ge(a,"complete"),ge(a,"error"))}t.abort=function(a){this.g&&this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1,this.m=a||7,ge(this,"complete"),ge(this,"abort"),Ho(this))},t.N=function(){this.g&&(this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1),Ho(this,!0)),Qe.aa.N.call(this)},t.Ea=function(){this.s||(this.B||this.u||this.j?If(this):this.bb())},t.bb=function(){If(this)};function If(a){if(a.h&&typeof o<"u"&&(!a.v[1]||Sn(a)!=4||a.Z()!=2)){if(a.u&&Sn(a)==4)mt(a.Ea,0,a);else if(ge(a,"readystatechange"),Sn(a)==4){a.h=!1;try{const G=a.Z();e:switch(G){case 200:case 201:case 202:case 204:case 206:case 304:case 1223:var h=!0;break e;default:h=!1}var d;if(!(d=h)){var g;if(g=G===0){var k=String(a.D).match(df)[1]||null;!k&&l.self&&l.self.location&&(k=l.self.location.protocol.slice(0,-1)),g=!zE.test(k?k.toLowerCase():"")}d=g}if(d)ge(a,"complete"),ge(a,"success");else{a.m=6;try{var V=2<Sn(a)?a.g.statusText:""}catch{V=""}a.l=V+" ["+a.Z()+"]",wf(a)}}finally{Ho(a)}}}}function Ho(a,h){if(a.g){bf(a);const d=a.g,g=a.v[0]?()=>{}:null;a.g=null,a.v=null,h||ge(a,"ready");try{d.onreadystatechange=g}catch{}}}function bf(a){a.I&&(l.clearTimeout(a.I),a.I=null)}t.isActive=function(){return!!this.g};function Sn(a){return a.g?a.g.readyState:0}t.Z=function(){try{return 2<Sn(this)?this.g.status:-1}catch{return-1}},t.oa=function(){try{return this.g?this.g.responseText:""}catch{return""}},t.Oa=function(a){if(this.g){var h=this.g.responseText;return a&&h.indexOf(a)==0&&(h=h.substring(a.length)),Gt(h)}};function Af(a){try{if(!a.g)return null;if("response"in a.g)return a.g.response;switch(a.H){case"":case"text":return a.g.responseText;case"arraybuffer":if("mozResponseArrayBuffer"in a.g)return a.g.mozResponseArrayBuffer}return null}catch{return null}}function KE(a){const h={};a=(a.g&&2<=Sn(a)&&a.g.getAllResponseHeaders()||"").split(`\r
`);for(let g=0;g<a.length;g++){if(j(a[g]))continue;var d=S(a[g]);const k=d[0];if(d=d[1],typeof d!="string")continue;d=d.trim();const V=h[k]||[];h[k]=V,V.push(d)}R(h,function(g){return g.join(", ")})}t.Ba=function(){return this.m},t.Ka=function(){return typeof this.l=="string"?this.l:String(this.l)};function yi(a,h,d){return d&&d.internalChannelParams&&d.internalChannelParams[a]||h}function Rf(a){this.Aa=0,this.i=[],this.j=new hi,this.ia=this.qa=this.I=this.W=this.g=this.ya=this.D=this.H=this.m=this.S=this.o=null,this.Ya=this.U=0,this.Va=yi("failFast",!1,a),this.F=this.C=this.u=this.s=this.l=null,this.X=!0,this.za=this.T=-1,this.Y=this.v=this.B=0,this.Ta=yi("baseRetryDelayMs",5e3,a),this.cb=yi("retryDelaySeedMs",1e4,a),this.Wa=yi("forwardChannelMaxRetries",2,a),this.wa=yi("forwardChannelRequestTimeoutMs",2e4,a),this.pa=a&&a.xmlHttpFactory||void 0,this.Xa=a&&a.Tb||void 0,this.Ca=a&&a.useFetchStreams||!1,this.L=void 0,this.J=a&&a.supportsCrossDomainXhr||!1,this.K="",this.h=new af(a&&a.concurrentRequestLimit),this.Da=new qE,this.P=a&&a.fastHandshake||!1,this.O=a&&a.encodeInitMessageHeaders||!1,this.P&&this.O&&(this.O=!1),this.Ua=a&&a.Rb||!1,a&&a.xa&&this.j.xa(),a&&a.forceLongPolling&&(this.X=!1),this.ba=!this.P&&this.X&&a&&a.detectBufferingProxy||!1,this.ja=void 0,a&&a.longPollingTimeout&&0<a.longPollingTimeout&&(this.ja=a.longPollingTimeout),this.ca=void 0,this.R=0,this.M=!1,this.ka=this.A=null}t=Rf.prototype,t.la=8,t.G=1,t.connect=function(a,h,d,g){Rt(0),this.W=a,this.H=h||{},d&&g!==void 0&&(this.H.OSID=d,this.H.OAID=g),this.F=this.X,this.I=Nf(this,null,this.W),Wo(this)};function nc(a){if(Sf(a),a.G==3){var h=a.U++,d=Rn(a.I);if(Ue(d,"SID",a.K),Ue(d,"RID",h),Ue(d,"TYPE","terminate"),vi(a,d),h=new Xn(a,a.j,h),h.L=2,h.v=jo(Rn(d)),d=!1,l.navigator&&l.navigator.sendBeacon)try{d=l.navigator.sendBeacon(h.v.toString(),"")}catch{}!d&&l.Image&&(new Image().src=h.v,d=!0),d||(h.g=Mf(h.j,null),h.g.ea(h.v)),h.F=Date.now(),Fo(h)}Vf(a)}function zo(a){a.g&&(sc(a),a.g.cancel(),a.g=null)}function Sf(a){zo(a),a.u&&(l.clearTimeout(a.u),a.u=null),Ko(a),a.h.cancel(),a.s&&(typeof a.s=="number"&&l.clearTimeout(a.s),a.s=null)}function Wo(a){if(!lf(a.h)&&!a.s){a.s=!0;var h=a.Ga;he||nn(),Ee||(he(),Ee=!0),Lt.add(h,a),a.B=0}}function GE(a,h){return cf(a.h)>=a.h.j-(a.s?1:0)?!1:a.s?(a.i=h.D.concat(a.i),!0):a.G==1||a.G==2||a.B>=(a.Va?0:a.Wa)?!1:(a.s=ui(m(a.Ga,a,h),xf(a,a.B)),a.B++,!0)}t.Ga=function(a){if(this.s)if(this.s=null,this.G==1){if(!a){this.U=Math.floor(1e5*Math.random()),a=this.U++;const k=new Xn(this,this.j,a);let V=this.o;if(this.S&&(V?(V=v(V),w(V,this.S)):V=this.S),this.m!==null||this.O||(k.H=V,V=null),this.P)e:{for(var h=0,d=0;d<this.i.length;d++){t:{var g=this.i[d];if("__data__"in g.map&&(g=g.map.__data__,typeof g=="string")){g=g.length;break t}g=void 0}if(g===void 0)break;if(h+=g,4096<h){h=d;break e}if(h===4096||d===this.i.length-1){h=d+1;break e}}h=1e3}else h=1e3;h=Pf(this,k,h),d=Rn(this.I),Ue(d,"RID",a),Ue(d,"CVER",22),this.D&&Ue(d,"X-HTTP-Session-Id",this.D),vi(this,d),V&&(this.O?h="headers="+encodeURIComponent(String(Ef(V)))+"&"+h:this.m&&tc(d,this.m,V)),ec(this.h,k),this.Ua&&Ue(d,"TYPE","init"),this.P?(Ue(d,"$req",h),Ue(d,"SID","null"),k.T=!0,Yl(k,d,null)):Yl(k,d,h),this.G=2}}else this.G==3&&(a?Cf(this,a):this.i.length==0||lf(this.h)||Cf(this))};function Cf(a,h){var d;h?d=h.l:d=a.U++;const g=Rn(a.I);Ue(g,"SID",a.K),Ue(g,"RID",d),Ue(g,"AID",a.T),vi(a,g),a.m&&a.o&&tc(g,a.m,a.o),d=new Xn(a,a.j,d,a.B+1),a.m===null&&(d.H=a.o),h&&(a.i=h.D.concat(a.i)),h=Pf(a,d,1e3),d.I=Math.round(.5*a.wa)+Math.round(.5*a.wa*Math.random()),ec(a.h,d),Yl(d,g,h)}function vi(a,h){a.H&&te(a.H,function(d,g){Ue(h,g,d)}),a.l&&ff({},function(d,g){Ue(h,g,d)})}function Pf(a,h,d){d=Math.min(a.i.length,d);var g=a.l?m(a.l.Na,a.l,a):null;e:{var k=a.i;let V=-1;for(;;){const G=["count="+d];V==-1?0<d?(V=k[0].g,G.push("ofs="+V)):V=0:G.push("ofs="+V);let Ve=!0;for(let ut=0;ut<d;ut++){let Se=k[ut].g;const _t=k[ut].map;if(Se-=V,0>Se)V=Math.max(0,k[ut].g-100),Ve=!1;else try{HE(_t,G,"req"+Se+"_")}catch{g&&g(_t)}}if(Ve){g=G.join("&");break e}}}return a=a.i.splice(0,d),h.D=a,g}function kf(a){if(!a.g&&!a.u){a.Y=1;var h=a.Fa;he||nn(),Ee||(he(),Ee=!0),Lt.add(h,a),a.v=0}}function rc(a){return a.g||a.u||3<=a.v?!1:(a.Y++,a.u=ui(m(a.Fa,a),xf(a,a.v)),a.v++,!0)}t.Fa=function(){if(this.u=null,Of(this),this.ba&&!(this.M||this.g==null||0>=this.R)){var a=2*this.R;this.j.info("BP detection timer enabled: "+a),this.A=ui(m(this.ab,this),a)}},t.ab=function(){this.A&&(this.A=null,this.j.info("BP detection timeout reached."),this.j.info("Buffering proxy detected and switch to long-polling!"),this.F=!1,this.M=!0,Rt(10),zo(this),Of(this))};function sc(a){a.A!=null&&(l.clearTimeout(a.A),a.A=null)}function Of(a){a.g=new Xn(a,a.j,"rpc",a.Y),a.m===null&&(a.g.H=a.o),a.g.O=0;var h=Rn(a.qa);Ue(h,"RID","rpc"),Ue(h,"SID",a.K),Ue(h,"AID",a.T),Ue(h,"CI",a.F?"0":"1"),!a.F&&a.ja&&Ue(h,"TO",a.ja),Ue(h,"TYPE","xmlhttp"),vi(a,h),a.m&&a.o&&tc(h,a.m,a.o),a.L&&(a.g.I=a.L);var d=a.g;a=a.ia,d.L=1,d.v=jo(Rn(h)),d.m=null,d.P=!0,rf(d,a)}t.Za=function(){this.C!=null&&(this.C=null,zo(this),rc(this),Rt(19))};function Ko(a){a.C!=null&&(l.clearTimeout(a.C),a.C=null)}function Df(a,h){var d=null;if(a.g==h){Ko(a),sc(a),a.g=null;var g=2}else if(Zl(a.h,h))d=h.D,uf(a.h,h),g=1;else return;if(a.G!=0){if(h.o)if(g==1){d=h.m?h.m.length:0,h=Date.now()-h.F;var k=a.B;g=No(),ge(g,new Zh(g,d)),Wo(a)}else kf(a);else if(k=h.s,k==3||k==0&&0<h.X||!(g==1&&GE(a,h)||g==2&&rc(a)))switch(d&&0<d.length&&(h=a.h,h.i=h.i.concat(d)),k){case 1:Fr(a,5);break;case 4:Fr(a,10);break;case 3:Fr(a,6);break;default:Fr(a,2)}}}function xf(a,h){let d=a.Ta+Math.floor(Math.random()*a.cb);return a.isActive()||(d*=2),d*h}function Fr(a,h){if(a.j.info("Error code "+h),h==2){var d=m(a.fb,a),g=a.Xa;const k=!g;g=new Lr(g||"//www.google.com/images/cleardot.gif"),l.location&&l.location.protocol=="http"||Uo(g,"https"),jo(g),k?jE(g.toString(),d):BE(g.toString(),d)}else Rt(2);a.G=0,a.l&&a.l.sa(h),Vf(a),Sf(a)}t.fb=function(a){a?(this.j.info("Successfully pinged google.com"),Rt(2)):(this.j.info("Failed to ping google.com"),Rt(1))};function Vf(a){if(a.G=0,a.ka=[],a.l){const h=hf(a.h);(h.length!=0||a.i.length!=0)&&(x(a.ka,h),x(a.ka,a.i),a.h.i.length=0,O(a.i),a.i.length=0),a.l.ra()}}function Nf(a,h,d){var g=d instanceof Lr?Rn(d):new Lr(d);if(g.g!="")h&&(g.g=h+"."+g.g),$o(g,g.s);else{var k=l.location;g=k.protocol,h=h?h+"."+k.hostname:k.hostname,k=+k.port;var V=new Lr(null);g&&Uo(V,g),h&&(V.g=h),k&&$o(V,k),d&&(V.l=d),g=V}return d=a.D,h=a.ya,d&&h&&Ue(g,d,h),Ue(g,"VER",a.la),vi(a,g),g}function Mf(a,h,d){if(h&&!a.J)throw Error("Can't create secondary domain capable XhrIo object.");return h=a.Ca&&!a.pa?new Qe(new Bo({eb:d})):new Qe(a.pa),h.Ha(a.J),h}t.isActive=function(){return!!this.l&&this.l.isActive(this)};function Lf(){}t=Lf.prototype,t.ua=function(){},t.ta=function(){},t.sa=function(){},t.ra=function(){},t.isActive=function(){return!0},t.Na=function(){};function Go(){}Go.prototype.g=function(a,h){return new Ft(a,h)};function Ft(a,h){ae.call(this),this.g=new Rf(h),this.l=a,this.h=h&&h.messageUrlParams||null,a=h&&h.messageHeaders||null,h&&h.clientProtocolHeaderRequired&&(a?a["X-Client-Protocol"]="webchannel":a={"X-Client-Protocol":"webchannel"}),this.g.o=a,a=h&&h.initMessageHeaders||null,h&&h.messageContentType&&(a?a["X-WebChannel-Content-Type"]=h.messageContentType:a={"X-WebChannel-Content-Type":h.messageContentType}),h&&h.va&&(a?a["X-WebChannel-Client-Profile"]=h.va:a={"X-WebChannel-Client-Profile":h.va}),this.g.S=a,(a=h&&h.Sb)&&!j(a)&&(this.g.m=a),this.v=h&&h.supportsCrossDomainXhr||!1,this.u=h&&h.sendRawJson||!1,(h=h&&h.httpSessionIdParam)&&!j(h)&&(this.g.D=h,a=this.h,a!==null&&h in a&&(a=this.h,h in a&&delete a[h])),this.j=new gs(this)}A(Ft,ae),Ft.prototype.m=function(){this.g.l=this.j,this.v&&(this.g.J=!0),this.g.connect(this.l,this.h||void 0)},Ft.prototype.close=function(){nc(this.g)},Ft.prototype.o=function(a){var h=this.g;if(typeof a=="string"){var d={};d.__data__=a,a=d}else this.u&&(d={},d.__data__=ct(a),a=d);h.i.push(new OE(h.Ya++,a)),h.G==3&&Wo(h)},Ft.prototype.N=function(){this.g.l=null,delete this.j,nc(this.g),delete this.g,Ft.aa.N.call(this)};function Ff(a){Wl.call(this),a.__headers__&&(this.headers=a.__headers__,this.statusCode=a.__status__,delete a.__headers__,delete a.__status__);var h=a.__sm__;if(h){e:{for(const d in h){a=d;break e}a=void 0}(this.i=a)&&(a=this.i,h=h!==null&&a in h?h[a]:void 0),this.data=h}else this.data=a}A(Ff,Wl);function Uf(){Kl.call(this),this.status=1}A(Uf,Kl);function gs(a){this.g=a}A(gs,Lf),gs.prototype.ua=function(){ge(this.g,"a")},gs.prototype.ta=function(a){ge(this.g,new Ff(a))},gs.prototype.sa=function(a){ge(this.g,new Uf)},gs.prototype.ra=function(){ge(this.g,"b")},Go.prototype.createWebChannel=Go.prototype.g,Ft.prototype.send=Ft.prototype.o,Ft.prototype.open=Ft.prototype.m,Ft.prototype.close=Ft.prototype.close,Y_=function(){return new Go},Q_=function(){return No()},G_=Nr,ru={mb:0,pb:1,qb:2,Jb:3,Ob:4,Lb:5,Mb:6,Kb:7,Ib:8,Nb:9,PROXY:10,NOPROXY:11,Gb:12,Cb:13,Db:14,Bb:15,Eb:16,Fb:17,ib:18,hb:19,jb:20},Mo.NO_ERROR=0,Mo.TIMEOUT=8,Mo.HTTP_ERROR=6,ha=Mo,ef.COMPLETE="complete",K_=ef,Qh.EventType=li,li.OPEN="a",li.CLOSE="b",li.ERROR="c",li.MESSAGE="d",ae.prototype.listen=ae.prototype.K,Ci=Qh,Qe.prototype.listenOnce=Qe.prototype.L,Qe.prototype.getLastError=Qe.prototype.Ka,Qe.prototype.getLastErrorCode=Qe.prototype.Ba,Qe.prototype.getStatus=Qe.prototype.Z,Qe.prototype.getResponseJson=Qe.prototype.Oa,Qe.prototype.getResponseText=Qe.prototype.oa,Qe.prototype.send=Qe.prototype.ea,Qe.prototype.setWithCredentials=Qe.prototype.Ha,W_=Qe}).apply(typeof ea<"u"?ea:typeof self<"u"?self:typeof window<"u"?window:{});const Zd="@firebase/firestore",ep="4.7.12";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ts=new Yu("@firebase/firestore");function ws(){return ts.logLevel}function Z(t,...e){if(ts.logLevel<=Te.DEBUG){const n=e.map(Zu);ts.debug(`Firestore (${Xs}): ${t}`,...n)}}function qn(t,...e){if(ts.logLevel<=Te.ERROR){const n=e.map(Zu);ts.error(`Firestore (${Xs}): ${t}`,...n)}}function $s(t,...e){if(ts.logLevel<=Te.WARN){const n=e.map(Zu);ts.warn(`Firestore (${Xs}): ${t}`,...n)}}function Zu(t){if(typeof t=="string")return t;try{/**
* @license
* Copyright 2020 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const rp=-62135596800,sp=1e6;class tt{static now(){return tt.fromMillis(Date.now())}static fromDate(e){return tt.fromMillis(e.getTime())}static fromMillis(e){const n=Math.floor(e/1e3),r=Math.floor((e-1e3*n)*sp);return new tt(n,r)}constructor(e,n){if(this.seconds=e,this.nanoseconds=n,n<0)throw new ee(F.INVALID_ARGUMENT,"Timestamp nanoseconds out of range: "+n);if(n>=1e9)throw new ee(F.INVALID_ARGUMENT,"Timestamp nanoseconds out of range: "+n);if(e<rp)throw new ee(F.INVALID_ARGUMENT,"Timestamp seconds out of range: "+e);if(e>=253402300800)throw new ee(F.INVALID_ARGUMENT,"Timestamp seconds out of range: "+e)}toDate(){return new Date(this.toMillis())}toMillis(){return 1e3*this.seconds+this.nanoseconds/sp}_compareTo(e){return this.seconds===e.seconds?_e(this.nanoseconds,e.nanoseconds):_e(this.seconds,e.seconds)}isEqual(e){return e.seconds===this.seconds&&e.nanoseconds===this.nanoseconds}toString(){return"Timestamp(seconds="+this.seconds+", nanoseconds="+this.nanoseconds+")"}toJSON(){return{seconds:this.seconds,nanoseconds:this.nanoseconds}}valueOf(){const e=this.seconds-rp;return String(e).padStart(12,"0")+"."+String(this.nanoseconds).padStart(9,"0")}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ap(t){let e=0;for(const n in t)Object.prototype.hasOwnProperty.call(t,n)&&e++;return e}function Or(t,e){for(const n in t)Object.prototype.hasOwnProperty.call(t,n)&&e(n,t[n])}function ny(t){for(const e in t)if(Object.prototype.hasOwnProperty.call(t,e))return!1;return!0}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ti{constructor(e,n=null,r=[],s=[],i=null,o="F",l=null,c=null){this.path=e,this.collectionGroup=n,this.explicitOrderBy=r,this.filters=s,this.limit=i,this.limitType=o,this.startAt=l,this.endAt=c,this.Ee=null,this.de=null,this.Ae=null,this.startAt,this.endAt}}function nR(t,e,n,r,s,i,o,l){return new ti(t,e,n,r,s,i,o,l)}function ih(t){return new ti(t)}function _p(t){return t.filters.length===0&&t.limit===null&&t.startAt==null&&t.endAt==null&&(t.explicitOrderBy.length===0||t.explicitOrderBy.length===1&&t.explicitOrderBy[0].field.isKeyField())}function _y(t){return t.collectionGroup!==null}function qi(t){const e=pe(t);if(e.Ee===null){e.Ee=[];const n=new Set;for(const i of e.explicitOrderBy)e.Ee.push(i),n.add(i.field.canonicalString());const r=e.explicitOrderBy.length>0?e.explicitOrderBy[e.explicitOrderBy.length-1].dir:"asc";(function(o){let l=new nt(dt.comparator);return o.filters.forEach(c=>{c.getFlattenedFilters().forEach(u=>{u.isInequality()&&(l=l.add(u.field))})}),l})(e).forEach(i=>{n.has(i.canonicalString())||i.isKeyField()||e.Ee.push(new lo(i,r))}),n.has(dt.keyField().canonicalString())||e.Ee.push(new lo(dt.keyField(),r))}return e.Ee}function vn(t){const e=pe(t);return e.de||(e.de=rR(e,qi(t))),e.de}function rR(t,e){if(t.limitType==="F")return gp(t.path,t.collectionGroup,e,t.filters,t.limit,t.startAt,t.endAt);{e=e.map(s=>{const i=s.dir==="desc"?"asc":"desc";return new lo(s.field,i)});const n=t.endAt?new $a(t.endAt.position,t.endAt.inclusive):null,r=t.startAt?new $a(t.startAt.position,t.startAt.inclusive):null;return gp(t.path,t.collectionGroup,e,t.filters,t.limit,n,r)}}function cu(t,e){const n=t.filters.concat([e]);return new ti(t.path,t.collectionGroup,t.explicitOrderBy.slice(),n,t.limit,t.limitType,t.startAt,t.endAt)}function uu(t,e,n){return new ti(t.path,t.collectionGroup,t.explicitOrderBy.slice(),t.filters.slice(),e,n,t.startAt,t.endAt)}function wl(t,e){return sh(vn(t),vn(e))&&t.limitType===e.limitType}function yy(t){return`${rh(vn(t))}|lt:${t.limitType}`}function Is(t){return`Query(target=${function(n){let r=n.path.canonicalString();return n.collectionGroup!==null&&(r+=" collectionGroup="+n.collectionGroup),n.filters.length>0&&(r+=`, filters: [${n.filters.map(s=>my(s)).join(", ")}]`),El(n.limit)||(r+=", limit: "+n.limit),n.orderBy.length>0&&(r+=`, orderBy: [${n.orderBy.map(s=>function(o){return`${o.field.canonicalString()} (${o.dir})`}(s)).join(", ")}]`),n.startAt&&(r+=", startAt: ",r+=n.startAt.inclusive?"b:":"a:",r+=n.startAt.position.map(s=>qs(s)).join(",")),n.endAt&&(r+=", endAt: ",r+=n.endAt.inclusive?"a:":"b:",r+=n.endAt.position.map(s=>qs(s)).join(",")),`Target(${r})`}(vn(t))}; limitType=${t.limitType})`}function Il(t,e){return e.isFoundDocument()&&function(r,s){const i=s.key.path;return r.collectionGroup!==null?s.key.hasCollectionId(r.collectionGroup)&&r.path.isPrefixOf(i):se.isDocumentKey(r.path)?r.path.isEqual(i):r.path.isImmediateParentOf(i)}(t,e)&&function(r,s){for(const i of qi(r))if(!i.field.isKeyField()&&s.data.field(i.field)===null)return!1;return!0}(t,e)&&function(r,s){for(const i of r.filters)if(!i.matches(s))return!1;return!0}(t,e)&&function(r,s){return!(r.startAt&&!function(o,l,c){const u=pp(o,l,c);return o.inclusive?u<=0:u<0}(r.startAt,qi(r),s)||r.endAt&&!function(o,l,c){const u=pp(o,l,c);return o.inclusive?u>=0:u>0}(r.endAt,qi(r),s))}(t,e)}function sR(t){return t.collectionGroup||(t.path.length%2==1?t.path.lastSegment():t.path.get(t.path.length-2))}function vy(t){return(e,n)=>{let r=!1;for(const s of qi(t)){const i=iR(s,e,n);if(i!==0)return i;r=r||s.field.isKeyField()}return 0}}function iR(t,e,n){const r=t.field.isKeyField()?se.comparator(e.key,n.key):function(i,o,l){const c=o.data.field(i),u=l.data.field(i);return c!==null&&u!==null?Bs(c,u):ce(42886)}(t.field,e,n);switch(t.dir){case"asc":return r;case"desc":return-1*r;default:return ce(19790,{direction:t.dir})}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Dp="ConnectivityMonitor";class xp{constructor(){this.Co=()=>this.Fo(),this.Mo=()=>this.xo(),this.Oo=[],this.No()}vo(e){this.Oo.push(e)}shutdown(){window.removeEventListener("online",this.Co),window.removeEventListener("offline",this.Mo)}No(){window.addEventListener("online",this.Co),window.addEventListener("offline",this.Mo)}Fo(){Z(Dp,"Network connectivity changed: AVAILABLE");for(const e of this.Oo)e(0)}xo(){Z(Dp,"Network connectivity changed: UNAVAILABLE");for(const e of this.Oo)e(1)}static C(){return typeof window<"u"&&window.addEventListener!==void 0&&window.removeEventListener!==void 0}}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const vt="WebChannelConnection";class bS extends wS{constructor(e){super(e),this.forceLongPolling=e.forceLongPolling,this.autoDetectLongPolling=e.autoDetectLongPolling,this.useFetchStreams=e.useFetchStreams,this.longPollingOptions=e.longPollingOptions}Ko(e,n,r,s,i){const o=gu();return new Promise((l,c)=>{const u=new W_;u.setWithCredentials(!0),u.listenOnce(K_.COMPLETE,()=>{try{switch(u.getLastErrorCode()){case ha.NO_ERROR:const p=u.getResponseJson();Z(vt,`XHR for RPC '${e}' ${o} received:`,JSON.stringify(p)),l(p);break;case ha.TIMEOUT:Z(vt,`RPC '${e}' ${o} timed out`),c(new ee(F.DEADLINE_EXCEEDED,"Request time out"));break;case ha.HTTP_ERROR:const m=u.getStatus();if(Z(vt,`RPC '${e}' ${o} failed with status:`,m,"response text:",u.getResponseText()),m>0){let _=u.getResponseJson();Array.isArray(_)&&(_=_[0]);const A=_==null?void 0:_.error;if(A&&A.status&&A.message){const O=function(H){const j=H.toLowerCase().replace(/_/g,"-");return Object.values(F).indexOf(j)>=0?j:F.UNKNOWN}(A.status);c(new ee(O,A.message))}else c(new ee(F.UNKNOWN,"Server responded with status "+u.getStatus()))}else c(new ee(F.UNAVAILABLE,"Connection failed."));break;default:ce(9055,{s_:e,streamId:o,o_:u.getLastErrorCode(),__:u.getLastError()})}}finally{Z(vt,`RPC '${e}' ${o} completed.`)}});const f=JSON.stringify(s);Z(vt,`RPC '${e}' ${o} sending request:`,s),u.send(n,"POST",f,r,15)})}a_(e,n,r){const s=gu(),i=[this.Lo,"/","google.firestore.v1.Firestore","/",e,"/channel"],o=Y_(),l=Q_(),c={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},u=this.longPollingOptions.timeoutSeconds;u!==void 0&&(c.longPollingTimeout=Math.round(1e3*u)),this.useFetchStreams&&(c.useFetchStreams=!0),this.Uo(c.initMessageHeaders,n,r),c.encodeInitMessageHeaders=!0;const f=i.join("");Z(vt,`Creating RPC '${e}' stream ${s}: ${f}`,c);const p=o.createWebChannel(f,c);let m=!1,_=!1;const A=new IS({Go:x=>{_?Z(vt,`Not sending because RPC '${e}' stream ${s} is closed:`,x):(m||(Z(vt,`Opening RPC '${e}' stream ${s} transport.`),p.open(),m=!0),Z(vt,`RPC '${e}' stream ${s} sending:`,x),p.send(x))},zo:()=>p.close()}),O=(x,H,j)=>{x.listen(H,N=>{try{j(N)}catch(D){setTimeout(()=>{throw D},0)}})};return O(p,Ci.EventType.OPEN,()=>{_||(Z(vt,`RPC '${e}' stream ${s} transport opened.`),A.t_())}),O(p,Ci.EventType.CLOSE,()=>{_||(_=!0,Z(vt,`RPC '${e}' stream ${s} transport closed`),A.r_())}),O(p,Ci.EventType.ERROR,x=>{_||(_=!0,$s(vt,`RPC '${e}' stream ${s} transport errored. Name:`,x.name,"Message:",x.message),A.r_(new ee(F.UNAVAILABLE,"The operation could not be completed")))}),O(p,Ci.EventType.MESSAGE,x=>{var H;if(!_){const j=x.data[0];Oe(!!j,16349);const N=j,D=(N==null?void 0:N.error)||((H=N[0])===null||H===void 0?void 0:H.error);if(D){Z(vt,`RPC '${e}' stream ${s} received error:`,D);const q=D.status;let te=function(y){const w=Ze[y];if(w!==void 0)return ky(w)}(q),R=D.message;te===void 0&&(te=F.INTERNAL,R="Unknown error status: "+q+" with message "+D.message),_=!0,A.r_(new ee(te,R)),p.close()}else Z(vt,`RPC '${e}' stream ${s} received:`,j),A.i_(j)}}),O(l,G_.STAT_EVENT,x=>{x.stat===ru.PROXY?Z(vt,`RPC '${e}' stream ${s} detected buffering proxy`):x.stat===ru.NOPROXY&&Z(vt,`RPC '${e}' stream ${s} detected no buffering proxy`)}),setTimeout(()=>{A.n_()},0),A}}function Cc(){return typeof document<"u"?document:null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ns="RemoteStore";class kS{constructor(e,n,r,s,i){this.localStore=e,this.datastore=n,this.asyncQueue=r,this.remoteSyncer={},this.oa=[],this._a=new Map,this.aa=new Set,this.ua=[],this.ca=i,this.ca.vo(o=>{r.enqueueAndForget(async()=>{ls(this)&&(Z(ns,"Restarting streams for network reachability change."),await async function(c){const u=pe(c);u.aa.add(4),await Ao(u),u.la.set("Unknown"),u.aa.delete(4),await Cl(u)}(this))})}),this.la=new PS(r,s)}}async function Cl(t){if(ls(t))for(const e of t.ua)await e(!0)}async function Ao(t){for(const e of t.ua)await e(!1)}function Wy(t,e){const n=pe(t);n._a.has(e.targetId)||(n._a.set(e.targetId,e),yh(n)?_h(n):ni(n).b_()&&gh(n,e))}function mh(t,e){const n=pe(t),r=ni(n);n._a.delete(e),r.b_()&&Ky(n,e),n._a.size===0&&(r.b_()?r.v_():ls(n)&&n.la.set("Unknown"))}function gh(t,e){if(t.ha.Ke(e.targetId),e.resumeToken.approximateByteSize()>0||e.snapshotVersion.compareTo(fe.min())>0){const n=t.remoteSyncer.getRemoteKeysForTarget(e.targetId).size;e=e.withExpectedCount(n)}ni(t).U_(e)}function Ky(t,e){t.ha.Ke(e),ni(t).K_(e)}function _h(t){t.ha=new bR({getRemoteKeysForTarget:e=>t.remoteSyncer.getRemoteKeysForTarget(e),Rt:e=>t._a.get(e)||null,Pt:()=>t.datastore.serializer.databaseId}),ni(t).start(),t.la.ta()}function yh(t){return ls(t)&&!ni(t).w_()&&t._a.size>0}function ls(t){return pe(t).aa.size===0}function Gy(t){t.ha=void 0}async function OS(t){t.la.set("Online")}async function DS(t){t._a.forEach((e,n)=>{gh(t,e)})}async function xS(t,e){Gy(t),yh(t)?(t.la.ia(e),_h(t)):t.la.set("Unknown")}async function VS(t,e,n){if(t.la.set("Online"),e instanceof Dy&&e.state===2&&e.cause)try{await async function(s,i){const o=i.cause;for(const l of i.targetIds)s._a.has(l)&&(await s.remoteSyncer.rejectListen(l,o),s._a.delete(l),s.ha.removeTarget(l))}(t,e)}catch(r){Z(ns,"Failed to remove targets %s: %s ",e.targetIds.join(","),r),await za(t,r)}else if(e instanceof ma?t.ha.Xe(e):e instanceof Oy?t.ha.ot(e):t.ha.nt(e),!n.isEqual(fe.min()))try{const r=await qy(t.localStore);n.compareTo(r)>=0&&await function(i,o){const l=i.ha.It(o);return l.targetChanges.forEach((c,u)=>{if(c.resumeToken.approximateByteSize()>0){const f=i._a.get(u);f&&i._a.set(u,f.withResumeToken(c.resumeToken,o))}}),l.targetMismatches.forEach((c,u)=>{const f=i._a.get(c);if(!f)return;i._a.set(c,f.withResumeToken(pt.EMPTY_BYTE_STRING,f.snapshotVersion)),Ky(i,c);const p=new pr(f.target,c,u,f.sequenceNumber);gh(i,p)}),i.remoteSyncer.applyRemoteEvent(l)}(t,n)}catch(r){Z(ns,"Failed to raise snapshot:",r),await za(t,r)}}async function za(t,e,n){if(!ei(e))throw e;t.aa.add(1),await Ao(t),t.la.set("Offline"),n||(n=()=>qy(t.localStore)),t.asyncQueue.enqueueRetryable(async()=>{Z(ns,"Retrying IndexedDB access"),await n(),t.aa.delete(1),await Cl(t)})}function Qy(t,e){return e().catch(n=>za(t,n,e))}async function Pl(t){const e=pe(t),n=Rr(e);let r=e.oa.length>0?e.oa[e.oa.length-1].batchId:eh;for(;NS(e);)try{const s=await gS(e.localStore,r);if(s===null){e.oa.length===0&&n.v_();break}r=s.batchId,MS(e,s)}catch(s){await za(e,s)}Yy(e)&&Jy(e)}function NS(t){return ls(t)&&t.oa.length<10}function MS(t,e){t.oa.push(e);const n=Rr(t);n.b_()&&n.W_&&n.G_(e.mutations)}function Yy(t){return ls(t)&&!Rr(t).w_()&&t.oa.length>0}function Jy(t){Rr(t).start()}async function LS(t){Rr(t).H_()}async function FS(t){const e=Rr(t);for(const n of t.oa)e.G_(n.mutations)}async function US(t,e,n){const r=t.oa.shift(),s=lh.from(r,e,n);await Qy(t,()=>t.remoteSyncer.applySuccessfulWrite(s)),await Pl(t)}async function $S(t,e){e&&Rr(t).W_&&await async function(r,s){if(function(o){return wR(o)&&o!==F.ABORTED}(s.code)){const i=r.oa.shift();Rr(r).D_(),await Qy(r,()=>r.remoteSyncer.rejectFailedWrite(i.batchId,s)),await Pl(r)}}(t,e),Yy(t)&&Jy(t)}async function Np(t,e){const n=pe(t);n.asyncQueue.verifyOperationInProgress(),Z(ns,"RemoteStore received new credentials");const r=ls(n);n.aa.add(3),await Ao(n),r&&n.la.set("Unknown"),await n.remoteSyncer.handleCredentialChange(e),n.aa.delete(3),await Cl(n)}async function jS(t,e){const n=pe(t);e?(n.aa.delete(2),await Cl(n)):e||(n.aa.add(2),await Ao(n),n.la.set("Unknown"))}function ni(t){return t.Pa||(t.Pa=function(n,r,s){const i=pe(n);return i.Y_(),new AS(r,i.connection,i.authCredentials,i.appCheckCredentials,i.serializer,s)}(t.datastore,t.asyncQueue,{jo:OS.bind(null,t),Jo:DS.bind(null,t),Zo:xS.bind(null,t),Q_:VS.bind(null,t)}),t.ua.push(async e=>{e?(t.Pa.D_(),yh(t)?_h(t):t.la.set("Unknown")):(await t.Pa.stop(),Gy(t))})),t.Pa}function Rr(t){return t.Ta||(t.Ta=function(n,r,s){const i=pe(n);return i.Y_(),new RS(r,i.connection,i.authCredentials,i.appCheckCredentials,i.serializer,s)}(t.datastore,t.asyncQueue,{jo:()=>Promise.resolve(),Jo:LS.bind(null,t),Zo:$S.bind(null,t),z_:FS.bind(null,t),j_:US.bind(null,t)}),t.ua.push(async e=>{e?(t.Ta.D_(),await Pl(t)):(await t.Ta.stop(),t.oa.length>0&&(Z(ns,`Stopping write stream with ${t.oa.length} pending writes`),t.oa=[]))})),t.Ta}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class cs{constructor(e,n,r){this.converter=n,this._query=r,this.type="query",this.firestore=e}withConverter(e){return new cs(this.firestore,e,this._query)}}class Ot{constructor(e,n,r){this.converter=n,this._key=r,this.type="document",this.firestore=e}get _path(){return this._key.path}get id(){return this._key.path.lastSegment()}get path(){return this._key.path.canonicalString()}get parent(){return new Er(this.firestore,this.converter,this._key.path.popLast())}withConverter(e){return new Ot(this.firestore,e,this._key)}}class Er extends cs{constructor(e,n,r){super(e,n,ih(r)),this._path=r,this.type="collection"}get id(){return this._query.path.lastSegment()}get path(){return this._query.path.canonicalString()}get parent(){const e=this._path.popLast();return e.isEmpty()?null:new Ot(this.firestore,null,new se(e))}withConverter(e){return new Er(this.firestore,e,this._path)}}function Kp(t,e,...n){if(t=at(t),dv("collection","path",e),t instanceof Ol){const r=qe.fromString(e,...n);return Hp(r),new Er(t,null,r)}{if(!(t instanceof Ot||t instanceof Er))throw new ee(F.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const r=t._path.child(qe.fromString(e,...n));return Hp(r),new Er(t.firestore,null,r)}}function Rs(t,e,...n){if(t=at(t),arguments.length===1&&(e=ey.newId()),dv("doc","path",e),t instanceof Ol){const r=qe.fromString(e,...n);return qp(r),new Ot(t,null,new se(r))}{if(!(t instanceof Ot||t instanceof Er))throw new ee(F.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const r=t._path.child(qe.fromString(e,...n));return qp(r),new Ot(t.firestore,t instanceof Er?t.converter:null,new se(r))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Gp="AsyncQueue";class Qp{constructor(e=Promise.resolve()){this.Qu=[],this.$u=!1,this.Uu=[],this.Ku=null,this.Wu=!1,this.Gu=!1,this.zu=[],this.y_=new Hy(this,"async_queue_retry"),this.ju=()=>{const r=Cc();r&&Z(Gp,"Visibility state changed to "+r.visibilityState),this.y_.A_()},this.Hu=e;const n=Cc();n&&typeof n.addEventListener=="function"&&n.addEventListener("visibilitychange",this.ju)}get isShuttingDown(){return this.$u}enqueueAndForget(e){this.enqueue(e)}enqueueAndForgetEvenWhileRestricted(e){this.Ju(),this.Yu(e)}enterRestrictedMode(e){if(!this.$u){this.$u=!0,this.Gu=e||!1;const n=Cc();n&&typeof n.removeEventListener=="function"&&n.removeEventListener("visibilitychange",this.ju)}}enqueue(e){if(this.Ju(),this.$u)return new Promise(()=>{});const n=new Un;return this.Yu(()=>this.$u&&this.Gu?Promise.resolve():(e().then(n.resolve,n.reject),n.promise)).then(()=>n.promise)}enqueueRetryable(e){this.enqueueAndForget(()=>(this.Qu.push(e),this.Zu()))}async Zu(){if(this.Qu.length!==0){try{await this.Qu[0](),this.Qu.shift(),this.y_.reset()}catch(e){if(!ei(e))throw e;Z(Gp,"Operation failed with retryable error: "+e)}this.Qu.length>0&&this.y_.E_(()=>this.Zu())}}Yu(e){const n=this.Hu.then(()=>(this.Wu=!0,e().catch(r=>{throw this.Ku=r,this.Wu=!1,qn("INTERNAL UNHANDLED ERROR: ",Yp(r)),r}).then(r=>(this.Wu=!1,r))));return this.Hu=n,n}enqueueAfterDelay(e,n,r){this.Ju(),this.zu.indexOf(e)>-1&&(n=0);const s=vh.createAndSchedule(this,e,n,r,i=>this.Xu(i));return this.Uu.push(s),s}Ju(){this.Ku&&ce(47125,{ec:Yp(this.Ku)})}verifyOperationInProgress(){}async tc(){let e;do e=this.Hu,await e;while(e!==this.Hu)}nc(e){for(const n of this.Uu)if(n.timerId===e)return!0;return!1}rc(e){return this.tc().then(()=>{this.Uu.sort((n,r)=>n.targetTimeMs-r.targetTimeMs);for(const n of this.Uu)if(n.skipDelay(),e!=="all"&&n.timerId===e)break;return this.tc()})}sc(e){this.zu.push(e)}Xu(e){const n=this.Uu.indexOf(e);this.Uu.splice(n,1)}}function Yp(t){let e=t.message||"";return t.stack&&(e=t.stack.includes(t.message)?t.stack:t.message+`
`+t.stack),e}class us extends Ol{constructor(e,n,r,s){super(e,n,r,s),this.type="firestore",this._queue=new Qp,this._persistenceKey=(s==null?void 0:s.name)||"[DEFAULT]"}async _terminate(){if(this._firestoreClient){const e=this._firestoreClient.terminate();this._queue=new Qp(e),this._firestoreClient=void 0,await e}}}function _C(t,e){const n=typeof t=="object"?t:B_(),r=typeof t=="string"?t:Fa,s=Xu(n,"firestore").getImmediate({identifier:r});if(!s._initialized){const i=Gb("firestore");i&&gC(s,...i)}return s}function bh(t){if(t._terminated)throw new ee(F.FAILED_PRECONDITION,"The client has already been terminated.");return t._firestoreClient||yC(t),t._firestoreClient}function yC(t){var e,n,r;const s=t._freezeSettings(),i=function(l,c,u,f){return new B0(l,c,u,f.host,f.ssl,f.experimentalForceLongPolling,f.experimentalAutoDetectLongPolling,fv(f.experimentalLongPollingOptions),f.useFetchStreams,f.isUsingEmulator)}(t._databaseId,((e=t._app)===null||e===void 0?void 0:e.options.appId)||"",t._persistenceKey,s);t._componentsProvider||!((n=s.localCache)===null||n===void 0)&&n._offlineComponentProvider&&(!((r=s.localCache)===null||r===void 0)&&r._onlineComponentProvider)&&(t._componentsProvider={_offline:s.localCache._offlineComponentProvider,_online:s.localCache._onlineComponentProvider}),t._firestoreClient=new uC(t._authCredentials,t._appCheckCredentials,t._queue,i,t._componentsProvider&&function(l){const c=l==null?void 0:l._online.build();return{_offline:l==null?void 0:l._offline.build(c),_online:c}}(t._componentsProvider))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Rh{constructor(e,n){if(!isFinite(e)||e<-90||e>90)throw new ee(F.INVALID_ARGUMENT,"Latitude must be a number between -90 and 90, but was: "+e);if(!isFinite(n)||n<-180||n>180)throw new ee(F.INVALID_ARGUMENT,"Longitude must be a number between -180 and 180, but was: "+n);this._lat=e,this._long=n}get latitude(){return this._lat}get longitude(){return this._long}isEqual(e){return this._lat===e._lat&&this._long===e._long}toJSON(){return{latitude:this._lat,longitude:this._long}}_compareTo(e){return _e(this._lat,e._lat)||_e(this._long,e._long)}}/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Zp(t){t=un(t,Ot);const e=un(t.firestore,us);return dC(bh(e),t._key).then(n=>FC(e,t,n))}class Rv extends OC{constructor(e){super(),this.firestore=e}convertBytes(e){return new Ws(e)}convertReference(e){const n=this.convertDocumentKey(e,this.firestore._databaseId);return new Ot(this.firestore,null,n)}}function VC(t){t=un(t,cs);const e=un(t.firestore,us),n=bh(e),r=new Rv(e);return SC(t._query),pC(n,t._query).then(s=>new DC(e,r,t,s))}function NC(t,e,n){t=un(t,Ot);const r=un(t.firestore,us),s=bv(t.converter,e);return Ll(r,[_v(xl(r),"setDoc",t._key,s,t.converter!==null,n).toMutation(t._key,en.none())])}function em(t,e,n,...r){t=un(t,Ot);const s=un(t.firestore,us),i=xl(s);let o;return o=typeof(e=at(e))=="string"||e instanceof Dl?IC(i,"updateDoc",t._key,e,n,r):wC(i,"updateDoc",t._key,e),Ll(s,[o.toMutation(t._key,en.exists(!0))])}function MC(t){return Ll(un(t.firestore,us),[new ah(t._key,en.none())])}function LC(t,e){const n=un(t.firestore,us),r=Rs(t),s=bv(t.converter,e);return Ll(n,[_v(xl(t.firestore),"addDoc",r._key,s,t.converter!==null,{}).toMutation(r._key,en.exists(!1))]).then(()=>r)}function Ll(t,e){return function(r,s){const i=new Un;return r.asyncQueue.enqueueAndForget(async()=>tC(await fC(r),s,i)),i.promise}(bh(t),e)}function FC(t,e,n){const r=n.docs.get(e._key),s=new Rv(t);return new Av(t,s,e._key,r,new Oi(n.hasPendingWrites,n.fromCache),e.converter)}(function(e,n=!0){(function(s){Xs=s})(Js),Us(new es("firestore",(r,{instanceIdentifier:s,options:i})=>{const o=r.getProvider("app").getImmediate(),l=new us(new A0(r.getProvider("auth-internal")),new C0(o,r.getProvider("app-check-internal")),function(u,f){if(!Object.prototype.hasOwnProperty.apply(u.options,["projectId"]))throw new ee(F.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new oo(u.options.projectId,f)}(o,s),o);return i=Object.assign({useFetchStreams:n},i),l._setSettings(i),l},"PUBLIC").setMultipleInstances(!0)),yr(Zd,ep,e),yr(Zd,ep,"esm2017")})();function Vh(t,e){var n={};for(var r in t)Object.prototype.hasOwnProperty.call(t,r)&&e.indexOf(r)<0&&(n[r]=t[r]);if(t!=null&&typeof Object.getOwnPropertySymbols=="function")for(var s=0,r=Object.getOwnPropertySymbols(t);s<r.length;s++)e.indexOf(r[s])<0&&Object.prototype.propertyIsEnumerable.call(t,r[s])&&(n[r[s]]=t[r[s]]);return n}function Sv(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}const UC=Sv,Cv=new To("auth","Firebase",Sv());/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ga=new Yu("@firebase/auth");function $C(t,...e){Ga.logLevel<=Te.WARN&&Ga.warn(`Auth (${Js}): ${t}`,...e)}function _a(t,...e){Ga.logLevel<=Te.ERROR&&Ga.error(`Auth (${Js}): ${t}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Wi(t){if(t)try{const e=new Date(Number(t));if(!isNaN(e.getTime()))return e.toUTCString()}catch{}}async function XC(t,e=!1){const n=at(t),r=await n.getIdToken(e),s=Lh(r);le(s&&s.exp&&s.auth_time&&s.iat,n.auth,"internal-error");const i=typeof s.firebase=="object"?s.firebase:void 0,o=i==null?void 0:i.sign_in_provider;return{claims:s,token:r,authTime:Wi(kc(s.auth_time)),issuedAtTime:Wi(kc(s.iat)),expirationTime:Wi(kc(s.exp)),signInProvider:o||null,signInSecondFactor:(i==null?void 0:i.sign_in_second_factor)||null}}function kc(t){return Number(t)*1e3}function Lh(t){const[e,n,r]=t.split(".");if(e===void 0||n===void 0||r===void 0)return _a("JWT malformed, contained fewer than 3 sections"),null;try{const s=V_(n);return s?JSON.parse(s):(_a("Failed to decode base64 JWT payload"),null)}catch(s){return _a("Caught error parsing JWT payload as JSON",s==null?void 0:s.toString()),null}}function rm(t){const e=Lh(t);return le(e,"internal-error"),le(typeof e.exp<"u","internal-error"),le(typeof e.iat<"u","internal-error"),Number(e.exp)-Number(e.iat)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ya(t){var e;const n=t.auth,r=await t.getIdToken(),s=await ho(t,Qa(n,{idToken:r}));le(s==null?void 0:s.users.length,n,"internal-error");const i=s.users[0];t._notifyReloadListener(i);const o=!((e=i.providerUserInfo)===null||e===void 0)&&e.length?xv(i.providerUserInfo):[],l=nP(t.providerData,o),c=t.isAnonymous,u=!(t.email&&i.passwordHash)&&!(l!=null&&l.length),f=c?u:!1,p={uid:i.localId,displayName:i.displayName||null,photoURL:i.photoUrl||null,email:i.email||null,emailVerified:i.emailVerified||!1,phoneNumber:i.phoneNumber||null,tenantId:i.tenantId||null,providerData:l,metadata:new wu(i.createdAt,i.lastLoginAt),isAnonymous:f};Object.assign(t,p)}async function tP(t){const e=at(t);await Ya(e),await e.auth._persistUserIfCurrent(e),e.auth._notifyListenersIfCurrent(e)}function nP(t,e){return[...t.filter(r=>!e.some(s=>s.providerId===r.providerId)),...e]}function xv(t){return t.map(e=>{var{providerId:n}=e,r=Vh(e,["providerId"]);return{providerId:n,uid:r.rawId||"",displayName:r.displayName||null,email:r.email||null,phoneNumber:r.phoneNumber||null,photoURL:r.photoUrl||null}})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function rP(t,e){const n=await Ov(t,{},async()=>{const r=wo({grant_type:"refresh_token",refresh_token:e}).slice(1),{tokenApiHost:s,apiKey:i}=t.config,o=await Dv(t,s,"/v1/token",`key=${i}`),l=await t._getAdditionalHeaders();return l["Content-Type"]="application/x-www-form-urlencoded",kv.fetch()(o,{method:"POST",headers:l,body:r})});return{accessToken:n.access_token,expiresIn:n.expires_in,refreshToken:n.refresh_token}}async function sP(t,e){return Vr(t,"POST","/v2/accounts:revokeToken",xr(t,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const sm=new Map;function Mn(t){zn(t instanceof Function,"Expected a class definition");let e=sm.get(t);return e?(zn(e instanceof t,"Instance stored in cache mismatched with class"),e):(e=new t,sm.set(t,e),e)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function qv(t,e=[]){let n;switch(t){case"Browser":n=om(At());break;case"Worker":n=`${om(At())}-${t}`;break;default:n=t}const r=e.length?e.join(","):"FirebaseCore-web";return`${n}/JsCore/${Js}/${r}`}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function EP(t,e){const n=Xu(t,"auth");if(n.isInitialized()){const s=n.getImmediate(),i=n.getOptions();if(Zr(i,e??{}))return s;hn(s,"already-initialized")}return n.initialize({options:e})}function TP(t,e){const n=(e==null?void 0:e.persistence)||[],r=(Array.isArray(n)?n:[n]).map(Mn);e!=null&&e.errorMap&&t._updateErrorMap(e.errorMap),t._initializeWithPersistence(r,e==null?void 0:e.popupRedirectResolver)}function wP(t,e,n){const r=hs(t);le(/^https?:\/\//.test(e),r,"invalid-emulator-scheme");const s=!1,i=Wv(e),{host:o,port:l}=IP(e),c=l===null?"":`:${l}`,u={url:`${i}//${o}${c}/`},f=Object.freeze({host:o,port:l,protocol:i.replace(":",""),options:Object.freeze({disableWarnings:s})});if(!r._canInitEmulator){le(r.config.emulator&&r.emulatorConfig,r,"emulator-config-failed"),le(Zr(u,r.config.emulator)&&Zr(f,r.emulatorConfig),r,"emulator-config-failed");return}r.config.emulator=u,r.emulatorConfig=f,r.settings.appVerificationDisabledForTesting=!0,bP(),yl(o)&&F_(`${i}//${o}${c}`)}function Wv(t){const e=t.indexOf(":");return e<0?"":t.substr(0,e+1)}function IP(t){const e=Wv(t),n=/(\/\/)?([^?#/]+)/.exec(t.substr(e.length));if(!n)return{host:"",port:null};const r=n[2].split("@").pop()||"",s=/^(\[[^\]]+\])(:|$)/.exec(r);if(s){const i=s[1];return{host:i,port:cm(r.substr(i.length+1))}}else{const[i,o]=r.split(":");return{host:i,port:cm(o)}}}function cm(t){if(!t)return null;const e=Number(t);return isNaN(e)?null:e}function bP(){function t(){const e=document.createElement("p"),n=e.style;e.innerText="Running in emulator mode. Do not use with production credentials.",n.position="fixed",n.width="100%",n.backgroundColor="#ffffff",n.border=".1em solid #000000",n.color="#b50000",n.bottom="0px",n.left="0px",n.margin="0px",n.zIndex="10000",n.textAlign="center",e.classList.add("firebase-emulator-warning"),document.body.appendChild(e)}typeof console<"u"&&typeof console.info=="function"&&console.info("WARNING: You are using the Auth Emulator, which is intended for local testing only.  Do not use with production credentials."),typeof window<"u"&&typeof document<"u"&&(document.readyState==="loading"?window.addEventListener("DOMContentLoaded",t):t())}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function kP(t){switch(t){case"recoverEmail":return"RECOVER_EMAIL";case"resetPassword":return"PASSWORD_RESET";case"signIn":return"EMAIL_SIGNIN";case"verifyEmail":return"VERIFY_EMAIL";case"verifyAndChangeEmail":return"VERIFY_AND_CHANGE_EMAIL";case"revertSecondFactorAddition":return"REVERT_SECOND_FACTOR_ADDITION";default:return null}}function OP(t){const e=Ri(Si(t)).link,n=e?Ri(Si(e)).deep_link_id:null,r=Ri(Si(t)).deep_link_id;return(r?Ri(Si(r)).link:null)||r||n||e||t}class $h{constructor(e){var n,r,s,i,o,l;const c=Ri(Si(e)),u=(n=c.apiKey)!==null&&n!==void 0?n:null,f=(r=c.oobCode)!==null&&r!==void 0?r:null,p=kP((s=c.mode)!==null&&s!==void 0?s:null);le(u&&f&&p,"argument-error"),this.apiKey=u,this.operation=p,this.code=f,this.continueUrl=(i=c.continueUrl)!==null&&i!==void 0?i:null,this.languageCode=(o=c.lang)!==null&&o!==void 0?o:null,this.tenantId=(l=c.tenantId)!==null&&l!==void 0?l:null}static parseLink(e){const n=OP(e);try{return new $h(n)}catch{return null}}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function VP(t,e,n=!1){const{auth:r}=t;if(Yt(r.app))return Promise.reject($n(r));const s="reauthenticate";try{const i=await ho(t,Gv(r,s,e,t),n);le(i.idToken,r,"internal-error");const o=Lh(i.idToken);le(o,r,"internal-error");const{sub:l}=o;return le(t.uid===l,r,"user-mismatch"),ss._forOperation(t,s,i)}catch(i){throw(i==null?void 0:i.code)==="auth/user-not-found"&&hn(r,"user-mismatch"),i}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Qv(t,e,n=!1){if(Yt(t.app))return Promise.reject($n(t));const r="signIn",s=await Gv(t,r,e),i=await ss._fromIdTokenResponse(t,r,s);return n||await t._updateCurrentUser(i.user),i}async function NP(t,e){return Qv(hs(t),e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function nE(){return typeof wn().WorkerGlobalScope<"u"&&typeof wn().importScripts=="function"}async function KP(){if(!(navigator!=null&&navigator.serviceWorker))return null;try{return(await navigator.serviceWorker.ready).active}catch{return null}}function GP(){var t;return((t=navigator==null?void 0:navigator.serviceWorker)===null||t===void 0?void 0:t.controller)||null}function QP(){return nE()?self:null}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class oE{constructor(e,n,r,s,i=!1){this.auth=e,this.resolver=r,this.user=s,this.bypassAuthState=i,this.pendingPromise=null,this.eventManager=null,this.filter=Array.isArray(n)?n:[n]}execute(){return new Promise(async(e,n)=>{this.pendingPromise={resolve:e,reject:n};try{this.eventManager=await this.resolver._initialize(this.auth),await this.onExecution(),this.eventManager.registerConsumer(this)}catch(r){this.reject(r)}})}async onAuthEvent(e){const{urlResponse:n,sessionId:r,postBody:s,tenantId:i,error:o,type:l}=e;if(o){this.reject(o);return}const c={auth:this.auth,requestUri:n,sessionId:r,tenantId:i||void 0,postBody:s||void 0,user:this.user,bypassAuthState:this.bypassAuthState};try{this.resolve(await this.getIdpTask(l)(c))}catch(u){this.reject(u)}}onError(e){this.reject(e)}getIdpTask(e){switch(e){case"signInViaPopup":case"signInViaRedirect":return r1;case"linkViaPopup":case"linkViaRedirect":return i1;case"reauthViaPopup":case"reauthViaRedirect":return s1;default:hn(this.auth,"internal-error")}}resolve(e){zn(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.resolve(e),this.unregisterAndCleanUp()}reject(e){zn(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.reject(e),this.unregisterAndCleanUp()}unregisterAndCleanUp(){this.eventManager&&this.eventManager.unregisterConsumer(this),this.pendingPromise=null,this.cleanUp()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const w1=new Co(3e4,6e4);function pm(){const t=wn().___jsl;if(t!=null&&t.H){for(const e of Object.keys(t.H))if(t.H[e].r=t.H[e].r||[],t.H[e].L=t.H[e].L||[],t.H[e].r=[...t.H[e].L],t.CP)for(let n=0;n<t.CP.length;n++)t.CP[n]=null}}function I1(t){return new Promise((e,n)=>{var r,s,i;function o(){pm(),gapi.load("gapi.iframes",{callback:()=>{e(gapi.iframes.getContext())},ontimeout:()=>{pm(),n(Tn(t,"network-request-failed"))},timeout:w1.get()})}if(!((s=(r=wn().gapi)===null||r===void 0?void 0:r.iframes)===null||s===void 0)&&s.Iframe)e(gapi.iframes.getContext());else if(!((i=wn().gapi)===null||i===void 0)&&i.load)o();else{const l=mP("iframefcb");return wn()[l]=()=>{gapi.load?o():n(Tn(t,"network-request-failed"))},Hv(`${pP()}?onload=${l}`).catch(c=>n(c))}}).catch(e=>{throw Ea=null,e})}let Ea=null;function b1(t){return Ea=Ea||I1(t),Ea}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const D1={location:"yes",resizable:"yes",statusbar:"yes",toolbar:"no"},x1=500,V1=600,N1="_blank",M1="http://localhost";class mm{constructor(e){this.window=e,this.associatedEvent=null}close(){if(this.window)try{this.window.close()}catch{}}}function L1(t,e,n,r=x1,s=V1){const i=Math.max((window.screen.availHeight-s)/2,0).toString(),o=Math.max((window.screen.availWidth-r)/2,0).toString();let l="";const c=Object.assign(Object.assign({},D1),{width:r.toString(),height:s.toString(),top:i,left:o}),u=At().toLowerCase();n&&(l=Lv(u)?N1:n),Nv(u)&&(e=e||M1,c.scrollbars="yes");const f=Object.entries(c).reduce((m,[_,A])=>`${m}${_}=${A},`,"");if(iP(u)&&l!=="_self")return F1(e||"",l),new mm(null);const p=window.open(e||"",l,f);le(p,t,"popup-blocked");try{p.focus()}catch{}return new mm(p)}function F1(t,e){const n=document.createElement("a");n.href=t,n.target=e;const r=document.createEvent("MouseEvent");r.initMouseEvent("click",!0,!0,window,1,0,0,0,0,!1,!1,!1,!1,1,null),n.dispatchEvent(r)}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const G1=5*60,Q1=L_("authIdTokenMaxAge")||G1;let vm=null;const Y1=t=>async e=>{const n=e&&await e.getIdTokenResult(),r=n&&(new Date().getTime()-Date.parse(n.issuedAtTime))/1e3;if(r&&r>Q1)return;const s=n==null?void 0:n.token;vm!==s&&(vm=s,await fetch(t,{method:s?"POST":"DELETE",headers:s?{Authorization:`Bearer ${s}`}:{}}))};function J1(t=B_()){const e=Xu(t,"auth");if(e.isInitialized())return e.getImmediate();const n=EP(t,{popupRedirectResolver:H1,persistence:[t1,qP,tE]}),r=L_("authTokenSyncURL");if(r&&typeof isSecureContext=="boolean"&&isSecureContext){const i=new URL(r,location.origin);if(location.origin===i.origin){const o=Y1(i.toString());UP(n,o,()=>o(n.currentUser)),FP(n,l=>o(l))}}const s=N_("auth");return s&&wP(n,`http://${s}`),n}function X1(){var t,e;return(e=(t=document.getElementsByTagName("head"))===null||t===void 0?void 0:t[0])!==null&&e!==void 0?e:document}fP({loadJS(t){return new Promise((e,n)=>{const r=document.createElement("script");r.setAttribute("src",t),r.onload=e,r.onerror=s=>{const i=Tn("internal-error");i.customData=s,n(i)},r.type="text/javascript",r.charset="UTF-8",X1().appendChild(r)})},gapiScript:"https://apis.google.com/js/api.js",recaptchaV2Script:"https://www.google.com/recaptcha/api.js",recaptchaEnterpriseScript:"https://www.google.com/recaptcha/enterprise.js?render="});K1("Browser");const Z1={apiKey:"AIzaSyAH7Qc8QkTR8AWBOxptwHH6IxIXpIx-c00",authDomain:"calisteniarg-f3d40.firebaseapp.com",projectId:"calisteniarg-f3d40",storageBucket:"calisteniarg-f3d40.firebasestorage.app",messagingSenderId:"641759769239",appId:"1:641759769239:web:9e4d3ffdd5dc9645f56fd2"},lE=j_(Z1),Br=_C(lE),Di=J1(lE),si=g_("profile",{state:()=>({profile:{id:null,email:"",nickname:"",routines:[],charge:!1}}),actions:{async loadProfile(t,e){if(!t)throw new Error("UID de usuario inválido");const n=Rs(Br,"profiles",t);try{const r=await Zp(n);if(r.exists()){const s=r.data();this.profile={id:t,email:s.email,nickname:s.nickname||"",routines:[]}}else await NC(n,{idUser:t,email:e,nickname:""}),this.profile={id:t,email:e,nickname:"",routines:[]}}catch(r){throw console.error("Error al cargar o crear el perfil:",r),r}},async setNickname(t){if(!this.profile.id)throw new Error("Usuario no autenticado");const e=Rs(Br,"profiles",this.profile.id);try{await em(e,{nickname:t}),this.profile.nickname=t}catch(n){throw console.error("Error al actualizar el nickname:",n),n}},async getRutinas(){if(console.log("GetRutinas()"),!this.profile.id)throw new Error("Usuario no autenticado");const t=Kp(Br,"routines"),e=[PC("idUser","==",this.profile.id),kC("fechaCreacion","desc")],n=CC(t,...e);try{const r=await VC(n),s=[];r.forEach(i=>{s.push({id:i.id,...i.data()})}),this.profile.routines=s}catch(r){throw console.error("Error al obtener las rutinas:",r),r}},async getRutina(t){try{const e=Rs(Br,"routines",t),n=await Zp(e);return n.exists()?{id:n.id,...n.data()}:(console.warn(`No se encontró la rutina con ID: ${t}`),null)}catch(e){throw console.error(`Error al obtener la rutina con ID ${t}:`,e),e}},getRutinaLocal(t){return this.profile.routines.find(e=>e.id===t)},async deleteRutina(t){try{this.profile.routines=this.profile.routines.filter(e=>e.id!==t),await MC(Rs(Br,"routines",t))}catch(e){throw console.error("Error al eliminar la rutina:",e),e}},async updateRutina(t){if(!t.id)throw new Error("Rutina sin ID");const e=Rs(Br,"routines",t.id),{id:n,...r}=t;try{console.log("Antes del horror:",t),await em(e,r);const s=this.profile.routines.findIndex(i=>i.id===t.id);s!==-1&&this.profile.routines.splice(s,1,t)}catch(s){throw console.error("Error al actualizar la rutina:",s),s}},async createRutinaFirebase(t){const e={...t,fechaCreacion:new Date().toISOString(),idUser:this.profile.id};try{const n=await LC(Kp(Br,"routines"),e),r={id:n.id,...e};return this.profile.routines.unshift(r),n}catch(n){throw console.error("Error al crear la rutina en Firebase:",n),n}}},getters:{getNickname:t=>t.profile.nickname,getUserRoutines:t=>t.profile.routines}}),jl=g_("user",{state:()=>({user:null}),actions:{initAuthListener(){Jv(Di,async t=>{const e=si();t?(this.user={email:t.email,id:t.uid},await e.loadProfile(t.uid,t.email),console.log("Sesión iniciada. Perfil")):(this.user=null,e.$reset())})},async register(t,e){try{return await MP(Di,t,e),{ok:!0,message:"Registration successful!"}}catch(n){return console.error("Error en registro:",n.message),{ok:!1,message:this.translateFirebaseError(n.code)}}},async login(t,e){try{return await LP(Di,t,e),{ok:!0,message:"Login successful!"}}catch(n){return console.error("Error en login:",n.message),{ok:!1,message:this.translateFirebaseError(n.code)}}},translateFirebaseError(t){return t?(console.log(t),{"auth/email-already-in-use":"El email ya esta en uso.","auth/invalid-credential":"Credenciales inválidas.","auth/user-not-found":"No existe una cuenta con ese correo.","auth/wrong-password":"Contraseña incorrecta.","auth/too-many-requests":"Demasiados intentos fallidos.","auth/network-request-failed":"Problema de conexión.","auth/invalid-email":"El formato del email no es válido."}[t]||"Error de autenticación. Intentá nuevamente."):"Error desconocido."},async logout(){try{await $P(Di),this.user=null}catch(t){console.error("Error en logout:",t.message)}},generateDefaultUsername(t){if(!t||typeof t!="string")return"";const e=t.indexOf("@");return e!==-1?t.substring(0,e):t}}}),ek={__name:"NotifierComponent",props:{message:String,type:String},setup(t){const e=t,n=ft(()=>e.type==="success"?"bg-success":"bg-danger");return(r,s)=>(me(),vo(jn,{name:"fade-slide",mode:"out-in",onAfterLeave:s[0]||(s[0]=i=>r.$emit("after-leave"))},{default:We(()=>[je(C("div",{class:Vt(["notifier p-3 rounded text-light",n.value])},it(t.message),3),[[Vn,t.message]])]),_:1}))}},cE=kr(ek,[["__scopeId","data-v-c66f5abe"]]),tk={class:"w-100 m-auto d-flex justify-content-center align-items-center"},nk={class:"d-flex justify-content-between"},rk={class:"mb-3 text-start"},sk={class:"mb-3 text-start"},ik={class:"text-start mt-3 text-light"},ok={__name:"LoginPage",setup(t){const e=Be(""),n=Be(""),r=Be(!1),s=Be(!1),i=Be({message:"",type:""}),o=jl(),l=async()=>{i.value={message:"",type:""},s.value=!1;try{const u=await o.login(e.value,n.value);u.ok?(i.value={message:"¡Inicio de sesión exitoso!",type:"success"},s.value=!0,setTimeout(()=>{s.value=!1,o.$router.push("/dashboard")},2e3)):(i.value={message:u.message,type:"error"},s.value=!0,setTimeout(()=>{s.value=!1},2e3))}catch(u){console.error("Unexpected error:",u),i.value={message:"Error inesperado. Intentá de nuevo.",type:"error"},s.value=!0}},c=()=>{i.value={message:"",type:""}};return Kn(()=>{r.value=!0}),(u,f)=>{const p=Ys("router-link");return me(),ve("main",tk,[ye(jn,{name:"fade-slide-login",mode:"out-in"},{default:We(()=>[je(C("form",{class:"form-login p-4 rounded shadow",onSubmit:$t(l,["prevent"])},[C("div",nk,[f[3]||(f[3]=C("h2",{class:"text-center ms-3 mb-4 fw-bold text-light"},[Me("Login "),C("i",{class:"bi bi-person-check"})],-1)),ye(p,{class:"text-decoration-none",to:"/"},{default:We(()=>f[2]||(f[2]=[C("button",{type:"button",class:"btn-exit btn btn-outline-light"},[C("i",{class:"bi bi-x"})],-1)])),_:1})]),C("div",rk,[f[4]||(f[4]=C("label",{for:"inputEmail",class:"form-label text-light"},"Email",-1)),je(C("input",{required:"","onUpdate:modelValue":f[0]||(f[0]=m=>e.value=m),type:"email",class:"form-control",id:"inputEmail",placeholder:"Ej: leomessi@gmail.com"},null,512),[[jt,e.value]])]),C("div",sk,[f[5]||(f[5]=C("label",{for:"inputPassword",class:"form-label text-light"},"Contraseña",-1)),je(C("input",{required:"","onUpdate:modelValue":f[1]||(f[1]=m=>n.value=m),type:"password",class:"form-control",id:"inputPassword",placeholder:"*********"},null,512),[[jt,n.value]])]),f[8]||(f[8]=C("button",{class:"btn-login btn w-100 py-2 text-light",type:"submit"},[Me("Iniciar Sesion "),C("i",{class:"bi bi-send-fill"})],-1)),je(ye(cE,{message:i.value.message,type:i.value.type,onAfterLeave:c},null,8,["message","type"]),[[Vn,s.value]]),C("p",ik,[f[7]||(f[7]=Me(" ¿Todavia no tenes una cuenta? ")),ye(p,{to:"/register"},{default:We(()=>f[6]||(f[6]=[Me("Registrate")])),_:1})])],544),[[Vn,r.value]])]),_:1})])}}},ak={class:"w-100 m-auto d-flex justify-content-center align-items-center"},lk={class:"d-flex justify-content-between"},ck={class:"mb-3 text-start"},uk={class:"mb-3 text-start"},hk={class:"mb-3 text-start"},fk={class:"text-start mt-3 text-light"},dk={__name:"RegisterPage",setup(t){const e=Be(""),n=Be(""),r=Be(""),s=Be(!1),i=Be(!1),o=Be({message:"",type:""}),l=jl(),c=async()=>{if(o.value={message:"",type:""},i.value=!1,n.value!==r.value){r.value="",o.value={message:"Las contraseñas no coinciden.",type:"error"},i.value=!0;return}try{const f=await l.register(e.value,n.value);f.ok?(o.value={message:f.message,type:"success"},setTimeout(()=>{i.value=!1,l.$router.push("/dashboard")},2e3)):(o.value={message:f.message,type:"error"},setTimeout(()=>{i.value=!1},2e3))}catch(f){console.error("Unexpected error:",f),o.value={message:"Error inesperado. Intentá de nuevo.",type:"error"}}i.value=!0},u=()=>{o.value={message:"",type:""}};return Kn(()=>{s.value=!0}),(f,p)=>{const m=Ys("router-link");return me(),ve("main",ak,[ye(jn,{name:"fade-slide-register",mode:"out-in"},{default:We(()=>[je(C("form",{class:"form-register p-4 rounded shadow",onSubmit:$t(c,["prevent"])},[C("div",lk,[p[4]||(p[4]=C("h2",{class:"text-center ms-3 mb-4 fw-bold text-light"},[Me("Registro "),C("i",{class:"bi bi-person-add"})],-1)),ye(m,{class:"text-decoration-none",to:"/"},{default:We(()=>p[3]||(p[3]=[C("button",{type:"button",class:"btn-exit btn btn-outline-light"},[C("i",{class:"bi bi-x"})],-1)])),_:1})]),C("div",ck,[p[5]||(p[5]=C("label",{for:"inputEmail",class:"form-label text-light"},"Email",-1)),je(C("input",{required:"","onUpdate:modelValue":p[0]||(p[0]=_=>e.value=_),type:"email",class:"form-control",id:"inputEmail",placeholder:"Ej: leomessi@gmail.com"},null,512),[[jt,e.value]])]),C("div",uk,[p[6]||(p[6]=C("label",{for:"inputPassword",class:"form-label text-light"},"Contraseña",-1)),je(C("input",{required:"","onUpdate:modelValue":p[1]||(p[1]=_=>n.value=_),type:"password",class:"form-control",id:"inputPassword",placeholder:"**********"},null,512),[[jt,n.value]])]),C("div",hk,[p[7]||(p[7]=C("label",{for:"confirmPassword",class:"form-label text-light"},"Confirmar contraseña",-1)),je(C("input",{required:"","onUpdate:modelValue":p[2]||(p[2]=_=>r.value=_),type:"password",class:"form-control",id:"confirmPassword",placeholder:"**********"},null,512),[[jt,r.value]])]),p[10]||(p[10]=C("button",{class:"btn-register btn w-100 py-2 text-light",type:"submit"},[Me(" Registrarse "),C("i",{class:"bi bi-send-fill"})],-1)),je(ye(cE,{message:o.value.message,type:o.value.type,onAfterLeave:u},null,8,["message","type"]),[[Vn,i.value]]),C("p",fk,[p[9]||(p[9]=Me(" ¿Ya tenes tu cuenta? ")),ye(m,{to:"/login",class:"login"},{default:We(()=>p[8]||(p[8]=[Me("Inicia sesion")])),_:1})])],544),[[Vn,s.value]])]),_:1})])}}},pk={class:"d-flex"},mk={class:"d-flex flex-column align-items-center"},gk={class:"username-container text-center font-weight-medium"},_k=["title"],yk={class:"h5"},vk={class:"nav text-center nav-pills flex-column mb-auto"},Ek={class:"nav-item"},Tk={class:"nav-item"},wk={class:"nav-item d-flex justify-content-center"},Ik={key:0,class:"heather p-2 w-100 nav-mobile"},bk={__name:"SideBarComponent",setup(t){const e=Be(!1),n=Be(window.innerWidth<768),r=si(),s=jl(),i=Qu(),{profile:o}=__(r),l=async()=>{await s.logout(),i.push({name:"Unregistred"})},c=()=>{e.value=!e.value},u=()=>{n.value=window.innerWidth<768,n.value||(e.value=!1)},f=p=>{if(!n.value)return;const m=document.querySelector(".sidebar-profile");e.value&&m&&!m.contains(p.target)&&(e.value=!1)};return Kn(()=>{window.addEventListener("resize",u),document.addEventListener("click",f)}),qu(()=>{window.removeEventListener("resize",u),document.removeEventListener("click",f)}),(p,m)=>{const _=Ys("router-link");return me(),ve("div",pk,[ye(jn,{name:"slide-fade"},{default:We(()=>[!n.value||e.value?(me(),ve("div",{key:0,class:Vt(["sidebar-profile flex-column flex-shrink-0 px-1 text-bg-dark",{"mobile-mode":n.value}])},[C("div",mk,[n.value?Jt("",!0):(me(),vo(_,{key:0,to:{name:"Dashboard"},class:"h3 mb-1 text-light"},{default:We(()=>m[0]||(m[0]=[C("i",{class:"bi bi-house"},null,-1)])),_:1})),C("div",gk,[C("p",{class:"ellipsis my-0",title:Fn(o).nickname},[C("span",yk," #"+it(Fn(o).nickname||"Usuario"),1)],8,_k)])]),m[6]||(m[6]=C("hr",null,null,-1)),C("ul",vk,[C("li",Ek,[ye(_,{to:{name:"MyWorkouts"},class:"nav-link d-flex flex-column justify-content-center align-items-center px-1 text-decoration-none"},{default:We(()=>m[1]||(m[1]=[C("i",{class:"bi bi-clipboard-check"},null,-1),Me(" Mis Rutinas ")])),_:1})]),m[4]||(m[4]=C("hr",null,null,-1)),C("li",Tk,[ye(_,{to:{name:"MyProfile"},class:"nav-link d-flex flex-column justify-content-center align-items-center px-1 text-decoration-none"},{default:We(()=>m[2]||(m[2]=[C("i",{class:"bi bi-person-circle"},null,-1),Me(" Mi Perfil ")])),_:1})]),m[5]||(m[5]=C("hr",null,null,-1)),C("li",wk,[C("button",{class:"nav-link d-flex flex-column justify-content-center align-items-center text-light px-1",onClick:$t(l,["prevent"])},m[3]||(m[3]=[C("i",{class:"bi bi-box-arrow-right"},null,-1),Me(" Cerrar Sesion ")]))])])],2)):Jt("",!0)]),_:1}),ye(jn,{name:"fade"},{default:We(()=>[n.value&&e.value?(me(),ve("div",{key:0,class:"darkSide",onClick:c})):Jt("",!0)]),_:1}),n.value?(me(),ve("header",Ik,[ye(_,{to:{name:"Dashboard"},class:"h2 mb-0 d-flex gap-2"},{default:We(()=>m[7]||(m[7]=[C("i",{class:"bi bi-house"},null,-1)])),_:1}),C("button",{class:"btn btn-outline-info",onClick:$t(c,["stop"])},m[8]||(m[8]=[C("i",{class:"bi bi-list"},null,-1)]))])):Jt("",!0)])}}},Ak=kr(bk,[["__scopeId","data-v-68d267cb"]]),Rk={class:"w-100"},Sk={__name:"DashboardPage",setup(t){const e=si(),{profile:n}=__(e);return Kn(()=>{console.log(n),n&&console.log("Onmounted: profile",n)}),(r,s)=>{const i=Ys("router-view");return me(),ve("div",Rk,[ye(Ak),ye(i,null,{default:We(({Component:o})=>[ye(jn,{name:"route-fade",mode:"out-in",class:"w-100 h-100 d-flex justify-content-center align-items-center"},{default:We(()=>[(me(),vo(nw(o)))]),_:2},1024)]),_:1})])}}},Ck=kr(Sk,[["__scopeId","data-v-6233ec35"]]),Pk={class:"vh-100 w-100 d-flex align-items-center justify-content-center title-container"},kk={class:"auth-links"},Ok={__name:"UnregistredPage",setup(t){return(e,n)=>{const r=Ys("router-link");return me(),ve("div",Pk,[n[2]||(n[2]=C("h2",null,[Me(" my workout app "),C("span",null,"my workout app"),C("span",null,"my workout app"),C("span",null,"Train Smart")],-1)),ye(jn,{name:"fade-slide-nav",appear:""},{default:We(()=>[C("nav",kk,[ye(r,{to:"/login",class:"btn px-4"},{default:We(()=>n[0]||(n[0]=[Me("Login")])),_:1}),ye(r,{to:"/register",class:"btn px-4"},{default:We(()=>n[1]||(n[1]=[Me("Register")])),_:1})])]),_:1})])}}},Dk={props:["rutina"]},xk={class:"px-2 py-1 rounded-xl shadow-md"},Vk={class:"text-start text-sm text-gray-500"},Nk={class:"mb-1"},Mk={class:"d-flex justify-content-between align-items-baseline"},Lk={class:"h5 text-lg text-start font-semibold mb-2"},Fk={class:"h5 text-sm text-end text-gray-400 mb-2"},Uk={class:"space-y-2 list-unstyled"},$k={class:"font-medium mb-4"},jk={class:"text-sm mt-2 d-flex justify-content-center gap-5 align-items-baseline"},Bk={class:"d-flex flex-column"},qk={class:"d-flex flex-column"},Hk={key:0},zk={key:1},Wk={class:"d-flex flex-column"},Kk={key:0},Gk={key:1},Qk={key:0,class:"mb-0"};function Yk(t,e,n,r,s,i){return me(),ve("div",xk,[C("div",Vk,[C("p",Nk," Descanso entre bloques: "+it(n.rutina.descansoBloques)+"s ",1),C("p",null," Descanso entre series: "+it(n.rutina.descansoSeries)+"s ",1)]),e[7]||(e[7]=C("hr",null,null,-1)),(me(!0),ve(It,null,Xi(n.rutina.bloques,(o,l)=>(me(),ve("div",{key:l,class:"my-3"},[C("div",Mk,[C("p",Lk,it(l+1)+"° Bloque ",1),C("p",Fk,it(o.series)+" Series",1)]),C("ul",Uk,[(me(!0),ve(It,null,Xi(o.ejercicios,(c,u)=>(me(),ve("li",{key:u,class:"p-3 rounded"},[C("div",$k,[C("h4",null,it(c.nombre),1)]),C("div",jk,[C("div",Bk,[e[0]||(e[0]=C("span",null,"Reps",-1)),e[1]||(e[1]=Me()),C("span",null,it(c.repeticiones),1)]),C("div",qk,[e[2]||(e[2]=C("span",null,"Tiempo",-1)),e[3]||(e[3]=Me()),c.tiempo!=0?(me(),ve("span",Hk,it(c.tiempo)+"s",1)):(me(),ve("span",zk,"-"))]),C("div",Wk,[e[4]||(e[4]=C("span",null,"Esfuerzo",-1)),e[5]||(e[5]=Me()),c.esfuerzo?(me(),ve("span",Kk,it(c.esfuerzo)+" RIR",1)):(me(),ve("span",Gk,"-"))])]),u!=o.ejercicios.length-1?(me(),ve("hr",Qk)):Jt("",!0)]))),128)),e[6]||(e[6]=C("hr",{class:"mb-0"},null,-1))])]))),128))])}const Jk=kr(Dk,[["render",Yk]]),Xk={class:"my-workouts"},Zk={class:"routines-container"},eO={class:"text-center mb-3"},tO={class:"d-flex justify-content-center justify-content-md-start ms-md-5 mb-3"},nO={class:"d-flex align-items-baseline text-start"},rO={key:0,class:"loader"},sO={class:"absolute d-flex justify-content-between top-2 left-0 text-sm text-gray-500"},iO={class:"text-center font-weight-medium my-2"},oO=["title"],aO={class:"d-flex justify-content-between align-items-center text-gray-700"},lO=["title"],cO=["innerHTML"],uO={key:0,class:"difficulty-text"},hO=["innerHTML"],fO={key:0,class:"difficulty-text"},dO=["onClick"],pO={key:0,class:"mini-menu"},mO=["onClick"],gO=["onClick"],_O=["onClick"],yO=["onClick"],vO={key:3,class:"edit-resume-container"},EO=["onClick"],TO=["onClick"],wO=["onClick"],IO=["onClick"],bO={__name:"MyWorkoutsPage",setup(t){const e=si(),n=Be(!0),r=Be(window.innerWidth<768),s=Be(new Map),i=Be([]);O_();const o=Qu(),l=Be(null),c={"Muy facil":1,Facil:2,Intermedia:3,Dificil:4,"Muy dificil":5},u=Be("fechaCreacionDesc"),f=ft(()=>e.getUserRoutines),p=ft(()=>[...f.value].sort((N,D)=>{if(u.value==="fechaCreacionDesc")return new Date(D.fechaCreacion)-new Date(N.fechaCreacion);if(u.value==="fechaCreacionAsc")return new Date(N.fechaCreacion)-new Date(D.fechaCreacion);{const q=c[N.dificultad]||0,te=c[D.dificultad]||0;return u.value==="asc"?q-te:te-q}}));Yr(l,N=>{N!==null?window.addEventListener("click",m):window.removeEventListener("click",m)}),Kn(async()=>{window.scrollTo({top:0,behavior:"smooth"})}),Yr(()=>e.profile.id,async N=>{if(N){n.value=!0;try{e.getUserRoutines.length===0?await e.getRutinas():n.value=!1}catch(D){console.error("Error al cargar rutinas:",D)}finally{n.value=!1}}},{immediate:!0});const m=N=>{const D=document.querySelector(".dropdown-menu-container");l.value!==null&&!(D!=null&&D.contains(N.target))&&(l.value=null)};function _(N){const D=i.value.indexOf(N);D!==-1?i.value.splice(D,1):(i.value.push(N),yo(()=>{setTimeout(()=>{const q=s.value.get(N);q==null||q.scrollIntoView({behavior:"smooth",block:"start"})},300)}))}async function A(N){if(!confirm("¿Estás seguro de que querés eliminar esta rutina?")){console.log("Eliminar cancelado");return}try{const D=i.value.indexOf(N);D!==-1&&i.value.splice(D,1),await e.deleteRutina(N),n.value=!1}catch(D){console.log("Error al borrar la rutina.",D)}}function O(N){o.push({name:"FormRoutine",query:{id:N.id}})}async function x(N){n.value=!0;const D={...JSON.parse(JSON.stringify(N)),nombre:N.nombre+" (copia)"};delete D.id,delete D.fechaCreacion;try{const q=await e.createRutinaFirebase(D);n.value=!1,_(q.id)}catch(q){console.error("Error copiando rutina:",q),n.value=!1}}const H=N=>(N.bloques||[]).reduce((D,q)=>D+(q.series||1),0),j=N=>"⚡️".repeat(c[N]||0);return(N,D)=>(me(),ve("div",Xk,[C("div",Zk,[D[15]||(D[15]=C("h1",{class:"my-md-5 mb-3"},[Me("Mis Rutinas "),C("i",{class:"bi bi-clipboard-check"})],-1)),C("div",eO,[ye(Fn(k_),{to:"/dashboard/form-routine",class:"btn btn-outline-danger px-5 d-flex gap-2 justify-content-center align-items-baseline",id:"add-routine"},{default:We(()=>D[2]||(D[2]=[C("i",{class:"bi bi-plus-circle-fill"},null,-1),Me(" Agregar Rutina ")])),_:1})]),je(C("div",tO,[C("div",nO,[D[4]||(D[4]=C("label",{for:"orderBy",class:"me-2"},"Ordenar por",-1)),je(C("select",{"onUpdate:modelValue":D[0]||(D[0]=q=>u.value=q),id:"orderBy",class:"p-2 m-2 rounded bg-dark text-white"},D[3]||(D[3]=[C("option",{value:"fechaCreacionDesc"},"Más Reciente",-1),C("option",{value:"fechaCreacionAsc"},"Más Antigua",-1),C("option",{value:"asc"},"De más fácil",-1),C("option",{value:"desc"},"De más difícil",-1)]),512),[[Wc,u.value]])])],512),[[Vn,f.value.length>0]]),n.value||f.value.length===0&&n.value?(me(),ve("div",rO)):Jt("",!0),je(C("div",null,[ye(mI,{name:"fade-item",tag:"ul",class:Vt(["routine-resumen",{"column-layout":i.value.length>0}])},{default:We(()=>[(me(!0),ve(It,null,Xi(p.value,q=>(me(),ve("li",{key:q.id,ref_for:!0,ref:te=>s.value.set(q.id,te),class:Vt(["mb-1 routine-card",{expanded:i.value.includes(q.id)}])},[C("div",sO,[C("h6",{class:Vt({h5:i.value.includes(q.id)})},it(q.bloques.length)+" Bloques",3),C("h6",{class:Vt({h5:i.value.includes(q.id)})},it(H(q))+" Series ",3)]),C("div",iO,[C("h3",{class:"ellipsis",title:q.nombre},it(q.nombre),9,oO)]),ye(jn,{name:"expand-fade"},{default:We(()=>[je(ye(Jk,{rutina:q},null,8,["rutina"]),[[Vn,i.value.includes(q.id)]])]),_:2},1024),C("div",aO,[r.value?(me(),ve("h6",{key:0,class:Vt(["mb-0 difficulty-container",{"h4 d-flex flex-column":i.value.includes(q.id)}]),title:q.dificultad},[C("span",{class:"difficulty-icons",innerHTML:j(q.dificultad)},null,8,cO),r.value||i.value.includes(q.id)?(me(),ve("span",uO," ("+it(q.dificultad)+") ",1)):Jt("",!0)],10,lO)):(me(),ve("h6",{key:1,class:Vt({h4:i.value.includes(q.id)})},[C("span",{class:"difficulty-icons",innerHTML:j(q.dificultad)},null,8,hO),r.value||i.value.includes(q.id)?(me(),ve("span",fO," ("+it(q.dificultad)+") ",1)):Jt("",!0)],2)),r.value&&!i.value.includes(q.id)?(me(),ve("div",{key:2,class:"dropdown-menu-container",onClick:D[1]||(D[1]=$t(()=>{},["stop"]))},[C("span",{onClick:$t(te=>l.value=l.value===q.id?null:q.id,["stop"])},D[5]||(D[5]=[C("i",{class:"bi bi-three-dots-vertical"},null,-1)]),8,dO),ye(jn,{name:"fade-item"},{default:We(()=>[l.value===q.id?(me(),ve("ul",pO,[C("li",{onClick:te=>_(q.id)},D[6]||(D[6]=[C("i",{class:"bi bi-arrows-angle-expand"},null,-1)]),8,mO),C("li",{onClick:$t(te=>O(q),["stop"])},D[7]||(D[7]=[C("i",{class:"bi bi-pencil-square"},null,-1)]),8,gO),C("li",{onClick:$t(te=>A(q.id),["stop"])},D[8]||(D[8]=[C("i",{class:"bi bi-trash3"},null,-1)]),8,_O),C("li",{onClick:$t(te=>x(q),["stop"])},D[9]||(D[9]=[C("i",{class:"bi bi-copy"},null,-1)]),8,yO)])):Jt("",!0)]),_:2},1024)])):(me(),ve("div",vO,[C("span",{onClick:te=>_(q.id)},D[10]||(D[10]=[C("i",{class:"bi bi-arrows-angle-expand"},null,-1)]),8,EO),C("span",{onClick:$t(te=>O(q),["stop"])},D[11]||(D[11]=[C("i",{class:"bi bi-pencil-square"},null,-1)]),8,TO),C("span",{onClick:$t(te=>A(q.id),["stop"])},D[12]||(D[12]=[C("i",{class:"bi bi-trash3"},null,-1)]),8,wO),C("span",{onClick:$t(te=>x(q),["stop"])},D[13]||(D[13]=[C("i",{class:"bi bi-copy"},null,-1)]),8,IO)]))])],2))),128))]),_:1},8,["class"])],512),[[Vn,p.value.length>0]]),je(C("div",null,D[14]||(D[14]=[C("h5",null,"No hay rutinas guardadas aún.",-1)]),512),[[Vn,p.value.length===0&&!n.value]])])]))}},AO=kr(bO,[["__scopeId","data-v-f973fdbf"]]),RO={class:"contenedor"},SO={class:"info-container"},CO={class:"w-100 mb-4 justify-content-center d-flex align-items-end gap-3"},PO={class:"text-start w-100"},kO={class:"w-100"},OO={class:"text-start"},DO=["value"],xO={__name:"ProfilePage",setup(t){const e=si(),n=ft(()=>e.profile),r=Be("");Kn(async()=>{r.value=n.value.nickname});const s=async()=>{try{e.setNickname(r.value),alert("Nombre de usuario actualizado correctamente")}catch(i){console.error("Error al actualizar nickname:",i),alert("Ocurrió un error al guardar.")}};return(i,o)=>(me(),ve("div",RO,[o[3]||(o[3]=C("h1",{class:"my-md-5"},[Me("Mi Perfil "),C("i",{class:"bi bi-person-circle"})],-1)),C("div",SO,[C("div",CO,[C("div",PO,[o[1]||(o[1]=C("label",{for:"username",class:"form-label"},"Nombre de Usuario",-1)),je(C("input",{type:"text","onUpdate:modelValue":o[0]||(o[0]=l=>r.value=l),spellcheck:"false",autocomplete:"off",id:"username",class:"form-control"},null,512),[[jt,r.value]])]),C("div",null,[C("button",{class:Vt(["btn btn-outline-success btn-guardar",r.value===n.value.nickname?"disabled":""]),onClick:s},"Guardar",2)])]),C("div",kO,[C("div",OO,[o[2]||(o[2]=C("label",{for:"email",class:"form-label"},"Email",-1)),C("input",{type:"text",value:n.value.email,id:"email",class:"form-control",readonly:"",disabled:""},null,8,DO)])])])]))}},VO=kr(xO,[["__scopeId","data-v-dd43bd1b"]]);var uE=typeof global=="object"&&global&&global.Object===Object&&global,NO=typeof self=="object"&&self&&self.Object===Object&&self,An=uE||NO||Function("return this")(),Ks=An.Symbol,hE=Object.prototype,MO=hE.hasOwnProperty,LO=hE.toString,bi=Ks?Ks.toStringTag:void 0;function FO(t){var e=MO.call(t,bi),n=t[bi];try{t[bi]=void 0;var r=!0}catch{}var s=LO.call(t);return r&&(e?t[bi]=n:delete t[bi]),s}var UO=Object.prototype,$O=UO.toString;function jO(t){return $O.call(t)}var BO="[object Null]",qO="[object Undefined]",Em=Ks?Ks.toStringTag:void 0;function Do(t){return t==null?t===void 0?qO:BO:Em&&Em in Object(t)?FO(t):jO(t)}function xo(t){return t!=null&&typeof t=="object"}var qh=Array.isArray;function Bl(t){var e=typeof t;return t!=null&&(e=="object"||e=="function")}var HO="[object AsyncFunction]",zO="[object Function]",WO="[object GeneratorFunction]",KO="[object Proxy]";function fE(t){if(!Bl(t))return!1;var e=Do(t);return e==zO||e==WO||e==HO||e==KO}var Dc=An["__core-js_shared__"],Tm=function(){var t=/[^.]+$/.exec(Dc&&Dc.keys&&Dc.keys.IE_PROTO||"");return t?"Symbol(src)_1."+t:""}();function GO(t){return!!Tm&&Tm in t}var QO=Function.prototype,YO=QO.toString;function fs(t){if(t!=null){try{return YO.call(t)}catch{}try{return t+""}catch{}}return""}var JO=/[\\^$.*+?()[\]{}|]/g,XO=/^\[object .+?Constructor\]$/,ZO=Function.prototype,eD=Object.prototype,tD=ZO.toString,nD=eD.hasOwnProperty,rD=RegExp("^"+tD.call(nD).replace(JO,"\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g,"$1.*?")+"$");function sD(t){if(!Bl(t)||GO(t))return!1;var e=fE(t)?rD:XO;return e.test(fs(t))}function iD(t,e){return t==null?void 0:t[e]}function ds(t,e){var n=iD(t,e);return sD(n)?n:void 0}var Au=ds(An,"WeakMap"),wm=Object.create,oD=function(){function t(){}return function(e){if(!Bl(e))return{};if(wm)return wm(e);t.prototype=e;var n=new t;return t.prototype=void 0,n}}(),Im=function(){try{var t=ds(Object,"defineProperty");return t({},"",{}),t}catch{}}();function aD(t,e){for(var n=-1,r=t==null?0:t.length;++n<r&&e(t[n],n,t)!==!1;);return t}var lD=9007199254740991,cD=/^(?:0|[1-9]\d*)$/;function uD(t,e){var n=typeof t;return e=e??lD,!!e&&(n=="number"||n!="symbol"&&cD.test(t))&&t>-1&&t%1==0&&t<e}function hD(t,e,n){e=="__proto__"&&Im?Im(t,e,{configurable:!0,enumerable:!0,value:n,writable:!0}):t[e]=n}function dE(t,e){return t===e||t!==t&&e!==e}var fD=Object.prototype,dD=fD.hasOwnProperty;function pD(t,e,n){var r=t[e];(!(dD.call(t,e)&&dE(r,n))||n===void 0&&!(e in t))&&hD(t,e,n)}var mD=9007199254740991;function pE(t){return typeof t=="number"&&t>-1&&t%1==0&&t<=mD}function gD(t){return t!=null&&pE(t.length)&&!fE(t)}var _D=Object.prototype;function mE(t){var e=t&&t.constructor,n=typeof e=="function"&&e.prototype||_D;return t===n}function yD(t,e){for(var n=-1,r=Array(t);++n<t;)r[n]=e(n);return r}var vD="[object Arguments]";function bm(t){return xo(t)&&Do(t)==vD}var gE=Object.prototype,ED=gE.hasOwnProperty,TD=gE.propertyIsEnumerable,wD=bm(function(){return arguments}())?bm:function(t){return xo(t)&&ED.call(t,"callee")&&!TD.call(t,"callee")};function ID(){return!1}var _E=typeof Ht=="object"&&Ht&&!Ht.nodeType&&Ht,Am=_E&&typeof zt=="object"&&zt&&!zt.nodeType&&zt,bD=Am&&Am.exports===_E,Rm=bD?An.Buffer:void 0,AD=Rm?Rm.isBuffer:void 0,yE=AD||ID,RD="[object Arguments]",SD="[object Array]",CD="[object Boolean]",PD="[object Date]",kD="[object Error]",OD="[object Function]",DD="[object Map]",xD="[object Number]",VD="[object Object]",ND="[object RegExp]",MD="[object Set]",LD="[object String]",FD="[object WeakMap]",UD="[object ArrayBuffer]",$D="[object DataView]",jD="[object Float32Array]",BD="[object Float64Array]",qD="[object Int8Array]",HD="[object Int16Array]",zD="[object Int32Array]",WD="[object Uint8Array]",KD="[object Uint8ClampedArray]",GD="[object Uint16Array]",QD="[object Uint32Array]",$e={};$e[jD]=$e[BD]=$e[qD]=$e[HD]=$e[zD]=$e[WD]=$e[KD]=$e[GD]=$e[QD]=!0;$e[RD]=$e[SD]=$e[UD]=$e[CD]=$e[$D]=$e[PD]=$e[kD]=$e[OD]=$e[DD]=$e[xD]=$e[VD]=$e[ND]=$e[MD]=$e[LD]=$e[FD]=!1;function YD(t){return xo(t)&&pE(t.length)&&!!$e[Do(t)]}function Hh(t){return function(e){return t(e)}}var vE=typeof Ht=="object"&&Ht&&!Ht.nodeType&&Ht,Ki=vE&&typeof zt=="object"&&zt&&!zt.nodeType&&zt,JD=Ki&&Ki.exports===vE,xc=JD&&uE.process,Gs=function(){try{var t=Ki&&Ki.require&&Ki.require("util").types;return t||xc&&xc.binding&&xc.binding("util")}catch{}}(),Sm=Gs&&Gs.isTypedArray,XD=Sm?Hh(Sm):YD,ZD=Object.prototype,ex=ZD.hasOwnProperty;function tx(t,e){var n=qh(t),r=!n&&wD(t),s=!n&&!r&&yE(t),i=!n&&!r&&!s&&XD(t),o=n||r||s||i,l=o?yD(t.length,String):[],c=l.length;for(var u in t)ex.call(t,u)&&!(o&&(u=="length"||s&&(u=="offset"||u=="parent")||i&&(u=="buffer"||u=="byteLength"||u=="byteOffset")||uD(u,c)))&&l.push(u);return l}function EE(t,e){return function(n){return t(e(n))}}var nx=EE(Object.keys,Object),rx=Object.prototype,sx=rx.hasOwnProperty;function ix(t){if(!mE(t))return nx(t);var e=[];for(var n in Object(t))sx.call(t,n)&&n!="constructor"&&e.push(n);return e}function ox(t){return gD(t)?tx(t):ix(t)}var po=ds(Object,"create");function ax(){this.__data__=po?po(null):{},this.size=0}function lx(t){var e=this.has(t)&&delete this.__data__[t];return this.size-=e?1:0,e}var cx="__lodash_hash_undefined__",ux=Object.prototype,hx=ux.hasOwnProperty;function fx(t){var e=this.__data__;if(po){var n=e[t];return n===cx?void 0:n}return hx.call(e,t)?e[t]:void 0}var dx=Object.prototype,px=dx.hasOwnProperty;function mx(t){var e=this.__data__;return po?e[t]!==void 0:px.call(e,t)}var gx="__lodash_hash_undefined__";function _x(t,e){var n=this.__data__;return this.size+=this.has(t)?0:1,n[t]=po&&e===void 0?gx:e,this}function is(t){var e=-1,n=t==null?0:t.length;for(this.clear();++e<n;){var r=t[e];this.set(r[0],r[1])}}is.prototype.clear=ax;is.prototype.delete=lx;is.prototype.get=fx;is.prototype.has=mx;is.prototype.set=_x;function yx(){this.__data__=[],this.size=0}function ql(t,e){for(var n=t.length;n--;)if(dE(t[n][0],e))return n;return-1}var vx=Array.prototype,Ex=vx.splice;function Tx(t){var e=this.__data__,n=ql(e,t);if(n<0)return!1;var r=e.length-1;return n==r?e.pop():Ex.call(e,n,1),--this.size,!0}function wx(t){var e=this.__data__,n=ql(e,t);return n<0?void 0:e[n][1]}function Ix(t){return ql(this.__data__,t)>-1}function bx(t,e){var n=this.__data__,r=ql(n,t);return r<0?(++this.size,n.push([t,e])):n[r][1]=e,this}function Qn(t){var e=-1,n=t==null?0:t.length;for(this.clear();++e<n;){var r=t[e];this.set(r[0],r[1])}}Qn.prototype.clear=yx;Qn.prototype.delete=Tx;Qn.prototype.get=wx;Qn.prototype.has=Ix;Qn.prototype.set=bx;var mo=ds(An,"Map");function Ax(){this.size=0,this.__data__={hash:new is,map:new(mo||Qn),string:new is}}function Rx(t){var e=typeof t;return e=="string"||e=="number"||e=="symbol"||e=="boolean"?t!=="__proto__":t===null}function Hl(t,e){var n=t.__data__;return Rx(e)?n[typeof e=="string"?"string":"hash"]:n.map}function Sx(t){var e=Hl(this,t).delete(t);return this.size-=e?1:0,e}function Cx(t){return Hl(this,t).get(t)}function Px(t){return Hl(this,t).has(t)}function kx(t,e){var n=Hl(this,t),r=n.size;return n.set(t,e),this.size+=n.size==r?0:1,this}function ii(t){var e=-1,n=t==null?0:t.length;for(this.clear();++e<n;){var r=t[e];this.set(r[0],r[1])}}ii.prototype.clear=Ax;ii.prototype.delete=Sx;ii.prototype.get=Cx;ii.prototype.has=Px;ii.prototype.set=kx;function Ox(t,e){for(var n=-1,r=e.length,s=t.length;++n<r;)t[s+n]=e[n];return t}var Dx=EE(Object.getPrototypeOf,Object);function xx(){this.__data__=new Qn,this.size=0}function Vx(t){var e=this.__data__,n=e.delete(t);return this.size=e.size,n}function Nx(t){return this.__data__.get(t)}function Mx(t){return this.__data__.has(t)}var Lx=200;function Fx(t,e){var n=this.__data__;if(n instanceof Qn){var r=n.__data__;if(!mo||r.length<Lx-1)return r.push([t,e]),this.size=++n.size,this;n=this.__data__=new ii(r)}return n.set(t,e),this.size=n.size,this}function oi(t){var e=this.__data__=new Qn(t);this.size=e.size}oi.prototype.clear=xx;oi.prototype.delete=Vx;oi.prototype.get=Nx;oi.prototype.has=Mx;oi.prototype.set=Fx;var TE=typeof Ht=="object"&&Ht&&!Ht.nodeType&&Ht,Cm=TE&&typeof zt=="object"&&zt&&!zt.nodeType&&zt,Ux=Cm&&Cm.exports===TE,Pm=Ux?An.Buffer:void 0;Pm&&Pm.allocUnsafe;function $x(t,e){return t.slice()}function jx(t,e){for(var n=-1,r=t==null?0:t.length,s=0,i=[];++n<r;){var o=t[n];e(o,n,t)&&(i[s++]=o)}return i}function Bx(){return[]}var qx=Object.prototype,Hx=qx.propertyIsEnumerable,km=Object.getOwnPropertySymbols,zx=km?function(t){return t==null?[]:(t=Object(t),jx(km(t),function(e){return Hx.call(t,e)}))}:Bx;function Wx(t,e,n){var r=e(t);return qh(t)?r:Ox(r,n(t))}function Kx(t){return Wx(t,ox,zx)}var Ru=ds(An,"DataView"),Su=ds(An,"Promise"),Cu=ds(An,"Set"),Om="[object Map]",Gx="[object Object]",Dm="[object Promise]",xm="[object Set]",Vm="[object WeakMap]",Nm="[object DataView]",Qx=fs(Ru),Yx=fs(mo),Jx=fs(Su),Xx=fs(Cu),Zx=fs(Au),On=Do;(Ru&&On(new Ru(new ArrayBuffer(1)))!=Nm||mo&&On(new mo)!=Om||Su&&On(Su.resolve())!=Dm||Cu&&On(new Cu)!=xm||Au&&On(new Au)!=Vm)&&(On=function(t){var e=Do(t),n=e==Gx?t.constructor:void 0,r=n?fs(n):"";if(r)switch(r){case Qx:return Nm;case Yx:return Om;case Jx:return Dm;case Xx:return xm;case Zx:return Vm}return e});var eV=Object.prototype,tV=eV.hasOwnProperty;function nV(t){var e=t.length,n=new t.constructor(e);return e&&typeof t[0]=="string"&&tV.call(t,"index")&&(n.index=t.index,n.input=t.input),n}var Mm=An.Uint8Array;function zh(t){var e=new t.constructor(t.byteLength);return new Mm(e).set(new Mm(t)),e}function rV(t,e){var n=zh(t.buffer);return new t.constructor(n,t.byteOffset,t.byteLength)}var sV=/\w*$/;function iV(t){var e=new t.constructor(t.source,sV.exec(t));return e.lastIndex=t.lastIndex,e}var Lm=Ks?Ks.prototype:void 0,Fm=Lm?Lm.valueOf:void 0;function oV(t){return Fm?Object(Fm.call(t)):{}}function aV(t,e){var n=zh(t.buffer);return new t.constructor(n,t.byteOffset,t.length)}var lV="[object Boolean]",cV="[object Date]",uV="[object Map]",hV="[object Number]",fV="[object RegExp]",dV="[object Set]",pV="[object String]",mV="[object Symbol]",gV="[object ArrayBuffer]",_V="[object DataView]",yV="[object Float32Array]",vV="[object Float64Array]",EV="[object Int8Array]",TV="[object Int16Array]",wV="[object Int32Array]",IV="[object Uint8Array]",bV="[object Uint8ClampedArray]",AV="[object Uint16Array]",RV="[object Uint32Array]";function SV(t,e,n){var r=t.constructor;switch(e){case gV:return zh(t);case lV:case cV:return new r(+t);case _V:return rV(t);case yV:case vV:case EV:case TV:case wV:case IV:case bV:case AV:case RV:return aV(t);case uV:return new r;case hV:case pV:return new r(t);case fV:return iV(t);case dV:return new r;case mV:return oV(t)}}function CV(t){return typeof t.constructor=="function"&&!mE(t)?oD(Dx(t)):{}}var PV="[object Map]";function kV(t){return xo(t)&&On(t)==PV}var Um=Gs&&Gs.isMap,OV=Um?Hh(Um):kV,DV="[object Set]";function xV(t){return xo(t)&&On(t)==DV}var $m=Gs&&Gs.isSet,VV=$m?Hh($m):xV,wE="[object Arguments]",NV="[object Array]",MV="[object Boolean]",LV="[object Date]",FV="[object Error]",IE="[object Function]",UV="[object GeneratorFunction]",$V="[object Map]",jV="[object Number]",bE="[object Object]",BV="[object RegExp]",qV="[object Set]",HV="[object String]",zV="[object Symbol]",WV="[object WeakMap]",KV="[object ArrayBuffer]",GV="[object DataView]",QV="[object Float32Array]",YV="[object Float64Array]",JV="[object Int8Array]",XV="[object Int16Array]",ZV="[object Int32Array]",eN="[object Uint8Array]",tN="[object Uint8ClampedArray]",nN="[object Uint16Array]",rN="[object Uint32Array]",Le={};Le[wE]=Le[NV]=Le[KV]=Le[GV]=Le[MV]=Le[LV]=Le[QV]=Le[YV]=Le[JV]=Le[XV]=Le[ZV]=Le[$V]=Le[jV]=Le[bE]=Le[BV]=Le[qV]=Le[HV]=Le[zV]=Le[eN]=Le[tN]=Le[nN]=Le[rN]=!0;Le[FV]=Le[IE]=Le[WV]=!1;function Ta(t,e,n,r,s,i){var o;if(o!==void 0)return o;if(!Bl(t))return t;var l=qh(t);if(l)o=nV(t);else{var c=On(t),u=c==IE||c==UV;if(yE(t))return $x(t);if(c==bE||c==wE||u&&!s)o=u?{}:CV(t);else{if(!Le[c])return s?t:{};o=SV(t,c)}}i||(i=new oi);var f=i.get(t);if(f)return f;i.set(t,o),VV(t)?t.forEach(function(_){o.add(Ta(_,e,n,_,t,i))}):OV(t)&&t.forEach(function(_,A){o.set(A,Ta(_,e,n,A,t,i))});var p=Kx,m=l?void 0:p(t);return aD(m||t,function(_,A){m&&(A=_,_=t[A]),pD(o,A,Ta(_,e,n,A,t,i))}),o}var sN=1,iN=4;function oN(t){return Ta(t,sN|iN)}const aN={class:"add-routine-form"},lN={class:"text-center mb-4"},cN={class:"mb-3 text-start"},uN={class:"mb-3 flex-column d-flex justify-content-center align-items-start col-md-3"},hN={class:"mb-3 text-start d-flex justify-content-start gap-5 align-items-center"},fN={class:"mb-3 text-start d-flex justify-content-start gap-5 align-items-center"},dN={class:"mb-3 d-flex justify-content-between align-items-baseline"},pN={class:"text-start m-0"},mN={class:"d-flex flex-column align-items-center justify-content-center col-md-2"},gN=["onUpdate:modelValue","id"],_N={class:"row w-100 d-flex flex-column justify-content-center gap-3"},yN={class:"w-100 mb-2"},vN=["onUpdate:modelValue","id"],EN={class:"setting-exercise"},TN={class:"col-md-3 mb-2 text-center"},wN=["onUpdate:modelValue","id"],IN={class:"col-md-3 text-center"},bN=["onUpdate:modelValue","id"],AN={class:"col-md-3 text-center"},RN=["onUpdate:modelValue","id"],SN={class:"d-flex w-100 justify-content-center gap-2"},CN=["onClick"],PN=["onClick"],kN={class:"btns-set-bloque"},ON=["onClick"],DN={key:0,class:"loader-form"},xN={__name:"FormRoutine",props:{rutinaParaEditar:Object},setup(t){const e=si(),n=O_(),r=Qu(),s=Be(!1),i=Qs({nombre:"",dificultad:"Intermedia",descansoBloques:60,descansoSeries:60,bloques:[{series:3,ejercicios:[{nombre:"",repeticiones:1,tiempo:0,esfuerzo:0}]}]});Kn(async()=>{window.scrollTo({top:0,behavior:"smooth"});const _=n.query.id;if(_)try{const A=e.getRutinaLocal(_);A?Object.assign(i,oN(A)):console.warn(`No se encontró la rutina con ID: ${_}`)}catch(A){console.error("Error al cargar la rutina para editar:",A)}});const o=()=>{r.push({name:"MyWorkouts"})},l=async()=>{s.value=!0;try{i.id?await e.updateRutina({...i}):await e.createRutinaFirebase({...i}),s.value=!1,r.push({name:"MyWorkouts"})}catch(_){console.error("Error al guardar la rutina:",_)}},c=()=>{i.bloques.push({series:3,ejercicios:[{nombre:"",repeticiones:1,tiempo:0,esfuerzo:0}]})},u=_=>{i.bloques.splice(_,1)},f=_=>{i.bloques[_].ejercicios.push({nombre:"",repeticiones:1,tiempo:0,esfuerzo:0})},p=(_,A)=>{i.bloques[_].ejercicios.splice(A,1)},m=_=>_===null||_===""||_===void 0?"input-alert":"";return(_,A)=>(me(),ve("div",aN,[C("h2",lN,it(i.id?"Editar Rutina":"Agregar Nueva Rutina"),1),C("form",{onSubmit:$t(l,["prevent"]),class:"p-2 p-md-4"},[C("div",cN,[A[4]||(A[4]=C("label",{for:"nombre",class:"form-label"},"Nombre",-1)),je(C("input",{type:"text","onUpdate:modelValue":A[0]||(A[0]=O=>i.nombre=O),spellcheck:"false",autocomplete:"on",class:Vt(["form-control",m(i.nombre)]),id:"nombre",required:""},null,2),[[jt,i.nombre]])]),C("div",uN,[A[6]||(A[6]=C("label",{for:"dificultad",class:"form-label"},"Dificultad",-1)),je(C("select",{"onUpdate:modelValue":A[1]||(A[1]=O=>i.dificultad=O),class:"form-select text-info input-difficulty",id:"dificultad",required:""},A[5]||(A[5]=[Nw('<option value="Muy facil" data-v-698e686d>Muy fácil</option><option value="Facil" data-v-698e686d>Fácil</option><option value="Intermedia" data-v-698e686d>Intermedia</option><option value="Dificil" data-v-698e686d>Difícil</option><option value="Muy dificil" data-v-698e686d>Muy difícil</option>',5)]),512),[[Wc,i.dificultad]])]),C("div",hN,[A[7]||(A[7]=C("label",{for:"descansoBloques",class:"form-label w-50 mb-0"}," Descanso entre Bloques ",-1)),je(C("input",{type:"number","onUpdate:modelValue":A[2]||(A[2]=O=>i.descansoBloques=O),class:"form-control input-number",id:"descansoBloques"},null,512),[[jt,i.descansoBloques]])]),C("div",fN,[A[8]||(A[8]=C("label",{for:"descansoSeries",class:"form-label w-50 mb-0"},"Descanso entre Series",-1)),je(C("input",{type:"number","onUpdate:modelValue":A[3]||(A[3]=O=>i.descansoSeries=O),class:"form-control input-number",id:"descansoSeries"},null,512),[[jt,i.descansoSeries]])]),(me(!0),ve(It,null,Xi(i.bloques,(O,x)=>(me(),ve("div",{key:x,class:"bloque-container mb-3 px-2 pt-2 pb-3 rounded text-start"},[C("div",dN,[C("h5",pN,it(x+1)+"° Bloque",1),C("div",mN,[A[9]||(A[9]=C("label",{for:"series-bloque-{{ index }}",class:"form-label mb-1"},"Series",-1)),je(C("input",{type:"number","onUpdate:modelValue":H=>O.series=H,class:"form-control input-number",id:"series-bloque-"+x,min:"1"},null,8,gN),[[jt,O.series]])])]),(me(!0),ve(It,null,Xi(O.ejercicios,(H,j)=>(me(),ve("div",{key:j,class:"ejercicio-container p-2 d-flex flex-column align-items-center gap-3"},[C("div",_N,[C("div",yN,[A[10]||(A[10]=C("label",{for:"ejercicio-{{ index }}-{{ ejercicioIndex }}",class:"form-label"},"Ejercicio",-1)),je(C("input",{type:"text","onUpdate:modelValue":N=>H.nombre=N,spellcheck:"false",autocomplete:"on",required:"",class:Vt(["form-control",m(i.nombre)]),id:"ejercicio-"+x+"-"+j},null,10,vN),[[jt,H.nombre]])])]),C("div",EN,[C("div",TN,[A[11]||(A[11]=C("label",{for:"reps-{{ index }}-{{ ejercicioIndex }}",class:"form-label"},"Reps",-1)),je(C("input",{type:"number","onUpdate:modelValue":N=>H.repeticiones=N,class:"form-control input-number",id:"reps-"+x+"-"+j,min:"1"},null,8,wN),[[jt,H.repeticiones]])]),C("div",IN,[A[12]||(A[12]=C("label",{for:"tiempo-{{ index }}-{{ ejercicioIndex }}",class:"form-label"},"Tiempo",-1)),je(C("input",{type:"number","onUpdate:modelValue":N=>H.tiempo=N,class:"form-control input-number",id:"tiempo-"+x+"-"+j,min:"0"},null,8,bN),[[jt,H.tiempo]])]),C("div",AN,[A[14]||(A[14]=C("label",{for:"esfuerzo-{{ index }}-{{ ejercicioIndex }}",class:"form-label"},"Esfuerzo",-1)),je(C("select",{"onUpdate:modelValue":N=>H.esfuerzo=N,class:"form-select text-info input-rir",id:"esfuerzo-"+x+"-"+j},A[13]||(A[13]=[C("option",{select:"",value:""},"-",-1),C("option",{value:"1"},"RIR 1",-1),C("option",{value:"2"},"RIR 2",-1),C("option",{value:"3"},"RIR 3",-1)]),8,RN),[[Wc,H.esfuerzo]])])]),C("div",SN,[C("button",{type:"button",onClick:N=>f(x),class:"btn btn-outline-info"},A[15]||(A[15]=[C("i",{class:"bi bi-plus-circle-fill"},null,-1),Me(" Ejercicio ")]),8,CN),j>0?(me(),ve("button",{key:0,type:"button",onClick:N=>p(x,j),class:"btn btn-outline-danger delete-exercise"},A[16]||(A[16]=[C("i",{class:"bi bi-trash-fill"},null,-1),Me(" Ejercicio ")]),8,PN)):Jt("",!0)])]))),128)),C("div",kN,[x>0?(me(),ve("button",{key:0,type:"button",onClick:H=>u(x),class:"btn btn-outline-danger"},A[17]||(A[17]=[C("i",{class:"bi bi-trash-fill"},null,-1),Me(" Bloque ")]),8,ON)):Jt("",!0)])]))),128)),C("div",{class:"text-center d-flex flex-column align-items-center"},[C("button",{type:"button",onClick:c,class:"btn btn-outline-info"},A[18]||(A[18]=[C("i",{class:"bi bi-plus-circle-fill"},null,-1),Me(" Agregar Bloque ")]))]),A[21]||(A[21]=C("hr",null,null,-1)),s.value?(me(),ve("div",DN)):Jt("",!0),C("div",{class:"text-center d-flex btns-set-routine flex-column align-items-center"},[A[20]||(A[20]=C("button",{type:"submit",class:"btn btn-success mt-0"},[C("i",{class:"bi bi-box-arrow-down"}),Me(" Guardar rutina ")],-1)),C("button",{type:"button",onClick:o,class:"btn btn-danger mt-3"},A[19]||(A[19]=[C("i",{class:"bi bi-x-circle"},null,-1),Me(" Cancelar ")]))])],32)]))}},VN=kr(xN,[["__scopeId","data-v-698e686d"]]),NN=[{path:"/register",name:"Register",component:dk},{path:"/login",name:"Login",component:ok},{path:"/dashboard",name:"Dashboard",component:Ck,children:[{path:"my-workouts",name:"MyWorkouts",component:AO},{path:"my-profile",name:"MyProfile",component:VO},{path:"form-routine",name:"FormRoutine",component:VN},{path:"",redirect:{name:"MyWorkouts"}}],meta:{requiresAuth:!0}},{path:"/unregistred",name:"Unregistred",component:Ok},{path:"/:pathMatch(.*)*",redirect:{name:"Unregistred"}}],Wh=Fb({history:pb("/my-workout-app/"),routes:NN});let Vc=null;function MN(){return new Promise(t=>{Vc!==null?t(Vc):Jv(Di,e=>{Vc=e,t(e)})})}Wh.beforeEach(async(t,e,n)=>{const r=await MN();if(console.log("Middleware routes, to:",t.fullPath),t.path==="/my-workout-app/login"&&r)return n("/my-workout-app/dashboard");if(t.matched.some(s=>s.meta.requiresAuth)&&!r)return n("/my-workout-app/login");n()});const Kh=AI(MI),AE=CI();AE.use(({store:t})=>{t.$router=al(Wh)});Kh.use(AE);Kh.use(Wh);const LN=jl();LN.initAuthListener();Kh.mount("#app")});export default FN();
