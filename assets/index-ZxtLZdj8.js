 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Xs=o0;function j_(t,e={}){let n=t;typeof e!="object"&&(e={name:e});const r=Object.assign({name:tu,automaticDataCollectionEnabled:!1},e),s=r.name;if(typeof s!="string"||!s)throw yr.create("bad-app-name",{appName:String(s)});if(n||(n=M_()),!n)throw yr.create("no-options");const i=Ma.get(s);if(i){if(es(n,i.options)&&es(r,i.config))return i;throw yr.create("duplicate-app",{appName:s})}const o=new gA(s);for(const c of nu.values())o.addComponent(c);const l=new u0(n,r,o);return Ma.set(s,l),l}function B_(t=tu){const e=Ma.get(t);if(!e&&t===tu&&M_())return j_();if(!e)throw yr.create("no-app",{appName:t});return e}function vr(t,e,n){var r;let s=(r=a0[t])!==null&&r!==void 0?r:t;n&&(s+=`-${n}`);const i=s.match(/\s|\//),o=e.match(/\s|\//);if(i||o){const l=[`Unable to register library "${s}" with version "${e}":`];i&&l.push(`library name "${s}" contains illegal characters (whitespace or "/")`),i&&o&&l.push("and"),o&&l.push(`version name "${e}" contains illegal characters (whitespace or "/")`),Bn.warn(l.join(" "));return}$s(new ts(`${s}-version`,()=>({library:s,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const h0="firebase-heartbeat-database",f0=1,ro="firebase-heartbeat-store";let Ac=null;function q_(){return Ac||(Ac=CA(h0,f0,{upgrade:(t,e)=>{switch(e){case 0:try{t.createObjectStore(ro)}catch(n){console.warn(n)}}}}).catch(t=>{throw yr.create("idb-open",{originalErrorMessage:t.message})})),Ac}async function d0(t){try{const n=(await q_()).transaction(ro),r=await n.objectStore(ro).get(H_(t));return await n.done,r}catch(e){if(e instanceof Gn)Bn.warn(e.message);else{const n=yr.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});Bn.warn(n.message)}}}async function Qd(t,e){try{const r=(await q_()).transaction(ro,"readwrite");await r.objectStore(ro).put(e,H_(t)),await r.done}catch(n){if(n instanceof Gn)Bn.warn(n.message);else{const r=yr.create("idb-set",{originalErrorMessage:n==null?void 0:n.message});Bn.warn(r.message)}}}function H_(t){return`${t.name}!${t.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function E0(t){$s(new ts("platform-logger",e=>new xA(e),"PRIVATE")),$s(new ts("heartbeat",e=>new g0(e),"PRIVATE")),vr(eu,Kd,t),vr(eu,Kd,"esm2017"),vr("fire-js","")}E0("");var T0="firebase",w0="11.7.1";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */vr(T0,w0,"app");var Xd=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const so=-1;function x0(t,e){const n=t.toTimestamp().seconds,r=t.toTimestamp().nanoseconds+1,s=de.fromTimestamp(r===1e9?new rt(n+1,0):new rt(n,r));return new Ir(s,se.empty(),e)}function D0(t){return new Ir(t.readTime,t.key,so)}class Ir{constructor(e,n,r){this.readTime=e,this.documentKey=n,this.largestBatchId=r}static min(){return new Ir(de.min(),se.empty(),so)}static max(){return new Ir(de.max(),se.empty(),so)}}function V0(t,e){let n=t.readTime.compareTo(e.readTime);return n!==0?n:(n=se.comparator(t.documentKey,e.documentKey),n!==0?n:ye(t.largestBatchId,e.largestBatchId))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const IR=new Er([4294967295,4294967295],0);function wp(t){const e=Z_().encode(t),n=new z_;return n.update(e),new Uint8Array(n.digest())}function Ip(t){const e=new DataView(t.buffer),n=e.getUint32(0,!0),r=e.getUint32(4,!0),s=e.getUint32(8,!0),i=e.getUint32(12,!0);return[new Er([n,r],0),new Er([s,i],0)]}class ch{constructor(e,n,r){if(this.bitmap=e,this.padding=n,this.hashCount=r,n<0||n>=8)throw new Oi(`Invalid padding: ${n}`);if(r<0)throw new Oi(`Invalid hash count: ${r}`);if(e.length>0&&this.hashCount===0)throw new Oi(`Invalid hash count: ${r}`);if(e.length===0&&n!==0)throw new Oi(`Invalid padding when bitmap length is 0: ${n}`);this.pe=8*e.length-n,this.ye=Er.fromNumber(this.pe)}we(e,n,r){let s=e.add(n.multiply(Er.fromNumber(r)));return s.compare(IR)===1&&(s=new Er([s.getBits(0),s.getBits(1)],0)),s.modulo(this.ye).toNumber()}be(e){return!!(this.bitmap[Math.floor(e/8)]&1<<e%8)}mightContain(e){if(this.pe===0)return!1;const n=wp(e),[r,s]=Ip(n);for(let i=0;i<this.hashCount;i++){const o=this.we(r,s,i);if(!this.be(o))return!1}return!0}static create(e,n,r){const s=e%8==0?0:8-e%8,i=new Uint8Array(Math.ceil(e/8)),o=new ch(i,s,n);return r.forEach(l=>o.insert(l)),o}insert(e){if(this.pe===0)return;const n=wp(e),[r,s]=Ip(n);for(let i=0;i<this.hashCount;i++){const o=this.we(r,s,i);this.Se(o)}}Se(e){const n=Math.floor(e/8),r=e%8;this.bitmap[n]|=1<<r}}class Oi extends Error{constructor(){super(...arguments),this.name="BloomFilterError"}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class us{constructor(e,n,r){this.converter=n,this._query=r,this.type="query",this.firestore=e}withConverter(e){return new us(this.firestore,e,this._query)}}class Ot{constructor(e,n,r){this.converter=n,this._key=r,this.type="document",this.firestore=e}get _path(){return this._key.path}get id(){return this._key.path.lastSegment()}get path(){return this._key.path.canonicalString()}get parent(){return new Tr(this.firestore,this.converter,this._key.path.popLast())}withConverter(e){return new Ot(this.firestore,e,this._key)}}class Tr extends us{constructor(e,n,r){super(e,n,ih(r)),this._path=r,this.type="collection"}get id(){return this._query.path.lastSegment()}get path(){return this._query.path.canonicalString()}get parent(){const e=this._path.popLast();return e.isEmpty()?null:new Ot(this.firestore,null,new se(e))}withConverter(e){return new Tr(this.firestore,e,this._path)}}function Kp(t,e,...n){if(t=lt(t),dv("collection","path",e),t instanceof Ol){const r=qe.fromString(e,...n);return Hp(r),new Tr(t,null,r)}{if(!(t instanceof Ot||t instanceof Tr))throw new ee(F.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const r=t._path.child(qe.fromString(e,...n));return Hp(r),new Tr(t.firestore,null,r)}}function Ss(t,e,...n){if(t=lt(t),arguments.length===1&&(e=ey.newId()),dv("doc","path",e),t instanceof Ol){const r=qe.fromString(e,...n);return qp(r),new Ot(t,null,new se(r))}{if(!(t instanceof Ot||t instanceof Tr))throw new ee(F.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const r=t._path.child(qe.fromString(e,...n));return qp(r),new Ot(t.firestore,t instanceof Tr?t.converter:null,new se(r))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ho(t,e,n=!1){if(n)return e;try{return await e}catch(r){throw r instanceof Gn&&ZP(r)&&t.auth.currentUser===t&&await t.auth.signOut(),r}}function ZP({code:t}){return t==="auth/user-disabled"||t==="auth/user-token-expired"}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ur extends ko{constructor(){super("facebook.com")}static credential(e){return ss._fromParams({providerId:ur.PROVIDER_ID,signInMethod:ur.FACEBOOK_SIGN_IN_METHOD,accessToken:e})}static credentialFromResult(e){return ur.credentialFromTaggedObject(e)}static credentialFromError(e){return ur.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e||!("oauthAccessToken"in e)||!e.oauthAccessToken)return null;try{return ur.credential(e.oauthAccessToken)}catch{return null}}}ur.FACEBOOK_SIGN_IN_METHOD="facebook.com";ur.PROVIDER_ID="facebook.com";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class fr extends ko{constructor(){super("github.com")}static credential(e){return ss._fromParams({providerId:fr.PROVIDER_ID,signInMethod:fr.GITHUB_SIGN_IN_METHOD,accessToken:e})}static credentialFromResult(e){return fr.credentialFromTaggedObject(e)}static credentialFromError(e){return fr.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e||!("oauthAccessToken"in e)||!e.oauthAccessToken)return null;try{return fr.credential(e.oauthAccessToken)}catch{return null}}}fr.GITHUB_SIGN_IN_METHOD="github.com";fr.PROVIDER_ID="github.com";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const G1=5*60,Q1=L_("authIdTokenMaxAge")||G1;let vm=null;const Y1=t=>async e=>{const n=e&&await e.getIdTokenResult(),r=n&&(new Date().getTime()-Date.parse(n.issuedAtTime))/1e3;if(r&&r>Q1)return;const s=n==null?void 0:n.token;vm!==s&&(vm=s,await fetch(t,{method:s?"POST":"DELETE",headers:s?{Authorization:`Bearer ${s}`}:{}}))};function J1(t=B_()){const e=Xu(t,"auth");if(e.isInitialized())return e.getImmediate();const n=EC(t,{popupRedirectResolver:H1,persistence:[t1,qC,tE]}),r=L_("authTokenSyncURL");if(r&&typeof isSecureContext=="boolean"&&isSecureContext){const i=new URL(r,location.origin);if(location.origin===i.origin){const o=Y1(i.toString());UC(n,o,()=>o(n.currentUser)),FC(n,l=>o(l))}}const s=N_("auth");return s&&wC(n,`http://${s}`),n}function X1(){var t,e;return(e=(t=document.getElementsByTagName("head"))===null||t===void 0?void 0:t[0])!==null&&e!==void 0?e:document}fC({loadJS(t){return new Promise((e,n)=>{const r=document.createElement("script");r.setAttribute("src",t),r.onload=e,r.onerror=s=>{const i=wn("internal-error");i.customData=s,n(i)},r.type="text/javascript",r.charset="UTF-8",X1().appendChild(r)})},gapiScript:"https://apis.google.com/js/api.js",recaptchaV2Script:"https://www.google.com/recaptcha/api.js",recaptchaEnterpriseScript:"https://www.google.com/recaptcha/enterprise.js?render="});K1("Browser");const Z1={apiKey:"AIzaSyAH7Qc8QkTR8AWBOxptwHH6IxIXpIx-c00",authDomain:"calisteniarg-f3d40.firebaseapp.com",projectId:"calisteniarg-f3d40",storageBucket:"calisteniarg-f3d40.firebasestorage.app",messagingSenderId:"641759769239",appId:"1:641759769239:web:9e4d3ffdd5dc9645f56fd2"},lE=j_(Z1),qr=_P(lE),Di=J1(lE),ii=g_("profile",{state:()=>({profile:{id:null,email:"",nickname:"",routines:[],charge:!1}}),actions:{async loadProfile(t,e){if(!t)throw new Error("UID de usuario inválido");const n=Ss(qr,"profiles",t);try{const r=await Zp(n);if(r.exists()){const s=r.data();this.profile={id:t,email:s.email,nickname:s.nickname||"",routines:[]}}else await NP(n,{idUser:t,email:e,nickname:""}),this.profile={id:t,email:e,nickname:"",routines:[]}}catch(r){throw console.error("Error al cargar o crear el perfil:",r),r}},async setNickname(t){if(!this.profile.id)throw new Error("Usuario no autenticado");const e=Ss(qr,"profiles",this.profile.id);try{await em(e,{nickname:t}),this.profile.nickname=t}catch(n){throw console.error("Error al actualizar el nickname:",n),n}},async getRutinas(){if(console.log("GetRutinas()"),!this.profile.id)throw new Error("Usuario no autenticado");const t=Kp(qr,"routines"),e=[CP("idUser","==",this.profile.id),kP("fechaCreacion","desc")],n=PP(t,...e);try{const r=await VP(n),s=[];r.forEach(i=>{s.push({id:i.id,...i.data()})}),this.profile.routines=s}catch(r){throw console.error("Error al obtener las rutinas:",r),r}},async getRutina(t){try{const e=Ss(qr,"routines",t),n=await Zp(e);return n.exists()?{id:n.id,...n.data()}:(console.warn(`No se encontró la rutina con ID: ${t}`),null)}catch(e){throw console.error(`Error al obtener la rutina con ID ${t}:`,e),e}},getRutinaLocal(t){return this.profile.routines.find(e=>e.id===t)},async deleteRutina(t){try{this.profile.routines=this.profile.routines.filter(e=>e.id!==t),await MP(Ss(qr,"routines",t))}catch(e){throw console.error("Error al eliminar la rutina:",e),e}},async updateRutina(t){if(!t.id)throw new Error("Rutina sin ID");const e=Ss(qr,"routines",t.id),{id:n,...r}=t;try{console.log("Antes del horror:",t),await em(e,r);const s=this.profile.routines.findIndex(i=>i.id===t.id);s!==-1&&this.profile.routines.splice(s,1,t)}catch(s){throw console.error("Error al actualizar la rutina:",s),s}},async createRutinaFirebase(t){const e={...t,fechaCreacion:new Date().toISOString(),idUser:this.profile.id};try{const n=await LP(Kp(qr,"routines"),e),r={id:n.id,...e};return this.profile.routines.unshift(r),n}catch(n){throw console.error("Error al crear la rutina en Firebase:",n),n}}},getters:{getNickname:t=>t.profile.nickname,getUserRoutines:t=>t.profile.routines}}),jl=g_("user",{state:()=>({user:null}),actions:{initAuthListener(){Jv(Di,async t=>{const e=ii();t?(this.user={email:t.email,id:t.uid},await e.loadProfile(t.uid,t.email),console.log("Sesión iniciada. Perfil")):(this.user=null,e.$reset())})},async register(t,e){try{return await MC(Di,t,e),{ok:!0,message:"Registration successful!"}}catch(n){return console.error("Error en registro:",n.message),{ok:!1,message:this.translateFirebaseError(n.code)}}},async login(t,e){try{return await LC(Di,t,e),{ok:!0,message:"Login successful!"}}catch(n){return console.error("Error en login:",n.message),{ok:!1,message:this.translateFirebaseError(n.code)}}},translateFirebaseError(t){return t?(console.log(t),{"auth/email-already-in-use":"El email ya esta en uso.","auth/invalid-credential":"Credenciales inválidas.","auth/user-not-found":"No existe una cuenta con ese correo.","auth/wrong-password":"Contraseña incorrecta.","auth/too-many-requests":"Demasiados intentos fallidos.","auth/network-request-failed":"Problema de conexión.","auth/invalid-email":"El formato del email no es válido."}[t]||"Error de autenticación. Intentá nuevamente."):"Error desconocido."},async logout(){try{await $C(Di),this.user=null}catch(t){console.error("Error en logout:",t.message)}},generateDefaultUsername(t){if(!t||typeof t!="string")return"";const e=t.indexOf("@");return e!==-1?t.substring(0,e):t}}}),ek={__name:"NotifierComponent",props:{message:String,type:String},setup(t){const e=t,n=dt(()=>e.type==="success"?"bg-success":"bg-danger");return(r,s)=>(le(),vo(jn,{name:"fade-slide",mode:"out-in",onAfterLeave:s[0]||(s[0]=i=>r.$emit("after-leave"))},{default:We(()=>[je(P("div",{class:Vt(["notifier p-3 rounded text-light",n.value])},Xe(t.message),3),[[Nn,t.message]])]),_:1}))}},cE=Or(ek,[["__scopeId","data-v-c66f5abe"]]),tk={class:"w-100 mb-auto mt-5 mx-auto mt-md-auto d-flex justify-content-center align-items-center"},nk={class:"d-flex justify-content-between"},rk={class:"mb-3 text-start"},sk={class:"mb-3 text-start"},ik={class:"text-start mt-3 text-light"},ok={__name:"LoginPage",setup(t){const e=Be(""),n=Be(""),r=Be(!1),s=Be(!1),i=Be({message:"",type:""}),o=jl(),l=async()=>{i.value={message:"",type:""},s.value=!1;try{const u=await o.login(e.value,n.value);u.ok?(i.value={message:"¡Inicio de sesión exitoso!",type:"success"},s.value=!0,setTimeout(()=>{s.value=!1,o.$router.push("/dashboard")},2e3)):(i.value={message:u.message,type:"error"},s.value=!0,setTimeout(()=>{s.value=!1},2e3))}catch(u){console.error("Unexpected error:",u),i.value={message:"Error inesperado. Intentá de nuevo.",type:"error"},s.value=!0}},c=()=>{i.value={message:"",type:""}};return Kn(()=>{r.value=!0}),(u,f)=>{const p=Js("router-link");return le(),me("main",tk,[ve(jn,{name:"fade-slide-login",mode:"out-in"},{default:We(()=>[je(P("form",{class:"form-login p-4 rounded shadow",onSubmit:$t(l,["prevent"])},[P("div",nk,[f[3]||(f[3]=P("h2",{class:"text-center ms-3 mb-4 fw-bold text-light"},[Fe("Login "),P("i",{class:"bi bi-person-check"})],-1)),ve(p,{class:"text-decoration-none",to:"/"},{default:We(()=>f[2]||(f[2]=[P("button",{type:"button",class:"btn-exit btn btn-outline-light"},[P("i",{class:"bi bi-x"})],-1)])),_:1})]),P("div",rk,[f[4]||(f[4]=P("label",{for:"inputEmail",class:"form-label text-light"},"Email",-1)),je(P("input",{required:"","onUpdate:modelValue":f[0]||(f[0]=m=>e.value=m),type:"email",class:"form-control text-light",id:"inputEmail",placeholder:"Ej: leomessi@gmail.com"},null,512),[[jt,e.value]])]),P("div",sk,[f[5]||(f[5]=P("label",{for:"inputPassword",class:"form-label text-light"},"Contraseña",-1)),je(P("input",{required:"","onUpdate:modelValue":f[1]||(f[1]=m=>n.value=m),type:"password",class:"form-control text-light",id:"inputPassword",placeholder:"*********"},null,512),[[jt,n.value]])]),f[8]||(f[8]=P("button",{class:"btn-login btn w-100 py-2 text-light",type:"submit"},[Fe("Iniciar Sesion "),P("i",{class:"bi bi-send-fill"})],-1)),je(ve(cE,{message:i.value.message,type:i.value.type,onAfterLeave:c},null,8,["message","type"]),[[Nn,s.value]]),P("p",ik,[f[7]||(f[7]=Fe(" ¿Todavia no tenes una cuenta? ")),ve(p,{to:"/register"},{default:We(()=>f[6]||(f[6]=[Fe("Registrate")])),_:1})])],544),[[Nn,r.value]])]),_:1})])}}},ak={class:"w-100 mb-auto mt-5 mx-auto mt-md-auto d-flex justify-content-center align-items-center"},lk={class:"d-flex justify-content-between"},ck={class:"mb-3 text-start"},uk={class:"mb-3 text-start"},hk={class:"mb-3 text-start"},fk={class:"text-start mt-3 text-light"},dk={__name:"RegisterPage",setup(t){const e=Be(""),n=Be(""),r=Be(""),s=Be(!1),i=Be(!1),o=Be({message:"",type:""}),l=jl(),c=async()=>{if(o.value={message:"",type:""},i.value=!1,n.value!==r.value){r.value="",o.value={message:"Las contraseñas no coinciden.",type:"error"},i.value=!0;return}try{const f=await l.register(e.value,n.value);f.ok?(o.value={message:f.message,type:"success"},setTimeout(()=>{i.value=!1,l.$router.push("/dashboard")},2e3)):(o.value={message:f.message,type:"error"},setTimeout(()=>{i.value=!1},2e3))}catch(f){console.error("Unexpected error:",f),o.value={message:"Error inesperado. Intentá de nuevo.",type:"error"}}i.value=!0},u=()=>{o.value={message:"",type:""}};return Kn(()=>{s.value=!0}),(f,p)=>{const m=Js("router-link");return le(),me("main",ak,[ve(jn,{name:"fade-slide-register",mode:"out-in"},{default:We(()=>[je(P("form",{class:"form-register p-4 rounded shadow",onSubmit:$t(c,["prevent"])},[P("div",lk,[p[4]||(p[4]=P("h2",{class:"text-center ms-3 mb-4 fw-bold text-light"},[Fe("Registro "),P("i",{class:"bi bi-person-add"})],-1)),ve(m,{class:"text-decoration-none",to:"/"},{default:We(()=>p[3]||(p[3]=[P("button",{type:"button",class:"btn-exit btn btn-outline-light"},[P("i",{class:"bi bi-x"})],-1)])),_:1})]),P("div",ck,[p[5]||(p[5]=P("label",{for:"inputEmail",class:"form-label text-light"},"Email",-1)),je(P("input",{required:"","onUpdate:modelValue":p[0]||(p[0]=_=>e.value=_),type:"email",class:"form-control text-light",id:"inputEmail",placeholder:"Ej: leomessi@gmail.com"},null,512),[[jt,e.value]])]),P("div",uk,[p[6]||(p[6]=P("label",{for:"inputPassword",class:"form-label text-light"},"Contraseña",-1)),je(P("input",{required:"","onUpdate:modelValue":p[1]||(p[1]=_=>n.value=_),type:"password",class:"form-control text-light",id:"inputPassword",placeholder:"**********"},null,512),[[jt,n.value]])]),P("div",hk,[p[7]||(p[7]=P("label",{for:"confirmPassword",class:"form-label text-light"},"Confirmar contraseña",-1)),je(P("input",{required:"","onUpdate:modelValue":p[2]||(p[2]=_=>r.value=_),type:"password",class:"form-control text-light",id:"confirmPassword",placeholder:"**********"},null,512),[[jt,r.value]])]),p[10]||(p[10]=P("button",{class:"btn-register btn w-100 py-2 text-light",type:"submit"},[Fe(" Registrarse "),P("i",{class:"bi bi-send-fill"})],-1)),je(ve(cE,{message:o.value.message,type:o.value.type,onAfterLeave:u},null,8,["message","type"]),[[Nn,i.value]]),P("p",fk,[p[9]||(p[9]=Fe(" ¿Ya tenes tu cuenta? ")),ve(m,{to:"/login",class:"login"},{default:We(()=>p[8]||(p[8]=[Fe("Inicia sesion")])),_:1})])],544),[[Nn,s.value]])]),_:1})])}}},pk={class:"d-flex"},mk={class:"d-flex flex-column align-items-center"},gk={class:"username-container text-center font-weight-medium"},_k=["title"],yk={class:"h5"},vk={class:"nav text-center nav-pills flex-column mb-auto"},Ek={class:"nav-item"},Tk={class:"nav-item"},wk={class:"nav-item d-flex justify-content-center"},Ik={key:0,class:"heather p-2 w-100 nav-mobile"},bk={__name:"SideBarComponent",setup(t){const e=Be(!1),n=Be(window.innerWidth<768),r=ii(),s=jl(),i=Qu(),{profile:o}=__(r),l=async()=>{await s.logout(),i.push({name:"Unregistred"})},c=()=>{e.value=!e.value},u=()=>{n.value=window.innerWidth<768,n.value||(e.value=!1)},f=p=>{if(!n.value)return;const m=document.querySelector(".sidebar-profile");e.value&&m&&!m.contains(p.target)&&(e.value=!1)};return Kn(()=>{window.addEventListener("resize",u),document.addEventListener("click",f)}),qu(()=>{window.removeEventListener("resize",u),document.removeEventListener("click",f)}),(p,m)=>{const _=Js("router-link");return le(),me("div",pk,[ve(jn,{name:"slide-fade"},{default:We(()=>[!n.value||e.value?(le(),me("div",{key:0,class:Vt(["sidebar-profile flex-column flex-shrink-0 px-1 text-bg-dark",{"mobile-mode":n.value}])},[P("div",mk,[n.value?Jt("",!0):(le(),vo(_,{key:0,to:{name:"Dashboard"},class:"h3 mb-1 text-light"},{default:We(()=>m[0]||(m[0]=[P("i",{class:"bi bi-house"},null,-1)])),_:1})),P("div",gk,[P("p",{class:"ellipsis my-0",title:Zt(o).nickname},[P("span",yk," #"+Xe(Zt(o).nickname||"Usuario"),1)],8,_k)])]),m[6]||(m[6]=P("hr",null,null,-1)),P("ul",vk,[P("li",Ek,[ve(_,{to:{name:"MyWorkouts"},class:"nav-link d-flex flex-column justify-content-center align-items-center px-1 text-decoration-none"},{default:We(()=>m[1]||(m[1]=[P("i",{class:"bi bi-clipboard-check"},null,-1),Fe(" Mis Rutinas ")])),_:1})]),m[4]||(m[4]=P("hr",null,null,-1)),P("li",Tk,[ve(_,{to:{name:"MyProfile"},class:"nav-link d-flex flex-column justify-content-center align-items-center px-1 text-decoration-none"},{default:We(()=>m[2]||(m[2]=[P("i",{class:"bi bi-person-circle"},null,-1),Fe(" Mi Perfil ")])),_:1})]),m[5]||(m[5]=P("hr",null,null,-1)),P("li",wk,[P("button",{class:"nav-link d-flex flex-column justify-content-center align-items-center text-light px-1",onClick:$t(l,["prevent"])},m[3]||(m[3]=[P("i",{class:"bi bi-box-arrow-right"},null,-1),Fe(" Cerrar Sesion ")]))])])],2)):Jt("",!0)]),_:1}),ve(jn,{name:"fade"},{default:We(()=>[n.value&&e.value?(le(),me("div",{key:0,class:"darkSide",onClick:c})):Jt("",!0)]),_:1}),n.value?(le(),me("header",Ik,[ve(_,{to:{name:"Dashboard"},class:"h2 mb-0 d-flex gap-2"},{default:We(()=>m[7]||(m[7]=[P("i",{class:"bi bi-house"},null,-1)])),_:1}),P("button",{class:"btn btn-outline-info",onClick:$t(c,["stop"])},m[8]||(m[8]=[P("i",{class:"bi bi-list"},null,-1)]))])):Jt("",!0)])}}},Ak=Or(bk,[["__scopeId","data-v-68d267cb"]]),Rk={class:"w-100"},Sk={__name:"DashboardPage",setup(t){const e=ii(),{profile:n}=__(e);return Kn(()=>{console.log(n),n&&console.log("Onmounted: profile",n)}),(r,s)=>{const i=Js("router-view");return le(),me("div",Rk,[ve(Ak),ve(i,null,{default:We(({Component:o})=>[ve(jn,{name:"route-fade",mode:"out-in",class:"w-100 h-100 d-flex justify-content-center align-items-center"},{default:We(()=>[(le(),vo(nw(o)))]),_:2},1024)]),_:1})])}}},Pk=Or(Sk,[["__scopeId","data-v-6233ec35"]]),Ck={class:"vh-100 w-100 d-flex align-items-center justify-content-center title-container"},kk={class:"split-text-container mb-md-5"},Ok={class:"mobile-title d-md-none d-flex flex-column text-center"},xk={class:"mobile-part from-left"},Dk={class:"mobile-part from-right"},Vk={class:"mobile-part from-left"},Nk={class:"auth-links"},Mk={__name:"UnregistredPage",setup(t){const e="MY".split(""),n="WORKOUT".split(""),r="APP".split("");return(s,i)=>{const o=Js("router-link");return le(),me("div",Ck,[P("div",kk,[i[0]||(i[0]=P("span",{class:"text-part left desktop-title"},"MY",-1)),i[1]||(i[1]=P("span",{class:"text-part right desktop-title"},"Workout",-1)),i[2]||(i[2]=P("span",{class:"text-part right desktop-title"},"App",-1)),P("div",Ok,[P("div",xk,[(le(!0),me(nt,null,gr(Zt(e),(l,c)=>(le(),me("span",{key:"my"+c},Xe(l),1))),128))]),P("div",Dk,[(le(!0),me(nt,null,gr(Zt(n),(l,c)=>(le(),me("span",{key:"workout"+c},Xe(l),1))),128))]),P("div",Vk,[(le(!0),me(nt,null,gr(Zt(r),(l,c)=>(le(),me("span",{key:"app"+c},Xe(l),1))),128))])])]),ve(jn,{name:"fade-slide-nav",appear:""},{default:We(()=>[P("nav",Nk,[ve(o,{to:"/login",class:"btn px-4"},{default:We(()=>i[3]||(i[3]=[Fe("Login")])),_:1}),ve(o,{to:"/register",class:"btn px-4"},{default:We(()=>i[4]||(i[4]=[Fe("Register")])),_:1})])]),_:1})])}}},Lk={props:["rutina"]},Fk={class:"px-2 py-1 rounded-xl shadow-md"},Uk={class:"text-start text-sm text-gray-500"},$k={class:"mb-1"},jk={class:"d-flex justify-content-between align-items-baseline"},Bk={class:"h5 text-lg text-start font-semibold mb-2"},qk={class:"h5 text-sm text-end text-gray-400 mb-2"},Hk={class:"space-y-2 list-unstyled"},zk={class:"font-medium mb-4"},Wk={class:"text-sm mt-2 d-flex justify-content-center gap-5 align-items-baseline"},Kk={class:"d-flex flex-column"},Gk={class:"d-flex flex-column"},Qk={key:0},Yk={key:1},Jk={class:"d-flex flex-column"},Xk={key:0},Zk={key:1},eO={key:0,class:"mb-0"};function tO(t,e,n,r,s,i){return le(),me("div",Fk,[P("div",Uk,[P("p",$k," Descanso entre bloques: "+Xe(n.rutina.descansoBloques)+"s ",1),P("p",null," Descanso entre series: "+Xe(n.rutina.descansoSeries)+"s ",1)]),e[7]||(e[7]=P("hr",null,null,-1)),(le(!0),me(nt,null,gr(n.rutina.bloques,(o,l)=>(le(),me("div",{key:l,class:"my-3"},[P("div",jk,[P("p",Bk,Xe(l+1)+"° Bloque ",1),P("p",qk,Xe(o.series)+" Series",1)]),P("ul",Hk,[(le(!0),me(nt,null,gr(o.ejercicios,(c,u)=>(le(),me("li",{key:u,class:"p-3 rounded"},[P("div",zk,[P("h4",null,Xe(c.nombre),1)]),P("div",Wk,[P("div",Kk,[e[0]||(e[0]=P("span",null,"Reps",-1)),e[1]||(e[1]=Fe()),P("span",null,Xe(c.repeticiones),1)]),P("div",Gk,[e[2]||(e[2]=P("span",null,"Tiempo",-1)),e[3]||(e[3]=Fe()),c.tiempo!=0?(le(),me("span",Qk,Xe(c.tiempo)+"s",1)):(le(),me("span",Yk,"-"))]),P("div",Jk,[e[4]||(e[4]=P("span",null,"Esfuerzo",-1)),e[5]||(e[5]=Fe()),c.esfuerzo?(le(),me("span",Xk,Xe(c.esfuerzo)+" RIR",1)):(le(),me("span",Zk,"-"))])]),u!=o.ejercicios.length-1?(le(),me("hr",eO)):Jt("",!0)]))),128)),e[6]||(e[6]=P("hr",{class:"mb-0"},null,-1))])]))),128))])}const nO=Or(Lk,[["render",tO]]),rO={class:"my-workouts"},sO={class:"routines-container"},iO={class:"text-center mb-3"},oO={class:"d-flex justify-content-center justify-content-md-start ms-md-5 mb-3"},aO={class:"d-flex align-items-baseline text-start"},lO={key:0,class:"loader"},cO={class:"absolute d-flex justify-content-between top-2 left-0 text-sm text-gray-500"},uO={class:"text-center font-weight-medium my-2"},hO=["title"],fO={class:"d-flex justify-content-between align-items-center text-gray-700"},dO=["title"],pO=["innerHTML"],mO={key:0,class:"difficulty-text"},gO=["innerHTML"],_O={key:0,class:"difficulty-text"},yO=["onClick"],vO={key:0,class:"mini-menu"},EO=["onClick"],TO=["onClick"],wO=["onClick"],IO=["onClick"],bO={key:3,class:"edit-resume-container"},AO=["onClick"],RO=["onClick"],SO=["onClick"],PO=["onClick"],CO={__name:"MyWorkoutsPage",setup(t){const e=ii(),n=Be(!0),r=Be(window.innerWidth<768),s=Be(new Map),i=Be([]);O_();const o=Qu(),l=Be(null),c={"Muy facil":1,Facil:2,Intermedia:3,Dificil:4,"Muy dificil":5},u=Be("fechaCreacionDesc"),f=dt(()=>e.getUserRoutines),p=dt(()=>[...f.value].sort((N,x)=>{if(u.value==="fechaCreacionDesc")return new Date(x.fechaCreacion)-new Date(N.fechaCreacion);if(u.value==="fechaCreacionAsc")return new Date(N.fechaCreacion)-new Date(x.fechaCreacion);{const q=c[N.dificultad]||0,te=c[x.dificultad]||0;return u.value==="asc"?q-te:te-q}}));Jr(l,N=>{N!==null?window.addEventListener("click",m):window.removeEventListener("click",m)}),Kn(async()=>{window.scrollTo({top:0,behavior:"smooth"})}),Jr(()=>e.profile.id,async N=>{if(N){n.value=!0;try{e.getUserRoutines.length===0?await e.getRutinas():n.value=!1}catch(x){console.error("Error al cargar rutinas:",x)}finally{n.value=!1}}},{immediate:!0});const m=N=>{const x=document.querySelector(".dropdown-menu-container");l.value!==null&&!(x!=null&&x.contains(N.target))&&(l.value=null)};function _(N){const x=i.value.indexOf(N);x!==-1?i.value.splice(x,1):(i.value.push(N),yo(()=>{setTimeout(()=>{const q=s.value.get(N);q==null||q.scrollIntoView({behavior:"smooth",block:"start"})},300)}))}async function A(N){if(!confirm("¿Estás seguro de que querés eliminar esta rutina?")){console.log("Eliminar cancelado");return}try{const x=i.value.indexOf(N);x!==-1&&i.value.splice(x,1),await e.deleteRutina(N),n.value=!1}catch(x){console.log("Error al borrar la rutina.",x)}}function O(N){o.push({name:"FormRoutine",query:{id:N.id}})}async function D(N){n.value=!0;const x={...JSON.parse(JSON.stringify(N)),nombre:N.nombre+" (copia)"};delete x.id,delete x.fechaCreacion;try{const q=await e.createRutinaFirebase(x);n.value=!1,_(q.id)}catch(q){console.error("Error copiando rutina:",q),n.value=!1}}const H=N=>(N.bloques||[]).reduce((x,q)=>x+(q.series||1),0),j=N=>"⚡️".repeat(c[N]||0);return(N,x)=>(le(),me("div",rO,[P("div",sO,[x[15]||(x[15]=P("h1",{class:"my-md-5 mb-3"},[Fe("Mis Rutinas "),P("i",{class:"bi bi-clipboard-check"})],-1)),P("div",iO,[ve(Zt(k_),{to:"/dashboard/form-routine",class:"btn btn-outline-danger px-5 d-flex gap-2 justify-content-center align-items-baseline",id:"add-routine"},{default:We(()=>x[2]||(x[2]=[P("i",{class:"bi bi-plus-circle-fill"},null,-1),Fe(" Agregar Rutina ")])),_:1})]),je(P("div",oO,[P("div",aO,[x[4]||(x[4]=P("label",{for:"orderBy",class:"me-2"},"Ordenar por",-1)),je(P("select",{"onUpdate:modelValue":x[0]||(x[0]=q=>u.value=q),id:"orderBy",class:"p-2 m-2 rounded bg-dark text-white"},x[3]||(x[3]=[P("option",{value:"fechaCreacionDesc"},"Más Reciente",-1),P("option",{value:"fechaCreacionAsc"},"Más Antigua",-1),P("option",{value:"asc"},"De más fácil",-1),P("option",{value:"desc"},"De más difícil",-1)]),512),[[Wc,u.value]])])],512),[[Nn,f.value.length>0]]),n.value||f.value.length===0&&n.value?(le(),me("div",lO)):Jt("",!0),je(P("div",null,[ve(mI,{name:"fade-item",tag:"ul",class:Vt(["routine-resumen",{"column-layout":i.value.length>0}])},{default:We(()=>[(le(!0),me(nt,null,gr(p.value,q=>(le(),me("li",{key:q.id,ref_for:!0,ref:te=>s.value.set(q.id,te),class:Vt(["mb-1 routine-card",{expanded:i.value.includes(q.id)}])},[P("div",cO,[P("h6",{class:Vt({h5:i.value.includes(q.id)})},Xe(q.bloques.length)+" Bloques",3),P("h6",{class:Vt({h5:i.value.includes(q.id)})},Xe(H(q))+" Series ",3)]),P("div",uO,[P("h3",{class:"ellipsis",title:q.nombre},Xe(q.nombre),9,hO)]),ve(jn,{name:"expand-fade"},{default:We(()=>[je(ve(nO,{rutina:q},null,8,["rutina"]),[[Nn,i.value.includes(q.id)]])]),_:2},1024),P("div",fO,[r.value?(le(),me("h6",{key:0,class:Vt(["mb-0 difficulty-container",{"h4 d-flex flex-column":i.value.includes(q.id)}]),title:q.dificultad},[P("span",{class:"difficulty-icons",innerHTML:j(q.dificultad)},null,8,pO),r.value||i.value.includes(q.id)?(le(),me("span",mO," ("+Xe(q.dificultad)+") ",1)):Jt("",!0)],10,dO)):(le(),me("h6",{key:1,class:Vt({h4:i.value.includes(q.id)})},[P("span",{class:"difficulty-icons",innerHTML:j(q.dificultad)},null,8,gO),r.value||i.value.includes(q.id)?(le(),me("span",_O," ("+Xe(q.dificultad)+") ",1)):Jt("",!0)],2)),r.value&&!i.value.includes(q.id)?(le(),me("div",{key:2,class:"dropdown-menu-container",onClick:x[1]||(x[1]=$t(()=>{},["stop"]))},[P("span",{onClick:$t(te=>l.value=l.value===q.id?null:q.id,["stop"])},x[5]||(x[5]=[P("i",{class:"bi bi-three-dots-vertical"},null,-1)]),8,yO),ve(jn,{name:"fade-item"},{default:We(()=>[l.value===q.id?(le(),me("ul",vO,[P("li",{onClick:te=>_(q.id)},x[6]||(x[6]=[P("i",{class:"bi bi-arrows-angle-expand"},null,-1)]),8,EO),P("li",{onClick:$t(te=>O(q),["stop"])},x[7]||(x[7]=[P("i",{class:"bi bi-pencil-square"},null,-1)]),8,TO),P("li",{onClick:$t(te=>A(q.id),["stop"])},x[8]||(x[8]=[P("i",{class:"bi bi-trash3"},null,-1)]),8,wO),P("li",{onClick:$t(te=>D(q),["stop"])},x[9]||(x[9]=[P("i",{class:"bi bi-copy"},null,-1)]),8,IO)])):Jt("",!0)]),_:2},1024)])):(le(),me("div",bO,[P("span",{onClick:te=>_(q.id)},x[10]||(x[10]=[P("i",{class:"bi bi-arrows-angle-expand"},null,-1)]),8,AO),P("span",{onClick:$t(te=>O(q),["stop"])},x[11]||(x[11]=[P("i",{class:"bi bi-pencil-square"},null,-1)]),8,RO),P("span",{onClick:$t(te=>A(q.id),["stop"])},x[12]||(x[12]=[P("i",{class:"bi bi-trash3"},null,-1)]),8,SO),P("span",{onClick:$t(te=>D(q),["stop"])},x[13]||(x[13]=[P("i",{class:"bi bi-copy"},null,-1)]),8,PO)]))])],2))),128))]),_:1},8,["class"])],512),[[Nn,p.value.length>0]]),je(P("div",null,x[14]||(x[14]=[P("h5",null,"No hay rutinas guardadas aún.",-1)]),512),[[Nn,p.value.length===0&&!n.value]])])]))}},kO=Or(CO,[["__scopeId","data-v-f973fdbf"]]),OO={class:"contenedor"},xO={class:"info-container"},DO={class:"w-100 mb-4 justify-content-center d-flex align-items-end gap-3"},VO={class:"text-start w-100"},NO={class:"w-100"},MO={class:"text-start"},LO=["value"],FO={__name:"ProfilePage",setup(t){const e=ii(),n=dt(()=>e.profile),r=Be("");Kn(async()=>{r.value=n.value.nickname});const s=async()=>{try{e.setNickname(r.value),alert("Nombre de usuario actualizado correctamente")}catch(i){console.error("Error al actualizar nickname:",i),alert("Ocurrió un error al guardar.")}};return(i,o)=>(le(),me("div",OO,[o[3]||(o[3]=P("h1",{class:"my-md-5"},[Fe("Mi Perfil "),P("i",{class:"bi bi-person-circle"})],-1)),P("div",xO,[P("div",DO,[P("div",VO,[o[1]||(o[1]=P("label",{for:"username",class:"form-label"},"Nombre de Usuario",-1)),je(P("input",{type:"text","onUpdate:modelValue":o[0]||(o[0]=l=>r.value=l),spellcheck:"false",autocomplete:"off",id:"username",class:"form-control"},null,512),[[jt,r.value]])]),P("div",null,[P("button",{class:Vt(["btn btn-outline-success btn-guardar",r.value===n.value.nickname?"disabled":""]),onClick:s},"Guardar",2)])]),P("div",NO,[P("div",MO,[o[2]||(o[2]=P("label",{for:"email",class:"form-label"},"Email",-1)),P("input",{type:"text",value:n.value.email,id:"email",class:"form-control",readonly:"",disabled:""},null,8,LO)])])])]))}},UO=Or(FO,[["__scopeId","data-v-dd43bd1b"]]);var uE=typeof global=="object"&&global&&global.Object===Object&&global,$O=typeof self=="object"&&self&&self.Object===Object&&self,Rn=uE||$O||Function("return this")(),Gs=Rn.Symbol,hE=Object.prototype,jO=hE.hasOwnProperty,BO=hE.toString,Ai=Gs?Gs.toStringTag:void 0;function qO(t){var e=jO.call(t,Ai),n=t[Ai];try{t[Ai]=void 0;var r=!0}catch{}var s=BO.call(t);return r&&(e?t[Ai]=n:delete t[Ai]),s}var HO=Object.prototype,zO=HO.toString;function WO(t){return zO.call(t)}var KO="[object Null]",GO="[object Undefined]",Em=Gs?Gs.toStringTag:void 0;function xo(t){return t==null?t===void 0?GO:KO:Em&&Em in Object(t)?qO(t):WO(t)}function Do(t){return t!=null&&typeof t=="object"}var qh=Array.isArray;function Bl(t){var e=typeof t;return t!=null&&(e=="object"||e=="function")}var QO="[object AsyncFunction]",YO="[object Function]",JO="[object GeneratorFunction]",XO="[object Proxy]";function fE(t){if(!Bl(t))return!1;var e=xo(t);return e==YO||e==JO||e==QO||e==XO}var xc=Rn["__core-js_shared__"],Tm=function(){var t=/[^.]+$/.exec(xc&&xc.keys&&xc.keys.IE_PROTO||"");return t?"Symbol(src)_1."+t:""}();function ZO(t){return!!Tm&&Tm in t}var ex=Function.prototype,tx=ex.toString;function ds(t){if(t!=null){try{return tx.call(t)}catch{}try{return t+""}catch{}}return""}var nx=/[\\^$.*+?()[\]{}|]/g,rx=/^\[object .+?Constructor\]$/,sx=Function.prototype,ix=Object.prototype,ox=sx.toString,ax=ix.hasOwnProperty,lx=RegExp("^"+ox.call(ax).replace(nx,"\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g,"$1.*?")+"$");function cx(t){if(!Bl(t)||ZO(t))return!1;var e=fE(t)?lx:rx;return e.test(ds(t))}function ux(t,e){return t==null?void 0:t[e]}function ps(t,e){var n=ux(t,e);return cx(n)?n:void 0}var Au=ps(Rn,"WeakMap"),wm=Object.create,hx=function(){function t(){}return function(e){if(!Bl(e))return{};if(wm)return wm(e);t.prototype=e;var n=new t;return t.prototype=void 0,n}}(),Im=function(){try{var t=ps(Object,"defineProperty");return t({},"",{}),t}catch{}}();function fx(t,e){for(var n=-1,r=t==null?0:t.length;++n<r&&e(t[n],n,t)!==!1;);return t}var dx=9007199254740991,px=/^(?:0|[1-9]\d*)$/;function mx(t,e){var n=typeof t;return e=e??dx,!!e&&(n=="number"||n!="symbol"&&px.test(t))&&t>-1&&t%1==0&&t<e}function gx(t,e,n){e=="__proto__"&&Im?Im(t,e,{configurable:!0,enumerable:!0,value:n,writable:!0}):t[e]=n}function dE(t,e){return t===e||t!==t&&e!==e}var _x=Object.prototype,yx=_x.hasOwnProperty;function vx(t,e,n){var r=t[e];(!(yx.call(t,e)&&dE(r,n))||n===void 0&&!(e in t))&&gx(t,e,n)}var Ex=9007199254740991;function pE(t){return typeof t=="number"&&t>-1&&t%1==0&&t<=Ex}function Tx(t){return t!=null&&pE(t.length)&&!fE(t)}var wx=Object.prototype;function mE(t){var e=t&&t.constructor,n=typeof e=="function"&&e.prototype||wx;return t===n}function Ix(t,e){for(var n=-1,r=Array(t);++n<t;)r[n]=e(n);return r}var bx="[object Arguments]";function bm(t){return Do(t)&&xo(t)==bx}var gE=Object.prototype,Ax=gE.hasOwnProperty,Rx=gE.propertyIsEnumerable,Sx=bm(function(){return arguments}())?bm:function(t){return Do(t)&&Ax.call(t,"callee")&&!Rx.call(t,"callee")};function Px(){return!1}var _E=typeof Ht=="object"&&Ht&&!Ht.nodeType&&Ht,Am=_E&&typeof zt=="object"&&zt&&!zt.nodeType&&zt,Cx=Am&&Am.exports===_E,Rm=Cx?Rn.Buffer:void 0,kx=Rm?Rm.isBuffer:void 0,yE=kx||Px,Ox="[object Arguments]",xx="[object Array]",Dx="[object Boolean]",Vx="[object Date]",Nx="[object Error]",Mx="[object Function]",Lx="[object Map]",Fx="[object Number]",Ux="[object Object]",$x="[object RegExp]",jx="[object Set]",Bx="[object String]",qx="[object WeakMap]",Hx="[object ArrayBuffer]",zx="[object DataView]",Wx="[object Float32Array]",Kx="[object Float64Array]",Gx="[object Int8Array]",Qx="[object Int16Array]",Yx="[object Int32Array]",Jx="[object Uint8Array]",Xx="[object Uint8ClampedArray]",Zx="[object Uint16Array]",eD="[object Uint32Array]",$e={};$e[Wx]=$e[Kx]=$e[Gx]=$e[Qx]=$e[Yx]=$e[Jx]=$e[Xx]=$e[Zx]=$e[eD]=!0;$e[Ox]=$e[xx]=$e[Hx]=$e[Dx]=$e[zx]=$e[Vx]=$e[Nx]=$e[Mx]=$e[Lx]=$e[Fx]=$e[Ux]=$e[$x]=$e[jx]=$e[Bx]=$e[qx]=!1;function tD(t){return Do(t)&&pE(t.length)&&!!$e[xo(t)]}function Hh(t){return function(e){return t(e)}}var vE=typeof Ht=="object"&&Ht&&!Ht.nodeType&&Ht,Gi=vE&&typeof zt=="object"&&zt&&!zt.nodeType&&zt,nD=Gi&&Gi.exports===vE,Dc=nD&&uE.process,Qs=function(){try{var t=Gi&&Gi.require&&Gi.require("util").types;return t||Dc&&Dc.binding&&Dc.binding("util")}catch{}}(),Sm=Qs&&Qs.isTypedArray,rD=Sm?Hh(Sm):tD,sD=Object.prototype,iD=sD.hasOwnProperty;function oD(t,e){var n=qh(t),r=!n&&Sx(t),s=!n&&!r&&yE(t),i=!n&&!r&&!s&&rD(t),o=n||r||s||i,l=o?Ix(t.length,String):[],c=l.length;for(var u in t)iD.call(t,u)&&!(o&&(u=="length"||s&&(u=="offset"||u=="parent")||i&&(u=="buffer"||u=="byteLength"||u=="byteOffset")||mx(u,c)))&&l.push(u);return l}function EE(t,e){return function(n){return t(e(n))}}var aD=EE(Object.keys,Object),lD=Object.prototype,cD=lD.hasOwnProperty;function uD(t){if(!mE(t))return aD(t);var e=[];for(var n in Object(t))cD.call(t,n)&&n!="constructor"&&e.push(n);return e}function hD(t){return Tx(t)?oD(t):uD(t)}var po=ps(Object,"create");function fD(){this.__data__=po?po(null):{},this.size=0}function dD(t){var e=this.has(t)&&delete this.__data__[t];return this.size-=e?1:0,e}var pD="__lodash_hash_undefined__",mD=Object.prototype,gD=mD.hasOwnProperty;function _D(t){var e=this.__data__;if(po){var n=e[t];return n===pD?void 0:n}return gD.call(e,t)?e[t]:void 0}var yD=Object.prototype,vD=yD.hasOwnProperty;function ED(t){var e=this.__data__;return po?e[t]!==void 0:vD.call(e,t)}var TD="__lodash_hash_undefined__";function wD(t,e){var n=this.__data__;return this.size+=this.has(t)?0:1,n[t]=po&&e===void 0?TD:e,this}function os(t){var e=-1,n=t==null?0:t.length;for(this.clear();++e<n;){var r=t[e];this.set(r[0],r[1])}}os.prototype.clear=fD;os.prototype.delete=dD;os.prototype.get=_D;os.prototype.has=ED;os.prototype.set=wD;function ID(){this.__data__=[],this.size=0}function ql(t,e){for(var n=t.length;n--;)if(dE(t[n][0],e))return n;return-1}var bD=Array.prototype,AD=bD.splice;function RD(t){var e=this.__data__,n=ql(e,t);if(n<0)return!1;var r=e.length-1;return n==r?e.pop():AD.call(e,n,1),--this.size,!0}function SD(t){var e=this.__data__,n=ql(e,t);return n<0?void 0:e[n][1]}function PD(t){return ql(this.__data__,t)>-1}function CD(t,e){var n=this.__data__,r=ql(n,t);return r<0?(++this.size,n.push([t,e])):n[r][1]=e,this}function Qn(t){var e=-1,n=t==null?0:t.length;for(this.clear();++e<n;){var r=t[e];this.set(r[0],r[1])}}Qn.prototype.clear=ID;Qn.prototype.delete=RD;Qn.prototype.get=SD;Qn.prototype.has=PD;Qn.prototype.set=CD;var mo=ps(Rn,"Map");function kD(){this.size=0,this.__data__={hash:new os,map:new(mo||Qn),string:new os}}function OD(t){var e=typeof t;return e=="string"||e=="number"||e=="symbol"||e=="boolean"?t!=="__proto__":t===null}function Hl(t,e){var n=t.__data__;return OD(e)?n[typeof e=="string"?"string":"hash"]:n.map}function xD(t){var e=Hl(this,t).delete(t);return this.size-=e?1:0,e}function DD(t){return Hl(this,t).get(t)}function VD(t){return Hl(this,t).has(t)}function ND(t,e){var n=Hl(this,t),r=n.size;return n.set(t,e),this.size+=n.size==r?0:1,this}function oi(t){var e=-1,n=t==null?0:t.length;for(this.clear();++e<n;){var r=t[e];this.set(r[0],r[1])}}oi.prototype.clear=kD;oi.prototype.delete=xD;oi.prototype.get=DD;oi.prototype.has=VD;oi.prototype.set=ND;function MD(t,e){for(var n=-1,r=e.length,s=t.length;++n<r;)t[s+n]=e[n];return t}var LD=EE(Object.getPrototypeOf,Object);function FD(){this.__data__=new Qn,this.size=0}function UD(t){var e=this.__data__,n=e.delete(t);return this.size=e.size,n}function $D(t){return this.__data__.get(t)}function jD(t){return this.__data__.has(t)}var BD=200;function qD(t,e){var n=this.__data__;if(n instanceof Qn){var r=n.__data__;if(!mo||r.length<BD-1)return r.push([t,e]),this.size=++n.size,this;n=this.__data__=new oi(r)}return n.set(t,e),this.size=n.size,this}function ai(t){var e=this.__data__=new Qn(t);this.size=e.size}ai.prototype.clear=FD;ai.prototype.delete=UD;ai.prototype.get=$D;ai.prototype.has=jD;ai.prototype.set=qD;var TE=typeof Ht=="object"&&Ht&&!Ht.nodeType&&Ht,Pm=TE&&typeof zt=="object"&&zt&&!zt.nodeType&&zt,HD=Pm&&Pm.exports===TE,Cm=HD?Rn.Buffer:void 0;Cm&&Cm.allocUnsafe;function zD(t,e){return t.slice()}function WD(t,e){for(var n=-1,r=t==null?0:t.length,s=0,i=[];++n<r;){var o=t[n];e(o,n,t)&&(i[s++]=o)}return i}function KD(){return[]}var GD=Object.prototype,QD=GD.propertyIsEnumerable,km=Object.getOwnPropertySymbols,YD=km?function(t){return t==null?[]:(t=Object(t),WD(km(t),function(e){return QD.call(t,e)}))}:KD;function JD(t,e,n){var r=e(t);return qh(t)?r:MD(r,n(t))}function XD(t){return JD(t,hD,YD)}var Ru=ps(Rn,"DataView"),Su=ps(Rn,"Promise"),Pu=ps(Rn,"Set"),Om="[object Map]",ZD="[object Object]",xm="[object Promise]",Dm="[object Set]",Vm="[object WeakMap]",Nm="[object DataView]",eV=ds(Ru),tV=ds(mo),nV=ds(Su),rV=ds(Pu),sV=ds(Au),xn=xo;(Ru&&xn(new Ru(new ArrayBuffer(1)))!=Nm||mo&&xn(new mo)!=Om||Su&&xn(Su.resolve())!=xm||Pu&&xn(new Pu)!=Dm||Au&&xn(new Au)!=Vm)&&(xn=function(t){var e=xo(t),n=e==ZD?t.constructor:void 0,r=n?ds(n):"";if(r)switch(r){case eV:return Nm;case tV:return Om;case nV:return xm;case rV:return Dm;case sV:return Vm}return e});var iV=Object.prototype,oV=iV.hasOwnProperty;function aV(t){var e=t.length,n=new t.constructor(e);return e&&typeof t[0]=="string"&&oV.call(t,"index")&&(n.index=t.index,n.input=t.input),n}var Mm=Rn.Uint8Array;function zh(t){var e=new t.constructor(t.byteLength);return new Mm(e).set(new Mm(t)),e}function lV(t,e){var n=zh(t.buffer);return new t.constructor(n,t.byteOffset,t.byteLength)}var cV=/\w*$/;function uV(t){var e=new t.constructor(t.source,cV.exec(t));return e.lastIndex=t.lastIndex,e}var Lm=Gs?Gs.prototype:void 0,Fm=Lm?Lm.valueOf:void 0;function hV(t){return Fm?Object(Fm.call(t)):{}}function fV(t,e){var n=zh(t.buffer);return new t.constructor(n,t.byteOffset,t.length)}var dV="[object Boolean]",pV="[object Date]",mV="[object Map]",gV="[object Number]",_V="[object RegExp]",yV="[object Set]",vV="[object String]",EV="[object Symbol]",TV="[object ArrayBuffer]",wV="[object DataView]",IV="[object Float32Array]",bV="[object Float64Array]",AV="[object Int8Array]",RV="[object Int16Array]",SV="[object Int32Array]",PV="[object Uint8Array]",CV="[object Uint8ClampedArray]",kV="[object Uint16Array]",OV="[object Uint32Array]";function xV(t,e,n){var r=t.constructor;switch(e){case TV:return zh(t);case dV:case pV:return new r(+t);case wV:return lV(t);case IV:case bV:case AV:case RV:case SV:case PV:case CV:case kV:case OV:return fV(t);case mV:return new r;case gV:case vV:return new r(t);case _V:return uV(t);case yV:return new r;case EV:return hV(t)}}function DV(t){return typeof t.constructor=="function"&&!mE(t)?hx(LD(t)):{}}var VV="[object Map]";function NV(t){return Do(t)&&xn(t)==VV}var Um=Qs&&Qs.isMap,MV=Um?Hh(Um):NV,LV="[object Set]";function FV(t){return Do(t)&&xn(t)==LV}var $m=Qs&&Qs.isSet,UV=$m?Hh($m):FV,wE="[object Arguments]",$V="[object Array]",jV="[object Boolean]",BV="[object Date]",qV="[object Error]",IE="[object Function]",HV="[object GeneratorFunction]",zV="[object Map]",WV="[object Number]",bE="[object Object]",KV="[object RegExp]",GV="[object Set]",QV="[object String]",YV="[object Symbol]",JV="[object WeakMap]",XV="[object ArrayBuffer]",ZV="[object DataView]",eN="[object Float32Array]",tN="[object Float64Array]",nN="[object Int8Array]",rN="[object Int16Array]",sN="[object Int32Array]",iN="[object Uint8Array]",oN="[object Uint8ClampedArray]",aN="[object Uint16Array]",lN="[object Uint32Array]",Me={};Me[wE]=Me[$V]=Me[XV]=Me[ZV]=Me[jV]=Me[BV]=Me[eN]=Me[tN]=Me[nN]=Me[rN]=Me[sN]=Me[zV]=Me[WV]=Me[bE]=Me[KV]=Me[GV]=Me[QV]=Me[YV]=Me[iN]=Me[oN]=Me[aN]=Me[lN]=!0;Me[qV]=Me[IE]=Me[JV]=!1;function Ta(t,e,n,r,s,i){var o;if(o!==void 0)return o;if(!Bl(t))return t;var l=qh(t);if(l)o=aV(t);else{var c=xn(t),u=c==IE||c==HV;if(yE(t))return zD(t);if(c==bE||c==wE||u&&!s)o=u?{}:DV(t);else{if(!Me[c])return s?t:{};o=xV(t,c)}}i||(i=new ai);var f=i.get(t);if(f)return f;i.set(t,o),UV(t)?t.forEach(function(_){o.add(Ta(_,e,n,_,t,i))}):MV(t)&&t.forEach(function(_,A){o.set(A,Ta(_,e,n,A,t,i))});var p=XD,m=l?void 0:p(t);return fx(m||t,function(_,A){m&&(A=_,_=t[A]),vx(o,A,Ta(_,e,n,A,t,i))}),o}var cN=1,uN=4;function hN(t){return Ta(t,cN|uN)}const fN={class:"add-routine-form"},dN={class:"text-center mb-4"},pN={class:"mb-3 text-start"},mN={class:"mb-3 flex-column d-flex justify-content-center align-items-start col-md-3"},gN={class:"mb-3 text-start d-flex justify-content-start gap-5 align-items-center"},_N={class:"mb-3 text-start d-flex justify-content-start gap-5 align-items-center"},yN={class:"mb-3 d-flex justify-content-between align-items-baseline"},vN={class:"text-start m-0"},EN={class:"d-flex flex-column align-items-center justify-content-center col-md-2"},TN=["onUpdate:modelValue","id"],wN={class:"row w-100 d-flex flex-column justify-content-center gap-3"},IN={class:"w-100 mb-2"},bN=["onUpdate:modelValue","id"],AN={class:"setting-exercise"},RN={class:"col-md-3 mb-2 text-center"},SN=["onUpdate:modelValue","id"],PN={class:"col-md-3 text-center"},CN=["onUpdate:modelValue","id"],kN={class:"col-md-3 text-center"},ON=["onUpdate:modelValue","id"],xN={class:"d-flex w-100 justify-content-center gap-2"},DN=["onClick"],VN=["onClick"],NN={class:"btns-set-bloque"},MN=["onClick"],LN={key:0,class:"loader-form"},FN={__name:"FormRoutine",props:{rutinaParaEditar:Object},setup(t){const e=ii(),n=O_(),r=Qu(),s=Be(!1),i=Ys({nombre:"",dificultad:"Intermedia",descansoBloques:60,descansoSeries:60,bloques:[{series:3,ejercicios:[{nombre:"",repeticiones:1,tiempo:0,esfuerzo:0}]}]});Kn(async()=>{window.scrollTo({top:0,behavior:"smooth"});const _=n.query.id;if(_)try{const A=e.getRutinaLocal(_);A?Object.assign(i,hN(A)):console.warn(`No se encontró la rutina con ID: ${_}`)}catch(A){console.error("Error al cargar la rutina para editar:",A)}});const o=()=>{r.push({name:"MyWorkouts"})},l=async()=>{s.value=!0;try{i.id?await e.updateRutina({...i}):await e.createRutinaFirebase({...i}),s.value=!1,r.push({name:"MyWorkouts"})}catch(_){console.error("Error al guardar la rutina:",_)}},c=()=>{i.bloques.push({series:3,ejercicios:[{nombre:"",repeticiones:1,tiempo:0,esfuerzo:0}]})},u=_=>{i.bloques.splice(_,1)},f=_=>{i.bloques[_].ejercicios.push({nombre:"",repeticiones:1,tiempo:0,esfuerzo:0})},p=(_,A)=>{i.bloques[_].ejercicios.splice(A,1)},m=_=>_===null||_===""||_===void 0?"input-alert":"";return(_,A)=>(le(),me("div",fN,[P("h2",dN,Xe(i.id?"Editar Rutina":"Agregar Nueva Rutina"),1),P("form",{onSubmit:$t(l,["prevent"]),class:"p-2 p-md-4"},[P("div",pN,[A[4]||(A[4]=P("label",{for:"nombre",class:"form-label"},"Nombre",-1)),je(P("input",{type:"text","onUpdate:modelValue":A[0]||(A[0]=O=>i.nombre=O),spellcheck:"false",autocomplete:"on",class:Vt(["form-control",m(i.nombre)]),id:"nombre",required:""},null,2),[[jt,i.nombre]])]),P("div",mN,[A[6]||(A[6]=P("label",{for:"dificultad",class:"form-label"},"Dificultad",-1)),je(P("select",{"onUpdate:modelValue":A[1]||(A[1]=O=>i.dificultad=O),class:"form-select text-info input-difficulty",id:"dificultad",required:""},A[5]||(A[5]=[Nw('<option value="Muy facil" data-v-698e686d>Muy fácil</option><option value="Facil" data-v-698e686d>Fácil</option><option value="Intermedia" data-v-698e686d>Intermedia</option><option value="Dificil" data-v-698e686d>Difícil</option><option value="Muy dificil" data-v-698e686d>Muy difícil</option>',5)]),512),[[Wc,i.dificultad]])]),P("div",gN,[A[7]||(A[7]=P("label",{for:"descansoBloques",class:"form-label w-50 mb-0"}," Descanso entre Bloques ",-1)),je(P("input",{type:"number","onUpdate:modelValue":A[2]||(A[2]=O=>i.descansoBloques=O),class:"form-control input-number",id:"descansoBloques"},null,512),[[jt,i.descansoBloques]])]),P("div",_N,[A[8]||(A[8]=P("label",{for:"descansoSeries",class:"form-label w-50 mb-0"},"Descanso entre Series",-1)),je(P("input",{type:"number","onUpdate:modelValue":A[3]||(A[3]=O=>i.descansoSeries=O),class:"form-control input-number",id:"descansoSeries"},null,512),[[jt,i.descansoSeries]])]),(le(!0),me(nt,null,gr(i.bloques,(O,D)=>(le(),me("div",{key:D,class:"bloque-container mb-3 px-2 pt-2 pb-3 rounded text-start"},[P("div",yN,[P("h5",vN,Xe(D+1)+"° Bloque",1),P("div",EN,[A[9]||(A[9]=P("label",{for:"series-bloque-{{ index }}",class:"form-label mb-1"},"Series",-1)),je(P("input",{type:"number","onUpdate:modelValue":H=>O.series=H,class:"form-control input-number",id:"series-bloque-"+D,min:"1"},null,8,TN),[[jt,O.series]])])]),(le(!0),me(nt,null,gr(O.ejercicios,(H,j)=>(le(),me("div",{key:j,class:"ejercicio-container p-2 d-flex flex-column align-items-center gap-3"},[P("div",wN,[P("div",IN,[A[10]||(A[10]=P("label",{for:"ejercicio-{{ index }}-{{ ejercicioIndex }}",class:"form-label"},"Ejercicio",-1)),je(P("input",{type:"text","onUpdate:modelValue":N=>H.nombre=N,spellcheck:"false",autocomplete:"on",required:"",class:Vt(["form-control",m(i.nombre)]),id:"ejercicio-"+D+"-"+j},null,10,bN),[[jt,H.nombre]])])]),P("div",AN,[P("div",RN,[A[11]||(A[11]=P("label",{for:"reps-{{ index }}-{{ ejercicioIndex }}",class:"form-label"},"Reps",-1)),je(P("input",{type:"number","onUpdate:modelValue":N=>H.repeticiones=N,class:"form-control input-number",id:"reps-"+D+"-"+j,min:"1"},null,8,SN),[[jt,H.repeticiones]])]),P("div",PN,[A[12]||(A[12]=P("label",{for:"tiempo-{{ index }}-{{ ejercicioIndex }}",class:"form-label"},"Tiempo",-1)),je(P("input",{type:"number","onUpdate:modelValue":N=>H.tiempo=N,class:"form-control input-number",id:"tiempo-"+D+"-"+j,min:"0"},null,8,CN),[[jt,H.tiempo]])]),P("div",kN,[A[14]||(A[14]=P("label",{for:"esfuerzo-{{ index }}-{{ ejercicioIndex }}",class:"form-label"},"Esfuerzo",-1)),je(P("select",{"onUpdate:modelValue":N=>H.esfuerzo=N,class:"form-select text-info input-rir",id:"esfuerzo-"+D+"-"+j},A[13]||(A[13]=[P("option",{select:"",value:""},"-",-1),P("option",{value:"1"},"RIR 1",-1),P("option",{value:"2"},"RIR 2",-1),P("option",{value:"3"},"RIR 3",-1)]),8,ON),[[Wc,H.esfuerzo]])])]),P("div",xN,[P("button",{type:"button",onClick:N=>f(D),class:"btn btn-outline-info"},A[15]||(A[15]=[P("i",{class:"bi bi-plus-circle-fill"},null,-1),Fe(" Ejercicio ")]),8,DN),j>0?(le(),me("button",{key:0,type:"button",onClick:N=>p(D,j),class:"btn btn-outline-danger delete-exercise"},A[16]||(A[16]=[P("i",{class:"bi bi-trash-fill"},null,-1),Fe(" Ejercicio ")]),8,VN)):Jt("",!0)])]))),128)),P("div",NN,[D>0?(le(),me("button",{key:0,type:"button",onClick:H=>u(D),class:"btn btn-outline-danger"},A[17]||(A[17]=[P("i",{class:"bi bi-trash-fill"},null,-1),Fe(" Bloque ")]),8,MN)):Jt("",!0)])]))),128)),P("div",{class:"text-center d-flex flex-column align-items-center"},[P("button",{type:"button",onClick:c,class:"btn btn-outline-info"},A[18]||(A[18]=[P("i",{class:"bi bi-plus-circle-fill"},null,-1),Fe(" Agregar Bloque ")]))]),A[21]||(A[21]=P("hr",null,null,-1)),s.value?(le(),me("div",LN)):Jt("",!0),P("div",{class:"text-center d-flex btns-set-routine flex-column align-items-center"},[A[20]||(A[20]=P("button",{type:"submit",class:"btn btn-success mt-0"},[P("i",{class:"bi bi-box-arrow-down"}),Fe(" Guardar rutina ")],-1)),P("button",{type:"button",onClick:o,class:"btn btn-danger mt-3"},A[19]||(A[19]=[P("i",{class:"bi bi-x-circle"},null,-1),Fe(" Cancelar ")]))])],32)]))}},UN=Or(FN,[["__scopeId","data-v-698e686d"]]),$N=[{path:"/register",name:"Register",component:dk},{path:"/login",name:"Login",component:ok},{path:"/dashboard",name:"Dashboard",component:Pk,children:[{path:"my-workouts",name:"MyWorkouts",component:kO},{path:"my-profile",name:"MyProfile",component:UO},{path:"form-routine",name:"FormRoutine",component:UN},{path:"",redirect:{name:"MyWorkouts"}}],meta:{requiresAuth:!0}},{path:"/unregistred",name:"Unregistred",component:Mk},{path:"/:pathMatch(.*)*",redirect:{name:"Unregistred"}}],Wh=Fb({history:pb("/my-workout-app/"),routes:$N});let Vc=null;function jN(){return new Promise(t=>{Vc!==null?t(Vc):Jv(Di,e=>{Vc=e,t(e)})})}Wh.beforeEach(async(t,e,n)=>{const r=await jN();if(console.log("Middleware routes, to:",t.fullPath),t.path==="/login"&&r)return n("/dashboard");if(t.matched.some(s=>s.meta.requiresAuth)&&!r)return n("/login");n()});const Kh=AI(MI),AE=PI();AE.use(({store:t})=>{t.$router=al(Wh)});Kh.use(AE);Kh.use(Wh);const BN=jl();BN.initAuthListener();Kh.mount("#app")});export default qN();
