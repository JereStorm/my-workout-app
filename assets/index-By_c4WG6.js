var QE=(t,e)=>()=>(e||t((e={exports:{}}).exports,e),e.exports);var HN=QE((Ht,zt)=>{(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))r(s);new MutationObserver(s=>{for(const i of s)if(i.type==="childList")for(const o of i.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&r(o)}).observe(document,{childList:!0,subtree:!0});function n(s){const i={};return s.integrity&&(i.integrity=s.integrity),s.referrerPolicy&&(i.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?i.credentials="include":s.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function r(s){if(s.ep)return;s.ep=!0;const i=n(s);fetch(s.href,i)}})();/**
* @vue/shared v3.5.13
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const G1=5*60,Q1=L_("authIdTokenMaxAge")||G1;let vm=null;const Y1=t=>async e=>{const n=e&&await e.getIdTokenResult(),r=n&&(new Date().getTime()-Date.parse(n.issuedAtTime))/1e3;if(r&&r>Q1)return;const s=n==null?void 0:n.token;vm!==s&&(vm=s,await fetch(t,{method:s?"POST":"DELETE",headers:s?{Authorization:`Bearer ${s}`}:{}}))};function J1(t=B_()){const e=Xu(t,"auth");if(e.isInitialized())return e.getImmediate();const n=EC(t,{popupRedirectResolver:H1,persistence:[t1,qC,tE]}),r=L_("authTokenSyncURL");if(r&&typeof isSecureContext=="boolean"&&isSecureContext){const i=new URL(r,location.origin);if(location.origin===i.origin){const o=Y1(i.toString());UC(n,o,()=>o(n.currentUser)),FC(n,l=>o(l))}}const s=N_("auth");return s&&wC(n,`http://${s}`),n}function X1(){var t,e;return(e=(t=document.getElementsByTagName("head"))===null||t===void 0?void 0:t[0])!==null&&e!==void 0?e:document}fC({loadJS(t){return new Promise((e,n)=>{const r=document.createElement("script");r.setAttribute("src",t),r.onload=e,r.onerror=s=>{const i=wn("internal-error");i.customData=s,n(i)},r.type="text/javascript",r.charset="UTF-8",X1().appendChild(r)})},gapiScript:"https://apis.google.com/js/api.js",recaptchaV2Script:"https://www.google.com/recaptcha/api.js",recaptchaEnterpriseScript:"https://www.google.com/recaptcha/enterprise.js?render="});K1("Browser");const Z1={apiKey:"AIzaSyAH7Qc8QkTR8AWBOxptwHH6IxIXpIx-c00",authDomain:"calisteniarg-f3d40.firebaseapp.com",projectId:"calisteniarg-f3d40",storageBucket:"calisteniarg-f3d40.firebasestorage.app",messagingSenderId:"641759769239",appId:"1:641759769239:web:9e4d3ffdd5dc9645f56fd2"},lE=j_(Z1),qr=_P(lE),Di=J1(lE),ii=g_("profile",{state:()=>({profile:{id:null,email:"",nickname:"",routines:[],charge:!1}}),actions:{async loadProfile(t,e){if(!t)throw new Error("UID de usuario inválido");const n=Ss(qr,"profiles",t);try{const r=await Zp(n);if(r.exists()){const s=r.data();this.profile={id:t,email:s.email,nickname:s.nickname||"",routines:[]}}else await NP(n,{idUser:t,email:e,nickname:""}),this.profile={id:t,email:e,nickname:"",routines:[]}}catch(r){throw console.error("Error al cargar o crear el perfil:",r),r}},async setNickname(t){if(!this.profile.id)throw new Error("Usuario no autenticado");const e=Ss(qr,"profiles",this.profile.id);try{await em(e,{nickname:t}),this.profile.nickname=t}catch(n){throw console.error("Error al actualizar el nickname:",n),n}},async getRutinas(){if(console.log("GetRutinas()"),!this.profile.id)throw new Error("Usuario no autenticado");const t=Kp(qr,"routines"),e=[CP("idUser","==",this.profile.id),kP("fechaCreacion","desc")],n=PP(t,...e);try{const r=await VP(n),s=[];r.forEach(i=>{s.push({id:i.id,...i.data()})}),this.profile.routines=s}catch(r){throw console.error("Error al obtener las rutinas:",r),r}},async getRutina(t){try{const e=Ss(qr,"routines",t),n=await Zp(e);return n.exists()?{id:n.id,...n.data()}:(console.warn(`No se encontró la rutina con ID: ${t}`),null)}catch(e){throw console.error(`Error al obtener la rutina con ID ${t}:`,e),e}},getRutinaLocal(t){return this.profile.routines.find(e=>e.id===t)},async deleteRutina(t){try{this.profile.routines=this.profile.routines.filter(e=>e.id!==t),await MP(Ss(qr,"routines",t))}catch(e){throw console.error("Error al eliminar la rutina:",e),e}},async updateRutina(t){if(!t.id)throw new Error("Rutina sin ID");const e=Ss(qr,"routines",t.id),{id:n,...r}=t;try{console.log("Antes del horror:",t),await em(e,r);const s=this.profile.routines.findIndex(i=>i.id===t.id);s!==-1&&this.profile.routines.splice(s,1,t)}catch(s){throw console.error("Error al actualizar la rutina:",s),s}},async createRutinaFirebase(t){const e={...t,fechaCreacion:new Date().toISOString(),idUser:this.profile.id};try{const n=await LP(Kp(qr,"routines"),e),r={id:n.id,...e};return this.profile.routines.unshift(r),n}catch(n){throw console.error("Error al crear la rutina en Firebase:",n),n}}},getters:{getNickname:t=>t.profile.nickname,getUserRoutines:t=>t.profile.routines}}),jl=g_("user",{state:()=>({user:null}),actions:{initAuthListener(){Jv(Di,async t=>{const e=ii();t?(this.user={email:t.email,id:t.uid},await e.loadProfile(t.uid,t.email),console.log("Sesión iniciada. Perfil")):(this.user=null,e.$reset())})},async register(t,e){try{return await MC(Di,t,e),{ok:!0,message:"Registration successful!"}}catch(n){return console.error("Error en registro:",n.message),{ok:!1,message:this.translateFirebaseError(n.code)}}},async login(t,e){try{return await LC(Di,t,e),{ok:!0,message:"Login successful!"}}catch(n){return console.error("Error en login:",n.message),{ok:!1,message:this.translateFirebaseError(n.code)}}},translateFirebaseError(t){return t?(console.log(t),{"auth/email-already-in-use":"El email ya esta en uso.","auth/invalid-credential":"Credenciales inválidas.","auth/user-not-found":"No existe una cuenta con ese correo.","auth/wrong-password":"Contraseña incorrecta.","auth/too-many-requests":"Demasiados intentos fallidos.","auth/network-request-failed":"Problema de conexión.","auth/invalid-email":"El formato del email no es válido."}[t]||"Error de autenticación. Intentá nuevamente."):"Error desconocido."},async logout(){try{await $C(Di),this.user=null}catch(t){console.error("Error en logout:",t.message)}},generateDefaultUsername(t){if(!t||typeof t!="string")return"";const e=t.indexOf("@");return e!==-1?t.substring(0,e):t}}}),ek={__name:"NotifierComponent",props:{message:String,type:String},setup(t){const e=t,n=dt(()=>e.type==="success"?"bg-success":"bg-danger");return(r,s)=>(le(),vo(jn,{name:"fade-slide",mode:"out-in",onAfterLeave:s[0]||(s[0]=i=>r.$emit("after-leave"))},{default:We(()=>[je(P("div",{class:Vt(["notifier p-3 rounded text-light",n.value])},Xe(t.message),3),[[Nn,t.message]])]),_:1}))}},cE=Gn(ek,[["__scopeId","data-v-c66f5abe"]]),tk={class:"w-100 mb-auto mt-5 mx-auto mt-md-auto d-flex justify-content-center align-items-center"},nk={class:"d-flex justify-content-between"},rk={class:"mb-3 text-start"},sk={class:"mb-3 text-start"},ik={class:"text-start mt-3 text-light"},ok={__name:"LoginPage",setup(t){const e=Be(""),n=Be(""),r=Be(!1),s=Be(!1),i=Be({message:"",type:""}),o=jl(),l=async()=>{i.value={message:"",type:""},s.value=!1;try{const u=await o.login(e.value,n.value);u.ok?(i.value={message:"¡Inicio de sesión exitoso!",type:"success"},s.value=!0,setTimeout(()=>{s.value=!1,o.$router.push("/dashboard")},2e3)):(i.value={message:u.message,type:"error"},s.value=!0,setTimeout(()=>{s.value=!1},2e3))}catch(u){console.error("Unexpected error:",u),i.value={message:"Error inesperado. Intentá de nuevo.",type:"error"},s.value=!0}},c=()=>{i.value={message:"",type:""}};return Kn(()=>{r.value=!0}),(u,f)=>{const p=Js("router-link");return le(),me("main",tk,[ve(jn,{name:"fade-slide-login",mode:"out-in"},{default:We(()=>[je(P("form",{class:"form-login p-4 rounded shadow",onSubmit:$t(l,["prevent"])},[P("div",nk,[f[3]||(f[3]=P("h2",{class:"text-center ms-3 mb-4 fw-bold text-light"},[Fe("Login "),P("i",{class:"bi bi-person-check"})],-1)),ve(p,{class:"text-decoration-none",to:"/"},{default:We(()=>f[2]||(f[2]=[P("button",{type:"button",class:"btn-exit btn btn-outline-light"},[P("i",{class:"bi bi-x"})],-1)])),_:1})]),P("div",rk,[f[4]||(f[4]=P("label",{for:"inputEmail",class:"form-label text-light"},"Email",-1)),je(P("input",{required:"","onUpdate:modelValue":f[0]||(f[0]=m=>e.value=m),type:"email",class:"form-control text-light",id:"inputEmail",placeholder:"Ej: leomessi@gmail.com"},null,512),[[jt,e.value]])]),P("div",sk,[f[5]||(f[5]=P("label",{for:"inputPassword",class:"form-label text-light"},"Contraseña",-1)),je(P("input",{required:"","onUpdate:modelValue":f[1]||(f[1]=m=>n.value=m),type:"password",class:"form-control text-light",id:"inputPassword",placeholder:"*********"},null,512),[[jt,n.value]])]),f[8]||(f[8]=P("button",{class:"btn-login btn w-100 py-2 text-light",type:"submit"},[Fe("Iniciar Sesion "),P("i",{class:"bi bi-send-fill"})],-1)),je(ve(cE,{message:i.value.message,type:i.value.type,onAfterLeave:c},null,8,["message","type"]),[[Nn,s.value]]),P("p",ik,[f[7]||(f[7]=Fe(" ¿Todavia no tenes una cuenta? ")),ve(p,{to:"/register"},{default:We(()=>f[6]||(f[6]=[Fe("Registrate")])),_:1})])],544),[[Nn,r.value]])]),_:1})])}}},ak={class:"w-100 mb-auto mt-5 mx-auto mt-md-auto d-flex justify-content-center align-items-center"},lk={class:"d-flex justify-content-between"},ck={class:"mb-3 text-start"},uk={class:"mb-3 text-start"},hk={class:"mb-3 text-start"},fk={class:"text-start mt-3 text-light"},dk={__name:"RegisterPage",setup(t){const e=Be(""),n=Be(""),r=Be(""),s=Be(!1),i=Be(!1),o=Be({message:"",type:""}),l=jl(),c=async()=>{if(o.value={message:"",type:""},i.value=!1,n.value!==r.value){r.value="",o.value={message:"Las contraseñas no coinciden.",type:"error"},i.value=!0;return}try{const f=await l.register(e.value,n.value);f.ok?(o.value={message:f.message,type:"success"},setTimeout(()=>{i.value=!1,l.$router.push("/dashboard")},2e3)):(o.value={message:f.message,type:"error"},setTimeout(()=>{i.value=!1},2e3))}catch(f){console.error("Unexpected error:",f),o.value={message:"Error inesperado. Intentá de nuevo.",type:"error"}}i.value=!0},u=()=>{o.value={message:"",type:""}};return Kn(()=>{s.value=!0}),(f,p)=>{const m=Js("router-link");return le(),me("main",ak,[ve(jn,{name:"fade-slide-register",mode:"out-in"},{default:We(()=>[je(P("form",{class:"form-register p-4 rounded shadow",onSubmit:$t(c,["prevent"])},[P("div",lk,[p[4]||(p[4]=P("h2",{class:"text-center ms-3 mb-4 fw-bold text-light"},[Fe("Registro "),P("i",{class:"bi bi-person-add"})],-1)),ve(m,{class:"text-decoration-none",to:"/"},{default:We(()=>p[3]||(p[3]=[P("button",{type:"button",class:"btn-exit btn btn-outline-light"},[P("i",{class:"bi bi-x"})],-1)])),_:1})]),P("div",ck,[p[5]||(p[5]=P("label",{for:"inputEmail",class:"form-label text-light"},"Email",-1)),je(P("input",{required:"","onUpdate:modelValue":p[0]||(p[0]=_=>e.value=_),type:"email",class:"form-control text-light",id:"inputEmail",placeholder:"Ej: leomessi@gmail.com"},null,512),[[jt,e.value]])]),P("div",uk,[p[6]||(p[6]=P("label",{for:"inputPassword",class:"form-label text-light"},"Contraseña",-1)),je(P("input",{required:"","onUpdate:modelValue":p[1]||(p[1]=_=>n.value=_),type:"password",class:"form-control text-light",id:"inputPassword",placeholder:"**********"},null,512),[[jt,n.value]])]),P("div",hk,[p[7]||(p[7]=P("label",{for:"confirmPassword",class:"form-label text-light"},"Confirmar contraseña",-1)),je(P("input",{required:"","onUpdate:modelValue":p[2]||(p[2]=_=>r.value=_),type:"password",class:"form-control text-light",id:"confirmPassword",placeholder:"**********"},null,512),[[jt,r.value]])]),p[10]||(p[10]=P("button",{class:"btn-register btn w-100 py-2 text-light",type:"submit"},[Fe(" Registrarse "),P("i",{class:"bi bi-send-fill"})],-1)),je(ve(cE,{message:o.value.message,type:o.value.type,onAfterLeave:u},null,8,["message","type"]),[[Nn,i.value]]),P("p",fk,[p[9]||(p[9]=Fe(" ¿Ya tenes tu cuenta? ")),ve(m,{to:"/login",class:"login"},{default:We(()=>p[8]||(p[8]=[Fe("Inicia sesion")])),_:1})])],544),[[Nn,s.value]])]),_:1})])}}},pk={class:"d-flex"},mk={class:"d-flex flex-column align-items-center"},gk={class:"username-container text-center font-weight-medium"},_k=["title"],yk={class:"h5"},vk={class:"nav text-center nav-pills flex-column mb-auto"},Ek={class:"nav-item"},Tk={class:"nav-item"},wk={class:"nav-item d-flex justify-content-center"},Ik={key:0,class:"heather p-2 w-100 nav-mobile"},bk={__name:"SideBarComponent",setup(t){const e=Be(!1),n=Be(window.innerWidth<768),r=ii(),s=jl(),i=Qu(),{profile:o}=__(r),l=async()=>{await s.logout(),i.push({name:"Unregistred"})},c=()=>{e.value=!e.value},u=()=>{n.value=window.innerWidth<768,n.value||(e.value=!1)},f=p=>{if(!n.value)return;const m=document.querySelector(".sidebar-profile");e.value&&m&&!m.contains(p.target)&&(e.value=!1)};return Kn(()=>{window.addEventListener("resize",u),document.addEventListener("click",f)}),qu(()=>{window.removeEventListener("resize",u),document.removeEventListener("click",f)}),(p,m)=>{const _=Js("router-link");return le(),me("div",pk,[ve(jn,{name:"slide-fade"},{default:We(()=>[!n.value||e.value?(le(),me("div",{key:0,class:Vt(["sidebar-profile flex-column flex-shrink-0 px-1 text-bg-dark",{"mobile-mode":n.value}])},[P("div",mk,[n.value?Jt("",!0):(le(),vo(_,{key:0,to:{name:"Dashboard"},class:"h3 mb-1 text-light"},{default:We(()=>m[0]||(m[0]=[P("i",{class:"bi bi-house"},null,-1)])),_:1})),P("div",gk,[P("p",{class:"ellipsis my-0",title:Zt(o).nickname},[P("span",yk," #"+Xe(Zt(o).nickname||"Usuario"),1)],8,_k)])]),m[6]||(m[6]=P("hr",null,null,-1)),P("ul",vk,[P("li",Ek,[ve(_,{to:{name:"MyWorkouts"},class:"nav-link d-flex flex-column justify-content-center align-items-center px-1 text-decoration-none"},{default:We(()=>m[1]||(m[1]=[P("i",{class:"bi bi-clipboard-check"},null,-1),Fe(" Mis Rutinas ")])),_:1})]),m[4]||(m[4]=P("hr",null,null,-1)),P("li",Tk,[ve(_,{to:{name:"MyProfile"},class:"nav-link d-flex flex-column justify-content-center align-items-center px-1 text-decoration-none"},{default:We(()=>m[2]||(m[2]=[P("i",{class:"bi bi-person-circle"},null,-1),Fe(" Mi Perfil ")])),_:1})]),m[5]||(m[5]=P("hr",null,null,-1)),P("li",wk,[P("button",{class:"nav-link d-flex flex-column justify-content-center align-items-center text-light px-1",onClick:$t(l,["prevent"])},m[3]||(m[3]=[P("i",{class:"bi bi-box-arrow-right"},null,-1),Fe(" Cerrar Sesion ")]))])])],2)):Jt("",!0)]),_:1}),ve(jn,{name:"fade"},{default:We(()=>[n.value&&e.value?(le(),me("div",{key:0,class:"darkSide",onClick:c})):Jt("",!0)]),_:1}),n.value?(le(),me("header",Ik,[ve(_,{to:{name:"Dashboard"},class:"h2 mb-0 d-flex gap-2"},{default:We(()=>m[7]||(m[7]=[P("i",{class:"bi bi-house"},null,-1)])),_:1}),P("button",{class:"btn btn-outline-info",onClick:$t(c,["stop"])},m[8]||(m[8]=[P("i",{class:"bi bi-list"},null,-1)]))])):Jt("",!0)])}}},Ak=Gn(bk,[["__scopeId","data-v-68d267cb"]]),Rk={class:"w-100"},Sk={__name:"DashboardPage",setup(t){const e=ii(),{profile:n}=__(e);return Kn(()=>{console.log(n),n&&console.log("Onmounted: profile",n)}),(r,s)=>{const i=Js("router-view");return le(),me("div",Rk,[ve(Ak),ve(i,null,{default:We(({Component:o})=>[ve(jn,{name:"route-fade",mode:"out-in",class:"w-100 h-100 d-flex justify-content-center align-items-center"},{default:We(()=>[(le(),vo(nw(o)))]),_:2},1024)]),_:1})])}}},Pk=Gn(Sk,[["__scopeId","data-v-6233ec35"]]),Ck={class:"vh-100 w-100 d-flex align-items-center justify-content-center title-container"},kk={class:"split-text-container mb-md-5"},Ok={class:"mobile-title d-md-none d-flex flex-column align-items-center justify-content-center text-center"},xk={class:"mobile-part from-left"},Dk={class:"mobile-part from-right"},Vk={class:"mobile-part from-bottom"},Nk={class:"auth-links"},Mk={__name:"UnregistredPage",setup(t){const e="MY".split(""),n="WORKOUT".split(""),r="APP".split("");return(s,i)=>{const o=Js("router-link");return le(),me("div",Ck,[P("div",kk,[i[0]||(i[0]=P("div",{class:"desktop-title-container d-none d-md-block"},[P("span",{class:"text-part left desktop-title"},"MY"),P("span",{class:"text-part right desktop-title"},"Workout"),P("span",{class:"text-part right desktop-title"},"App")],-1)),P("div",Ok,[P("div",xk,[(le(!0),me(nt,null,_r(Zt(e),(l,c)=>(le(),me("span",{key:"my"+c},Xe(l),1))),128))]),P("div",Dk,[(le(!0),me(nt,null,_r(Zt(n),(l,c)=>(le(),me("span",{key:"workout"+c},Xe(l),1))),128))]),P("div",Vk,[(le(!0),me(nt,null,_r(Zt(r),(l,c)=>(le(),me("span",{key:"app"+c},Xe(l),1))),128))])])]),ve(jn,{name:"fade-slide-nav",appear:""},{default:We(()=>[P("nav",Nk,[ve(o,{to:"/login",class:"btn px-4"},{default:We(()=>i[1]||(i[1]=[Fe("Login")])),_:1}),ve(o,{to:"/register",class:"btn px-4"},{default:We(()=>i[2]||(i[2]=[Fe("Register")])),_:1})])]),_:1})])}}},Lk=Gn(Mk,[["__scopeId","data-v-cef00f6b"]]),Fk={props:["rutina"]},Uk={class:"px-2 py-1 rounded-xl shadow-md"},$k={class:"text-start text-sm text-gray-500"},jk={class:"mb-1"},Bk={class:"d-flex justify-content-between align-items-baseline"},qk={class:"h5 text-lg text-start font-semibold mb-2"},Hk={class:"h5 text-sm text-end text-gray-400 mb-2"},zk={class:"space-y-2 list-unstyled"},Wk={class:"font-medium mb-4"},Kk={class:"text-sm mt-2 d-flex justify-content-center gap-5 align-items-baseline"},Gk={class:"d-flex flex-column"},Qk={class:"d-flex flex-column"},Yk={key:0},Jk={key:1},Xk={class:"d-flex flex-column"},Zk={key:0},eO={key:1},tO={key:0,class:"mb-0"};function nO(t,e,n,r,s,i){return le(),me("div",Uk,[P("div",$k,[P("p",jk," Descanso entre bloques: "+Xe(n.rutina.descansoBloques)+"s ",1),P("p",null," Descanso entre series: "+Xe(n.rutina.descansoSeries)+"s ",1)]),e[7]||(e[7]=P("hr",null,null,-1)),(le(!0),me(nt,null,_r(n.rutina.bloques,(o,l)=>(le(),me("div",{key:l,class:"my-3"},[P("div",Bk,[P("p",qk,Xe(l+1)+"° Bloque ",1),P("p",Hk,Xe(o.series)+" Series",1)]),P("ul",zk,[(le(!0),me(nt,null,_r(o.ejercicios,(c,u)=>(le(),me("li",{key:u,class:"p-3 rounded"},[P("div",Wk,[P("h4",null,Xe(c.nombre),1)]),P("div",Kk,[P("div",Gk,[e[0]||(e[0]=P("span",null,"Reps",-1)),e[1]||(e[1]=Fe()),P("span",null,Xe(c.repeticiones),1)]),P("div",Qk,[e[2]||(e[2]=P("span",null,"Tiempo",-1)),e[3]||(e[3]=Fe()),c.tiempo!=0?(le(),me("span",Yk,Xe(c.tiempo)+"s",1)):(le(),me("span",Jk,"-"))]),P("div",Xk,[e[4]||(e[4]=P("span",null,"Esfuerzo",-1)),e[5]||(e[5]=Fe()),c.esfuerzo?(le(),me("span",Zk,Xe(c.esfuerzo)+" RIR",1)):(le(),me("span",eO,"-"))])]),u!=o.ejercicios.length-1?(le(),me("hr",tO)):Jt("",!0)]))),128)),e[6]||(e[6]=P("hr",{class:"mb-0"},null,-1))])]))),128))])}const rO=Gn(Fk,[["render",nO]]),sO={class:"my-workouts"},iO={class:"routines-container"},oO={class:"text-center mb-3"},aO={class:"d-flex justify-content-center justify-content-md-start ms-md-5 mb-3"},lO={class:"d-flex align-items-baseline text-start"},cO={key:0,class:"loader"},uO={class:"absolute d-flex justify-content-between top-2 left-0 text-sm text-gray-500"},hO={class:"text-center font-weight-medium my-2"},fO=["title"],dO={class:"d-flex justify-content-between align-items-center text-gray-700"},pO=["title"],mO=["innerHTML"],gO={key:0,class:"difficulty-text"},_O=["innerHTML"],yO={key:0,class:"difficulty-text"},vO=["onClick"],EO={key:0,class:"mini-menu"},TO=["onClick"],wO=["onClick"],IO=["onClick"],bO=["onClick"],AO={key:3,class:"edit-resume-container"},RO=["onClick"],SO=["onClick"],PO=["onClick"],CO=["onClick"],kO={__name:"MyWorkoutsPage",setup(t){const e=ii(),n=Be(!0),r=Be(window.innerWidth<768),s=Be(new Map),i=Be([]);O_();const o=Qu(),l=Be(null),c={"Muy facil":1,Facil:2,Intermedia:3,Dificil:4,"Muy dificil":5},u=Be("fechaCreacionDesc"),f=dt(()=>e.getUserRoutines),p=dt(()=>[...f.value].sort((N,x)=>{if(u.value==="fechaCreacionDesc")return new Date(x.fechaCreacion)-new Date(N.fechaCreacion);if(u.value==="fechaCreacionAsc")return new Date(N.fechaCreacion)-new Date(x.fechaCreacion);{const q=c[N.dificultad]||0,te=c[x.dificultad]||0;return u.value==="asc"?q-te:te-q}}));Jr(l,N=>{N!==null?window.addEventListener("click",m):window.removeEventListener("click",m)}),Kn(async()=>{window.scrollTo({top:0,behavior:"smooth"})}),Jr(()=>e.profile.id,async N=>{if(N){n.value=!0;try{e.getUserRoutines.length===0?await e.getRutinas():n.value=!1}catch(x){console.error("Error al cargar rutinas:",x)}finally{n.value=!1}}},{immediate:!0});const m=N=>{const x=document.querySelector(".dropdown-menu-container");l.value!==null&&!(x!=null&&x.contains(N.target))&&(l.value=null)};function _(N){const x=i.value.indexOf(N);x!==-1?i.value.splice(x,1):(i.value.push(N),yo(()=>{setTimeout(()=>{const q=s.value.get(N);q==null||q.scrollIntoView({behavior:"smooth",block:"start"})},300)}))}async function A(N){if(!confirm("¿Estás seguro de que querés eliminar esta rutina?")){console.log("Eliminar cancelado");return}try{const x=i.value.indexOf(N);x!==-1&&i.value.splice(x,1),await e.deleteRutina(N),n.value=!1}catch(x){console.log("Error al borrar la rutina.",x)}}function O(N){o.push({name:"FormRoutine",query:{id:N.id}})}async function D(N){n.value=!0;const x={...JSON.parse(JSON.stringify(N)),nombre:N.nombre+" (copia)"};delete x.id,delete x.fechaCreacion;try{const q=await e.createRutinaFirebase(x);n.value=!1,_(q.id)}catch(q){console.error("Error copiando rutina:",q),n.value=!1}}const H=N=>(N.bloques||[]).reduce((x,q)=>x+(q.series||1),0),j=N=>"⚡️".repeat(c[N]||0);return(N,x)=>(le(),me("div",sO,[P("div",iO,[x[15]||(x[15]=P("h1",{class:"my-md-5 mb-3"},[Fe("Mis Rutinas "),P("i",{class:"bi bi-clipboard-check"})],-1)),P("div",oO,[ve(Zt(k_),{to:"/dashboard/form-routine",class:"btn btn-outline-danger px-5 d-flex gap-2 justify-content-center align-items-baseline",id:"add-routine"},{default:We(()=>x[2]||(x[2]=[P("i",{class:"bi bi-plus-circle-fill"},null,-1),Fe(" Agregar Rutina ")])),_:1})]),je(P("div",aO,[P("div",lO,[x[4]||(x[4]=P("label",{for:"orderBy",class:"me-2"},"Ordenar por",-1)),je(P("select",{"onUpdate:modelValue":x[0]||(x[0]=q=>u.value=q),id:"orderBy",class:"p-2 m-2 rounded bg-dark text-white"},x[3]||(x[3]=[P("option",{value:"fechaCreacionDesc"},"Más Reciente",-1),P("option",{value:"fechaCreacionAsc"},"Más Antigua",-1),P("option",{value:"asc"},"De más fácil",-1),P("option",{value:"desc"},"De más difícil",-1)]),512),[[Wc,u.value]])])],512),[[Nn,f.value.length>0]]),n.value||f.value.length===0&&n.value?(le(),me("div",cO)):Jt("",!0),je(P("div",null,[ve(mI,{name:"fade-item",tag:"ul",class:Vt(["routine-resumen",{"column-layout":i.value.length>0}])},{default:We(()=>[(le(!0),me(nt,null,_r(p.value,q=>(le(),me("li",{key:q.id,ref_for:!0,ref:te=>s.value.set(q.id,te),class:Vt(["mb-1 routine-card",{expanded:i.value.includes(q.id)}])},[P("div",uO,[P("h6",{class:Vt({h5:i.value.includes(q.id)})},Xe(q.bloques.length)+" Bloques",3),P("h6",{class:Vt({h5:i.value.includes(q.id)})},Xe(H(q))+" Series ",3)]),P("div",hO,[P("h3",{class:"ellipsis",title:q.nombre},Xe(q.nombre),9,fO)]),ve(jn,{name:"expand-fade"},{default:We(()=>[je(ve(rO,{rutina:q},null,8,["rutina"]),[[Nn,i.value.includes(q.id)]])]),_:2},1024),P("div",dO,[r.value?(le(),me("h6",{key:0,class:Vt(["mb-0 difficulty-container",{"h4 d-flex flex-column":i.value.includes(q.id)}]),title:q.dificultad},[P("span",{class:"difficulty-icons",innerHTML:j(q.dificultad)},null,8,mO),r.value||i.value.includes(q.id)?(le(),me("span",gO," ("+Xe(q.dificultad)+") ",1)):Jt("",!0)],10,pO)):(le(),me("h6",{key:1,class:Vt({h4:i.value.includes(q.id)})},[P("span",{class:"difficulty-icons",innerHTML:j(q.dificultad)},null,8,_O),r.value||i.value.includes(q.id)?(le(),me("span",yO," ("+Xe(q.dificultad)+") ",1)):Jt("",!0)],2)),r.value&&!i.value.includes(q.id)?(le(),me("div",{key:2,class:"dropdown-menu-container",onClick:x[1]||(x[1]=$t(()=>{},["stop"]))},[P("span",{onClick:$t(te=>l.value=l.value===q.id?null:q.id,["stop"])},x[5]||(x[5]=[P("i",{class:"bi bi-three-dots-vertical"},null,-1)]),8,vO),ve(jn,{name:"fade-item"},{default:We(()=>[l.value===q.id?(le(),me("ul",EO,[P("li",{onClick:te=>_(q.id)},x[6]||(x[6]=[P("i",{class:"bi bi-arrows-angle-expand"},null,-1)]),8,TO),P("li",{onClick:$t(te=>O(q),["stop"])},x[7]||(x[7]=[P("i",{class:"bi bi-pencil-square"},null,-1)]),8,wO),P("li",{onClick:$t(te=>A(q.id),["stop"])},x[8]||(x[8]=[P("i",{class:"bi bi-trash3"},null,-1)]),8,IO),P("li",{onClick:$t(te=>D(q),["stop"])},x[9]||(x[9]=[P("i",{class:"bi bi-copy"},null,-1)]),8,bO)])):Jt("",!0)]),_:2},1024)])):(le(),me("div",AO,[P("span",{onClick:te=>_(q.id)},x[10]||(x[10]=[P("i",{class:"bi bi-arrows-angle-expand"},null,-1)]),8,RO),P("span",{onClick:$t(te=>O(q),["stop"])},x[11]||(x[11]=[P("i",{class:"bi bi-pencil-square"},null,-1)]),8,SO),P("span",{onClick:$t(te=>A(q.id),["stop"])},x[12]||(x[12]=[P("i",{class:"bi bi-trash3"},null,-1)]),8,PO),P("span",{onClick:$t(te=>D(q),["stop"])},x[13]||(x[13]=[P("i",{class:"bi bi-copy"},null,-1)]),8,CO)]))])],2))),128))]),_:1},8,["class"])],512),[[Nn,p.value.length>0]]),je(P("div",null,x[14]||(x[14]=[P("h5",null,"No hay rutinas guardadas aún.",-1)]),512),[[Nn,p.value.length===0&&!n.value]])])]))}},OO=Gn(kO,[["__scopeId","data-v-f973fdbf"]]),xO={class:"contenedor"},DO={class:"info-container"},VO={class:"w-100 mb-4 justify-content-center d-flex align-items-end gap-3"},NO={class:"text-start w-100"},MO={class:"w-100"},LO={class:"text-start"},FO=["value"],UO={__name:"ProfilePage",setup(t){const e=ii(),n=dt(()=>e.profile),r=Be("");Kn(async()=>{r.value=n.value.nickname});const s=async()=>{try{e.setNickname(r.value),alert("Nombre de usuario actualizado correctamente")}catch(i){console.error("Error al actualizar nickname:",i),alert("Ocurrió un error al guardar.")}};return(i,o)=>(le(),me("div",xO,[o[3]||(o[3]=P("h1",{class:"my-md-5"},[Fe("Mi Perfil "),P("i",{class:"bi bi-person-circle"})],-1)),P("div",DO,[P("div",VO,[P("div",NO,[o[1]||(o[1]=P("label",{for:"username",class:"form-label"},"Nombre de Usuario",-1)),je(P("input",{type:"text","onUpdate:modelValue":o[0]||(o[0]=l=>r.value=l),spellcheck:"false",autocomplete:"off",id:"username",class:"form-control"},null,512),[[jt,r.value]])]),P("div",null,[P("button",{class:Vt(["btn btn-outline-success btn-guardar",r.value===n.value.nickname?"disabled":""]),onClick:s},"Guardar",2)])]),P("div",MO,[P("div",LO,[o[2]||(o[2]=P("label",{for:"email",class:"form-label"},"Email",-1)),P("input",{type:"text",value:n.value.email,id:"email",class:"form-control",readonly:"",disabled:""},null,8,FO)])])])]))}},$O=Gn(UO,[["__scopeId","data-v-dd43bd1b"]]);var uE=typeof global=="object"&&global&&global.Object===Object&&global,jO=typeof self=="object"&&self&&self.Object===Object&&self,Rn=uE||jO||Function("return this")(),Gs=Rn.Symbol,hE=Object.prototype,BO=hE.hasOwnProperty,qO=hE.toString,Ai=Gs?Gs.toStringTag:void 0;function HO(t){var e=BO.call(t,Ai),n=t[Ai];try{t[Ai]=void 0;var r=!0}catch{}var s=qO.call(t);return r&&(e?t[Ai]=n:delete t[Ai]),s}var zO=Object.prototype,WO=zO.toString;function KO(t){return WO.call(t)}var GO="[object Null]",QO="[object Undefined]",Em=Gs?Gs.toStringTag:void 0;function xo(t){return t==null?t===void 0?QO:GO:Em&&Em in Object(t)?HO(t):KO(t)}function Do(t){return t!=null&&typeof t=="object"}var qh=Array.isArray;function Bl(t){var e=typeof t;return t!=null&&(e=="object"||e=="function")}var YO="[object AsyncFunction]",JO="[object Function]",XO="[object GeneratorFunction]",ZO="[object Proxy]";function fE(t){if(!Bl(t))return!1;var e=xo(t);return e==JO||e==XO||e==YO||e==ZO}var xc=Rn["__core-js_shared__"],Tm=function(){var t=/[^.]+$/.exec(xc&&xc.keys&&xc.keys.IE_PROTO||"");return t?"Symbol(src)_1."+t:""}();function ex(t){return!!Tm&&Tm in t}var tx=Function.prototype,nx=tx.toString;function ds(t){if(t!=null){try{return nx.call(t)}catch{}try{return t+""}catch{}}return""}var rx=/[\\^$.*+?()[\]{}|]/g,sx=/^\[object .+?Constructor\]$/,ix=Function.prototype,ox=Object.prototype,ax=ix.toString,lx=ox.hasOwnProperty,cx=RegExp("^"+ax.call(lx).replace(rx,"\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g,"$1.*?")+"$");function ux(t){if(!Bl(t)||ex(t))return!1;var e=fE(t)?cx:sx;return e.test(ds(t))}function hx(t,e){return t==null?void 0:t[e]}function ps(t,e){var n=hx(t,e);return ux(n)?n:void 0}var Au=ps(Rn,"WeakMap"),wm=Object.create,fx=function(){function t(){}return function(e){if(!Bl(e))return{};if(wm)return wm(e);t.prototype=e;var n=new t;return t.prototype=void 0,n}}(),Im=function(){try{var t=ps(Object,"defineProperty");return t({},"",{}),t}catch{}}();function dx(t,e){for(var n=-1,r=t==null?0:t.length;++n<r&&e(t[n],n,t)!==!1;);return t}var px=9007199254740991,mx=/^(?:0|[1-9]\d*)$/;function gx(t,e){var n=typeof t;return e=e??px,!!e&&(n=="number"||n!="symbol"&&mx.test(t))&&t>-1&&t%1==0&&t<e}function _x(t,e,n){e=="__proto__"&&Im?Im(t,e,{configurable:!0,enumerable:!0,value:n,writable:!0}):t[e]=n}function dE(t,e){return t===e||t!==t&&e!==e}var yx=Object.prototype,vx=yx.hasOwnProperty;function Ex(t,e,n){var r=t[e];(!(vx.call(t,e)&&dE(r,n))||n===void 0&&!(e in t))&&_x(t,e,n)}var Tx=9007199254740991;function pE(t){return typeof t=="number"&&t>-1&&t%1==0&&t<=Tx}function wx(t){return t!=null&&pE(t.length)&&!fE(t)}var Ix=Object.prototype;function mE(t){var e=t&&t.constructor,n=typeof e=="function"&&e.prototype||Ix;return t===n}function bx(t,e){for(var n=-1,r=Array(t);++n<t;)r[n]=e(n);return r}var Ax="[object Arguments]";function bm(t){return Do(t)&&xo(t)==Ax}var gE=Object.prototype,Rx=gE.hasOwnProperty,Sx=gE.propertyIsEnumerable,Px=bm(function(){return arguments}())?bm:function(t){return Do(t)&&Rx.call(t,"callee")&&!Sx.call(t,"callee")};function Cx(){return!1}var _E=typeof Ht=="object"&&Ht&&!Ht.nodeType&&Ht,Am=_E&&typeof zt=="object"&&zt&&!zt.nodeType&&zt,kx=Am&&Am.exports===_E,Rm=kx?Rn.Buffer:void 0,Ox=Rm?Rm.isBuffer:void 0,yE=Ox||Cx,xx="[object Arguments]",Dx="[object Array]",Vx="[object Boolean]",Nx="[object Date]",Mx="[object Error]",Lx="[object Function]",Fx="[object Map]",Ux="[object Number]",$x="[object Object]",jx="[object RegExp]",Bx="[object Set]",qx="[object String]",Hx="[object WeakMap]",zx="[object ArrayBuffer]",Wx="[object DataView]",Kx="[object Float32Array]",Gx="[object Float64Array]",Qx="[object Int8Array]",Yx="[object Int16Array]",Jx="[object Int32Array]",Xx="[object Uint8Array]",Zx="[object Uint8ClampedArray]",eD="[object Uint16Array]",tD="[object Uint32Array]",$e={};$e[Kx]=$e[Gx]=$e[Qx]=$e[Yx]=$e[Jx]=$e[Xx]=$e[Zx]=$e[eD]=$e[tD]=!0;$e[xx]=$e[Dx]=$e[zx]=$e[Vx]=$e[Wx]=$e[Nx]=$e[Mx]=$e[Lx]=$e[Fx]=$e[Ux]=$e[$x]=$e[jx]=$e[Bx]=$e[qx]=$e[Hx]=!1;function nD(t){return Do(t)&&pE(t.length)&&!!$e[xo(t)]}function Hh(t){return function(e){return t(e)}}var vE=typeof Ht=="object"&&Ht&&!Ht.nodeType&&Ht,Gi=vE&&typeof zt=="object"&&zt&&!zt.nodeType&&zt,rD=Gi&&Gi.exports===vE,Dc=rD&&uE.process,Qs=function(){try{var t=Gi&&Gi.require&&Gi.require("util").types;return t||Dc&&Dc.binding&&Dc.binding("util")}catch{}}(),Sm=Qs&&Qs.isTypedArray,sD=Sm?Hh(Sm):nD,iD=Object.prototype,oD=iD.hasOwnProperty;function aD(t,e){var n=qh(t),r=!n&&Px(t),s=!n&&!r&&yE(t),i=!n&&!r&&!s&&sD(t),o=n||r||s||i,l=o?bx(t.length,String):[],c=l.length;for(var u in t)oD.call(t,u)&&!(o&&(u=="length"||s&&(u=="offset"||u=="parent")||i&&(u=="buffer"||u=="byteLength"||u=="byteOffset")||gx(u,c)))&&l.push(u);return l}function EE(t,e){return function(n){return t(e(n))}}var lD=EE(Object.keys,Object),cD=Object.prototype,uD=cD.hasOwnProperty;function hD(t){if(!mE(t))return lD(t);var e=[];for(var n in Object(t))uD.call(t,n)&&n!="constructor"&&e.push(n);return e}function fD(t){return wx(t)?aD(t):hD(t)}var po=ps(Object,"create");function dD(){this.__data__=po?po(null):{},this.size=0}function pD(t){var e=this.has(t)&&delete this.__data__[t];return this.size-=e?1:0,e}var mD="__lodash_hash_undefined__",gD=Object.prototype,_D=gD.hasOwnProperty;function yD(t){var e=this.__data__;if(po){var n=e[t];return n===mD?void 0:n}return _D.call(e,t)?e[t]:void 0}var vD=Object.prototype,ED=vD.hasOwnProperty;function TD(t){var e=this.__data__;return po?e[t]!==void 0:ED.call(e,t)}var wD="__lodash_hash_undefined__";function ID(t,e){var n=this.__data__;return this.size+=this.has(t)?0:1,n[t]=po&&e===void 0?wD:e,this}function os(t){var e=-1,n=t==null?0:t.length;for(this.clear();++e<n;){var r=t[e];this.set(r[0],r[1])}}os.prototype.clear=dD;os.prototype.delete=pD;os.prototype.get=yD;os.prototype.has=TD;os.prototype.set=ID;function bD(){this.__data__=[],this.size=0}function ql(t,e){for(var n=t.length;n--;)if(dE(t[n][0],e))return n;return-1}var AD=Array.prototype,RD=AD.splice;function SD(t){var e=this.__data__,n=ql(e,t);if(n<0)return!1;var r=e.length-1;return n==r?e.pop():RD.call(e,n,1),--this.size,!0}function PD(t){var e=this.__data__,n=ql(e,t);return n<0?void 0:e[n][1]}function CD(t){return ql(this.__data__,t)>-1}function kD(t,e){var n=this.__data__,r=ql(n,t);return r<0?(++this.size,n.push([t,e])):n[r][1]=e,this}function Yn(t){var e=-1,n=t==null?0:t.length;for(this.clear();++e<n;){var r=t[e];this.set(r[0],r[1])}}Yn.prototype.clear=bD;Yn.prototype.delete=SD;Yn.prototype.get=PD;Yn.prototype.has=CD;Yn.prototype.set=kD;var mo=ps(Rn,"Map");function OD(){this.size=0,this.__data__={hash:new os,map:new(mo||Yn),string:new os}}function xD(t){var e=typeof t;return e=="string"||e=="number"||e=="symbol"||e=="boolean"?t!=="__proto__":t===null}function Hl(t,e){var n=t.__data__;return xD(e)?n[typeof e=="string"?"string":"hash"]:n.map}function DD(t){var e=Hl(this,t).delete(t);return this.size-=e?1:0,e}function VD(t){return Hl(this,t).get(t)}function ND(t){return Hl(this,t).has(t)}function MD(t,e){var n=Hl(this,t),r=n.size;return n.set(t,e),this.size+=n.size==r?0:1,this}function oi(t){var e=-1,n=t==null?0:t.length;for(this.clear();++e<n;){var r=t[e];this.set(r[0],r[1])}}oi.prototype.clear=OD;oi.prototype.delete=DD;oi.prototype.get=VD;oi.prototype.has=ND;oi.prototype.set=MD;function LD(t,e){for(var n=-1,r=e.length,s=t.length;++n<r;)t[s+n]=e[n];return t}var FD=EE(Object.getPrototypeOf,Object);function UD(){this.__data__=new Yn,this.size=0}function $D(t){var e=this.__data__,n=e.delete(t);return this.size=e.size,n}function jD(t){return this.__data__.get(t)}function BD(t){return this.__data__.has(t)}var qD=200;function HD(t,e){var n=this.__data__;if(n instanceof Yn){var r=n.__data__;if(!mo||r.length<qD-1)return r.push([t,e]),this.size=++n.size,this;n=this.__data__=new oi(r)}return n.set(t,e),this.size=n.size,this}function ai(t){var e=this.__data__=new Yn(t);this.size=e.size}ai.prototype.clear=UD;ai.prototype.delete=$D;ai.prototype.get=jD;ai.prototype.has=BD;ai.prototype.set=HD;var TE=typeof Ht=="object"&&Ht&&!Ht.nodeType&&Ht,Pm=TE&&typeof zt=="object"&&zt&&!zt.nodeType&&zt,zD=Pm&&Pm.exports===TE,Cm=zD?Rn.Buffer:void 0;Cm&&Cm.allocUnsafe;function WD(t,e){return t.slice()}function KD(t,e){for(var n=-1,r=t==null?0:t.length,s=0,i=[];++n<r;){var o=t[n];e(o,n,t)&&(i[s++]=o)}return i}function GD(){return[]}var QD=Object.prototype,YD=QD.propertyIsEnumerable,km=Object.getOwnPropertySymbols,JD=km?function(t){return t==null?[]:(t=Object(t),KD(km(t),function(e){return YD.call(t,e)}))}:GD;function XD(t,e,n){var r=e(t);return qh(t)?r:LD(r,n(t))}function ZD(t){return XD(t,fD,JD)}var Ru=ps(Rn,"DataView"),Su=ps(Rn,"Promise"),Pu=ps(Rn,"Set"),Om="[object Map]",eV="[object Object]",xm="[object Promise]",Dm="[object Set]",Vm="[object WeakMap]",Nm="[object DataView]",tV=ds(Ru),nV=ds(mo),rV=ds(Su),sV=ds(Pu),iV=ds(Au),xn=xo;(Ru&&xn(new Ru(new ArrayBuffer(1)))!=Nm||mo&&xn(new mo)!=Om||Su&&xn(Su.resolve())!=xm||Pu&&xn(new Pu)!=Dm||Au&&xn(new Au)!=Vm)&&(xn=function(t){var e=xo(t),n=e==eV?t.constructor:void 0,r=n?ds(n):"";if(r)switch(r){case tV:return Nm;case nV:return Om;case rV:return xm;case sV:return Dm;case iV:return Vm}return e});var oV=Object.prototype,aV=oV.hasOwnProperty;function lV(t){var e=t.length,n=new t.constructor(e);return e&&typeof t[0]=="string"&&aV.call(t,"index")&&(n.index=t.index,n.input=t.input),n}var Mm=Rn.Uint8Array;function zh(t){var e=new t.constructor(t.byteLength);return new Mm(e).set(new Mm(t)),e}function cV(t,e){var n=zh(t.buffer);return new t.constructor(n,t.byteOffset,t.byteLength)}var uV=/\w*$/;function hV(t){var e=new t.constructor(t.source,uV.exec(t));return e.lastIndex=t.lastIndex,e}var Lm=Gs?Gs.prototype:void 0,Fm=Lm?Lm.valueOf:void 0;function fV(t){return Fm?Object(Fm.call(t)):{}}function dV(t,e){var n=zh(t.buffer);return new t.constructor(n,t.byteOffset,t.length)}var pV="[object Boolean]",mV="[object Date]",gV="[object Map]",_V="[object Number]",yV="[object RegExp]",vV="[object Set]",EV="[object String]",TV="[object Symbol]",wV="[object ArrayBuffer]",IV="[object DataView]",bV="[object Float32Array]",AV="[object Float64Array]",RV="[object Int8Array]",SV="[object Int16Array]",PV="[object Int32Array]",CV="[object Uint8Array]",kV="[object Uint8ClampedArray]",OV="[object Uint16Array]",xV="[object Uint32Array]";function DV(t,e,n){var r=t.constructor;switch(e){case wV:return zh(t);case pV:case mV:return new r(+t);case IV:return cV(t);case bV:case AV:case RV:case SV:case PV:case CV:case kV:case OV:case xV:return dV(t);case gV:return new r;case _V:case EV:return new r(t);case yV:return hV(t);case vV:return new r;case TV:return fV(t)}}function VV(t){return typeof t.constructor=="function"&&!mE(t)?fx(FD(t)):{}}var NV="[object Map]";function MV(t){return Do(t)&&xn(t)==NV}var Um=Qs&&Qs.isMap,LV=Um?Hh(Um):MV,FV="[object Set]";function UV(t){return Do(t)&&xn(t)==FV}var $m=Qs&&Qs.isSet,$V=$m?Hh($m):UV,wE="[object Arguments]",jV="[object Array]",BV="[object Boolean]",qV="[object Date]",HV="[object Error]",IE="[object Function]",zV="[object GeneratorFunction]",WV="[object Map]",KV="[object Number]",bE="[object Object]",GV="[object RegExp]",QV="[object Set]",YV="[object String]",JV="[object Symbol]",XV="[object WeakMap]",ZV="[object ArrayBuffer]",eN="[object DataView]",tN="[object Float32Array]",nN="[object Float64Array]",rN="[object Int8Array]",sN="[object Int16Array]",iN="[object Int32Array]",oN="[object Uint8Array]",aN="[object Uint8ClampedArray]",lN="[object Uint16Array]",cN="[object Uint32Array]",Me={};Me[wE]=Me[jV]=Me[ZV]=Me[eN]=Me[BV]=Me[qV]=Me[tN]=Me[nN]=Me[rN]=Me[sN]=Me[iN]=Me[WV]=Me[KV]=Me[bE]=Me[GV]=Me[QV]=Me[YV]=Me[JV]=Me[oN]=Me[aN]=Me[lN]=Me[cN]=!0;Me[HV]=Me[IE]=Me[XV]=!1;function Ta(t,e,n,r,s,i){var o;if(o!==void 0)return o;if(!Bl(t))return t;var l=qh(t);if(l)o=lV(t);else{var c=xn(t),u=c==IE||c==zV;if(yE(t))return WD(t);if(c==bE||c==wE||u&&!s)o=u?{}:VV(t);else{if(!Me[c])return s?t:{};o=DV(t,c)}}i||(i=new ai);var f=i.get(t);if(f)return f;i.set(t,o),$V(t)?t.forEach(function(_){o.add(Ta(_,e,n,_,t,i))}):LV(t)&&t.forEach(function(_,A){o.set(A,Ta(_,e,n,A,t,i))});var p=ZD,m=l?void 0:p(t);return dx(m||t,function(_,A){m&&(A=_,_=t[A]),Ex(o,A,Ta(_,e,n,A,t,i))}),o}var uN=1,hN=4;function fN(t){return Ta(t,uN|hN)}const dN={class:"add-routine-form"},pN={class:"text-center mb-4"},mN={class:"mb-3 text-start"},gN={class:"mb-3 flex-column d-flex justify-content-center align-items-start col-md-3"},_N={class:"mb-3 text-start d-flex justify-content-start gap-5 align-items-center"},yN={class:"mb-3 text-start d-flex justify-content-start gap-5 align-items-center"},vN={class:"mb-3 d-flex justify-content-between align-items-baseline"},EN={class:"text-start m-0"},TN={class:"d-flex flex-column align-items-center justify-content-center col-md-2"},wN=["onUpdate:modelValue","id"],IN={class:"row w-100 d-flex flex-column justify-content-center gap-3"},bN={class:"w-100 mb-2"},AN=["onUpdate:modelValue","id"],RN={class:"setting-exercise"},SN={class:"col-md-3 mb-2 text-center"},PN=["onUpdate:modelValue","id"],CN={class:"col-md-3 text-center"},kN=["onUpdate:modelValue","id"],ON={class:"col-md-3 text-center"},xN=["onUpdate:modelValue","id"],DN={class:"d-flex w-100 justify-content-center gap-2"},VN=["onClick"],NN=["onClick"],MN={class:"btns-set-bloque"},LN=["onClick"],FN={key:0,class:"loader-form"},UN={__name:"FormRoutine",props:{rutinaParaEditar:Object},setup(t){const e=ii(),n=O_(),r=Qu(),s=Be(!1),i=Ys({nombre:"",dificultad:"Intermedia",descansoBloques:60,descansoSeries:60,bloques:[{series:3,ejercicios:[{nombre:"",repeticiones:1,tiempo:0,esfuerzo:0}]}]});Kn(async()=>{window.scrollTo({top:0,behavior:"smooth"});const _=n.query.id;if(_)try{const A=e.getRutinaLocal(_);A?Object.assign(i,fN(A)):console.warn(`No se encontró la rutina con ID: ${_}`)}catch(A){console.error("Error al cargar la rutina para editar:",A)}});const o=()=>{r.push({name:"MyWorkouts"})},l=async()=>{s.value=!0;try{i.id?await e.updateRutina({...i}):await e.createRutinaFirebase({...i}),s.value=!1,r.push({name:"MyWorkouts"})}catch(_){console.error("Error al guardar la rutina:",_)}},c=()=>{i.bloques.push({series:3,ejercicios:[{nombre:"",repeticiones:1,tiempo:0,esfuerzo:0}]})},u=_=>{i.bloques.splice(_,1)},f=_=>{i.bloques[_].ejercicios.push({nombre:"",repeticiones:1,tiempo:0,esfuerzo:0})},p=(_,A)=>{i.bloques[_].ejercicios.splice(A,1)},m=_=>_===null||_===""||_===void 0?"input-alert":"";return(_,A)=>(le(),me("div",dN,[P("h2",pN,Xe(i.id?"Editar Rutina":"Agregar Nueva Rutina"),1),P("form",{onSubmit:$t(l,["prevent"]),class:"p-2 p-md-4"},[P("div",mN,[A[4]||(A[4]=P("label",{for:"nombre",class:"form-label"},"Nombre",-1)),je(P("input",{type:"text","onUpdate:modelValue":A[0]||(A[0]=O=>i.nombre=O),spellcheck:"false",autocomplete:"on",class:Vt(["form-control",m(i.nombre)]),id:"nombre",required:""},null,2),[[jt,i.nombre]])]),P("div",gN,[A[6]||(A[6]=P("label",{for:"dificultad",class:"form-label"},"Dificultad",-1)),je(P("select",{"onUpdate:modelValue":A[1]||(A[1]=O=>i.dificultad=O),class:"form-select text-info input-difficulty",id:"dificultad",required:""},A[5]||(A[5]=[Nw('<option value="Muy facil" data-v-698e686d>Muy fácil</option><option value="Facil" data-v-698e686d>Fácil</option><option value="Intermedia" data-v-698e686d>Intermedia</option><option value="Dificil" data-v-698e686d>Difícil</option><option value="Muy dificil" data-v-698e686d>Muy difícil</option>',5)]),512),[[Wc,i.dificultad]])]),P("div",_N,[A[7]||(A[7]=P("label",{for:"descansoBloques",class:"form-label w-50 mb-0"}," Descanso entre Bloques ",-1)),je(P("input",{type:"number","onUpdate:modelValue":A[2]||(A[2]=O=>i.descansoBloques=O),class:"form-control input-number",id:"descansoBloques"},null,512),[[jt,i.descansoBloques]])]),P("div",yN,[A[8]||(A[8]=P("label",{for:"descansoSeries",class:"form-label w-50 mb-0"},"Descanso entre Series",-1)),je(P("input",{type:"number","onUpdate:modelValue":A[3]||(A[3]=O=>i.descansoSeries=O),class:"form-control input-number",id:"descansoSeries"},null,512),[[jt,i.descansoSeries]])]),(le(!0),me(nt,null,_r(i.bloques,(O,D)=>(le(),me("div",{key:D,class:"bloque-container mb-3 px-2 pt-2 pb-3 rounded text-start"},[P("div",vN,[P("h5",EN,Xe(D+1)+"° Bloque",1),P("div",TN,[A[9]||(A[9]=P("label",{for:"series-bloque-{{ index }}",class:"form-label mb-1"},"Series",-1)),je(P("input",{type:"number","onUpdate:modelValue":H=>O.series=H,class:"form-control input-number",id:"series-bloque-"+D,min:"1"},null,8,wN),[[jt,O.series]])])]),(le(!0),me(nt,null,_r(O.ejercicios,(H,j)=>(le(),me("div",{key:j,class:"ejercicio-container p-2 d-flex flex-column align-items-center gap-3"},[P("div",IN,[P("div",bN,[A[10]||(A[10]=P("label",{for:"ejercicio-{{ index }}-{{ ejercicioIndex }}",class:"form-label"},"Ejercicio",-1)),je(P("input",{type:"text","onUpdate:modelValue":N=>H.nombre=N,spellcheck:"false",autocomplete:"on",required:"",class:Vt(["form-control",m(i.nombre)]),id:"ejercicio-"+D+"-"+j},null,10,AN),[[jt,H.nombre]])])]),P("div",RN,[P("div",SN,[A[11]||(A[11]=P("label",{for:"reps-{{ index }}-{{ ejercicioIndex }}",class:"form-label"},"Reps",-1)),je(P("input",{type:"number","onUpdate:modelValue":N=>H.repeticiones=N,class:"form-control input-number",id:"reps-"+D+"-"+j,min:"1"},null,8,PN),[[jt,H.repeticiones]])]),P("div",CN,[A[12]||(A[12]=P("label",{for:"tiempo-{{ index }}-{{ ejercicioIndex }}",class:"form-label"},"Tiempo",-1)),je(P("input",{type:"number","onUpdate:modelValue":N=>H.tiempo=N,class:"form-control input-number",id:"tiempo-"+D+"-"+j,min:"0"},null,8,kN),[[jt,H.tiempo]])]),P("div",ON,[A[14]||(A[14]=P("label",{for:"esfuerzo-{{ index }}-{{ ejercicioIndex }}",class:"form-label"},"Esfuerzo",-1)),je(P("select",{"onUpdate:modelValue":N=>H.esfuerzo=N,class:"form-select text-info input-rir",id:"esfuerzo-"+D+"-"+j},A[13]||(A[13]=[P("option",{select:"",value:""},"-",-1),P("option",{value:"1"},"RIR 1",-1),P("option",{value:"2"},"RIR 2",-1),P("option",{value:"3"},"RIR 3",-1)]),8,xN),[[Wc,H.esfuerzo]])])]),P("div",DN,[P("button",{type:"button",onClick:N=>f(D),class:"btn btn-outline-info"},A[15]||(A[15]=[P("i",{class:"bi bi-plus-circle-fill"},null,-1),Fe(" Ejercicio ")]),8,VN),j>0?(le(),me("button",{key:0,type:"button",onClick:N=>p(D,j),class:"btn btn-outline-danger delete-exercise"},A[16]||(A[16]=[P("i",{class:"bi bi-trash-fill"},null,-1),Fe(" Ejercicio ")]),8,NN)):Jt("",!0)])]))),128)),P("div",MN,[D>0?(le(),me("button",{key:0,type:"button",onClick:H=>u(D),class:"btn btn-outline-danger"},A[17]||(A[17]=[P("i",{class:"bi bi-trash-fill"},null,-1),Fe(" Bloque ")]),8,LN)):Jt("",!0)])]))),128)),P("div",{class:"text-center d-flex flex-column align-items-center"},[P("button",{type:"button",onClick:c,class:"btn btn-outline-info"},A[18]||(A[18]=[P("i",{class:"bi bi-plus-circle-fill"},null,-1),Fe(" Agregar Bloque ")]))]),A[21]||(A[21]=P("hr",null,null,-1)),s.value?(le(),me("div",FN)):Jt("",!0),P("div",{class:"text-center d-flex btns-set-routine flex-column align-items-center"},[A[20]||(A[20]=P("button",{type:"submit",class:"btn btn-success mt-0"},[P("i",{class:"bi bi-box-arrow-down"}),Fe(" Guardar rutina ")],-1)),P("button",{type:"button",onClick:o,class:"btn btn-danger mt-3"},A[19]||(A[19]=[P("i",{class:"bi bi-x-circle"},null,-1),Fe(" Cancelar ")]))])],32)]))}},$N=Gn(UN,[["__scopeId","data-v-698e686d"]]),jN=[{path:"/register",name:"Register",component:dk},{path:"/login",name:"Login",component:ok},{path:"/dashboard",name:"Dashboard",component:Pk,children:[{path:"my-workouts",name:"MyWorkouts",component:OO},{path:"my-profile",name:"MyProfile",component:$O},{path:"form-routine",name:"FormRoutine",component:$N},{path:"",redirect:{name:"MyWorkouts"}}],meta:{requiresAuth:!0}},{path:"/unregistred",name:"Unregistred",component:Lk},{path:"/:pathMatch(.*)*",redirect:{name:"Unregistred"}}],Wh=Fb({history:pb("/my-workout-app/"),routes:jN});let Vc=null;function BN(){return new Promise(t=>{Vc!==null?t(Vc):Jv(Di,e=>{Vc=e,t(e)})})}Wh.beforeEach(async(t,e,n)=>{const r=await BN();if(console.log("Middleware routes, to:",t.fullPath),t.path==="/login"&&r)return n("/dashboard");if(t.matched.some(s=>s.meta.requiresAuth)&&!r)return n("/login");n()});const Kh=AI(MI),AE=PI();AE.use(({store:t})=>{t.$router=al(Wh)});Kh.use(AE);Kh.use(Wh);const qN=jl();qN.initAuthListener();Kh.mount("#app")});export default HN();
