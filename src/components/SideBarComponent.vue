<template>
    <div class="d-flex">
        ...
        <transition name="slide-fade">
            <div v-if="!isMobile || isSidebarVisible"
                ...
                <div class="d-flex flex-column align-items-center">
                    <router-link v-if="!isMobile" to="my-workout-app/dashboard" class="h3 mb-1 text-light ">
                ...
                <ul class="nav text-center nav-pills flex-column mb-auto">
                    <li class="nav-item">
                        <router-link to="my-workout-app/dashboard/my-workouts"
                    ...
                    <hr />
                    <li class="nav-item">
                        <router-link to="my-workout-app/dashboard/my-profile"
                            class="nav-link d-flex flex-column justify-content-center align-items-center px-1 text-decoration-none">
        ...
        <header v-if="isMobile" class="heather p-2 w-100 nav-mobile">
            ...
            <router-link to="my-workout-app/dashboard" class="h2 mb-0 d-flex gap-2">
                <i class="bi bi-house"></i>
            </router-link>
